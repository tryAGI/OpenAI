...
namespace tryAGI.OpenAI
{
    public partial class GroupOrganizationRoleAssignmentsClient
    {
        ...
        {
            var __response = await ListGroupOrganizationRoleAssignmentsAsResponseAsync(
                groupId: groupId,
                limit: limit,
                after: after,
                order: order,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::tryAGI.OpenAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::tryAGI.OpenAI.AutoSDKHttpResponse<global::tryAGI.OpenAI.RoleListResource>> ListGroupOrganizationRoleAssignmentsAsResponseAsync(
            string groupId,
            int? limit = default,
            string? after = default,
            global::tryAGI.OpenAI.ListGroupRoleAssignmentsOrder? order = default,
