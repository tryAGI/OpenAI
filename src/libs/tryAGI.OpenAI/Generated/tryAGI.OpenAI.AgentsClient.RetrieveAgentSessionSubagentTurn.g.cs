...
namespace tryAGI.OpenAI
{
    public partial class AgentsClient
    {
        ...
        private static readonly global::tryAGI.OpenAI.EndPointSecurityRequirement s_RetrieveAgentSessionSubagentTurnSecurityRequirement0 =
        ...
        private static readonly global::tryAGI.OpenAI.EndPointSecurityRequirement[] s_RetrieveAgentSessionSubagentTurnSecurityRequirements =
            new global::tryAGI.OpenAI.EndPointSecurityRequirement[]
            {                s_RetrieveAgentSessionSubagentTurnSecurityRequirement0,
            };
        partial void PrepareRetrieveAgentSessionSubagentTurnArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string sessionId,
            ref string subagentId,
            ref string turnId);
        partial void PrepareRetrieveAgentSessionSubagentTurnRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string sessionId,
            string subagentId,
            string turnId);
        partial void ProcessRetrieveAgentSessionSubagentTurnResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessRetrieveAgentSessionSubagentTurnResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::tryAGI.OpenAI.TurnResource> RetrieveAgentSessionSubagentTurnAsync(
            string sessionId,
            string subagentId,
            string turnId,
        ...
        {
            var __response = await RetrieveAgentSessionSubagentTurnAsResponseAsync(
                sessionId: sessionId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::tryAGI.OpenAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::tryAGI.OpenAI.AutoSDKHttpResponse<global::tryAGI.OpenAI.TurnResource>> RetrieveAgentSessionSubagentTurnAsResponseAsync(
            string sessionId,
            string subagentId,
            string turnId,
            global::tryAGI.OpenAI.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareRetrieveAgentSessionSubagentTurnArguments(
            ...
            var __authorizations = global::tryAGI.OpenAI.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_RetrieveAgentSessionSubagentTurnSecurityRequirements,
                operationName: "RetrieveAgentSessionSubagentTurnAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::tryAGI.OpenAI.PathBuilder(
                                path: $"/agents/sessions/{sessionId}/subagents/{subagentId}/turns/{turnId}",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareRetrieveAgentSessionSubagentTurnRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "RetrieveAgentSessionSubagentTurnAsync",
                                pathTemplate: "$\"/agents/sessions/{sessionId}/subagents/{subagentId}/turns/{turnId}\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessRetrieveAgentSessionSubagentTurnResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessRetrieveAgentSessionSubagentTurnResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::tryAGI.OpenAI.TurnResource.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::tryAGI.OpenAI.AutoSDKHttpResponse<global::tryAGI.OpenAI.TurnResource>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::tryAGI.OpenAI.TurnResource.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
