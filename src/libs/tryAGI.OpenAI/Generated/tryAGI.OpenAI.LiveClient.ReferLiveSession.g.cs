...
namespace tryAGI.OpenAI
{
    public partial class LiveClient
    {
        ...
        private static readonly global::tryAGI.OpenAI.EndPointSecurityRequirement s_ReferLiveSessionSecurityRequirement0 =
        ...
        private static readonly global::tryAGI.OpenAI.EndPointSecurityRequirement[] s_ReferLiveSessionSecurityRequirements =
            new global::tryAGI.OpenAI.EndPointSecurityRequirement[]
            {                s_ReferLiveSessionSecurityRequirement0,
            };
        partial void PrepareReferLiveSessionArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string sessionId,
            global::tryAGI.OpenAI.LiveCallReferRequest request);
        partial void PrepareReferLiveSessionRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string sessionId,
            global::tryAGI.OpenAI.LiveCallReferRequest request);
        partial void ProcessReferLiveSessionResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task ReferLiveSessionAsync(
            string sessionId,
        ...
        {
            await ReferLiveSessionAsResponseAsync(
                sessionId: sessionId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::tryAGI.OpenAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::tryAGI.OpenAI.AutoSDKHttpResponse> ReferLiveSessionAsResponseAsync(
            string sessionId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareReferLiveSessionArguments(
            ...
            var __authorizations = global::tryAGI.OpenAI.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ReferLiveSessionSecurityRequirements,
                operationName: "ReferLiveSessionAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareReferLiveSessionRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ReferLiveSession",
                                methodName: "ReferLiveSessionAsync",
                                pathTemplate: "$\"/live/sessions/{sessionId}/refer\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessReferLiveSessionResponse(
                    httpClient: HttpClient,
        ...
        public async global::System.Threading.Tasks.Task ReferLiveSessionAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::tryAGI.OpenAI.LiveCallReferRequest
            {
                TargetUri = targetUri,
            };

            await ReferLiveSessionAsync(
                sessionId: sessionId,
                request: __request,
                requestOptions: requestOptions,
