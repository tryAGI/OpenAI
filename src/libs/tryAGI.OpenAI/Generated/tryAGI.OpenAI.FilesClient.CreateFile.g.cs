...
namespace tryAGI.OpenAI
{
    public partial class FilesClient
    {
        ...
        private static readonly global::tryAGI.OpenAI.EndPointSecurityRequirement s_CreateFileSecurityRequirement0 =
        ...
        private static readonly global::tryAGI.OpenAI.EndPointSecurityRequirement[] s_CreateFileSecurityRequirements =
            new global::tryAGI.OpenAI.EndPointSecurityRequirement[]
        ...
        ///   file types. See the [Assistants Tools guide](https://developers.openai.com/api/docs/guides/tools) for<br/>
        ///   details.<br/>
        /// - The Fine-tuning API only supports `.jsonl` files. The input also has<br/>
        ///   certain required formats for fine-tuning<br/>
        ///   [chat](https://developers.openai.com/api/docs/guides/supervised-fine-tuning#formatting-your-data) or<br/>
        ///   [completions](https://developers.openai.com/api/docs/guides/supervised-fine-tuning#formatting-your-data) models.<br/>
        /// - The Batch API only supports `.jsonl` files up to 200 MB in size. The input<br/>
        ///   also has a specific required<br/>
        ///   [format](https://developers.openai.com/api/docs/guides/batch#1-prepare-your-batch-file).<br/>
        ...
        ///   [`/vector_stores/{vector_store_id}/file_batches`](https://developers.openai.com/api/reference/resources/vector_stores/subresources/file_batches/methods/create)<br/>
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::tryAGI.OpenAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::tryAGI.OpenAI.AutoSDKHttpResponse<global::tryAGI.OpenAI.OpenAIFile>> CreateFileAsResponseAsync(
                         ...
                         __authorization.Location == "Header")
                {
                    __httpRequest.Headers.Add(__authorization.Name, __authorization.Value);
                            ...
                            if (request.ExpiresAfter != default)
                            {
                                ...
                                __httpRequestContent.Add(
                                    content: new global::System.Net.Http.StringContent(request.ExpiresAfter.ToJson(JsonSerializerContext)),
                                    name: "\"expires_after\"");
            ...
            try
            {
                ...
                else
                {
                    await global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            // The file upload request is invalid or exceeds a file size or storage quota limit.
                            ...
                            // Too many file requests. Reduce the request rate and try again later.
                            ...
                            // The file could not be uploaded because of a server error.
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::tryAGI.OpenAI.OpenAIFile.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::tryAGI.OpenAI.AutoSDKHttpResponse<global::tryAGI.OpenAI.OpenAIFile>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::tryAGI.OpenAI.OpenAIFile.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var request = new global::tryAGI.OpenAI.CreateFileRequest
            {
