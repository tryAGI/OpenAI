...
namespace tryAGI.OpenAI
{
    public partial class ConversationsClient
    {
        ...
        private static readonly global::tryAGI.OpenAI.EndPointSecurityRequirement s_ListConversationItemsSecurityRequirement0 =
        ...
        private static readonly global::tryAGI.OpenAI.EndPointSecurityRequirement[] s_ListConversationItemsSecurityRequirements =
            new global::tryAGI.OpenAI.EndPointSecurityRequirement[]
            {                s_ListConversationItemsSecurityRequirement0,
            };
        ...
        {
            var __response = await ListConversationItemsAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::tryAGI.OpenAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::tryAGI.OpenAI.AutoSDKHttpResponse<global::tryAGI.OpenAI.ConversationItemList>> ListConversationItemsAsResponseAsync(
            string conversationId,
            int? limit = default,
            global::tryAGI.OpenAI.ListConversationItemsOrder? order = default,
            string? after = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::tryAGI.OpenAI.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ListConversationItemsSecurityRequirements,
                operationName: "ListConversationItemsAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "ListConversationItemsAsync",
                ...
                else
                {
                    await global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            // The stored encrypted item content could not be validated.
                            ...
                            // The conversation or the item specified by `after` was not found.
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::tryAGI.OpenAI.ConversationItemList.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::tryAGI.OpenAI.AutoSDKHttpResponse<global::tryAGI.OpenAI.ConversationItemList>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::tryAGI.OpenAI.ConversationItemList.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        /// <summary>
        /// Wraps ListConversationItemsAsync as an IAsyncEnumerable&lt;global::tryAGI.OpenAI.ConversationItem&gt; that auto-pages over the response.
        /// </summary>
        /// <param name="conversationId">
        /// Example: conv_123
        /// </param>
        ...
        public global::System.Collections.Generic.IAsyncEnumerable<global::tryAGI.OpenAI.ConversationItem> ListConversationItemsAutoPagingAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            return global::tryAGI.OpenAI.AutoSDKPager.CursorAsync<global::tryAGI.OpenAI.ConversationItemList, global::tryAGI.OpenAI.ConversationItem>(
                fetchPage: (__cursor, __ct) => ListConversationItemsAsync(
                    conversationId: conversationId,
                    limit: limit,
                    order: order,
                    after: __cursor,
