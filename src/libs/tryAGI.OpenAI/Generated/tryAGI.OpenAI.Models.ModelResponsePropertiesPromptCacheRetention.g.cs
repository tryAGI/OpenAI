...
namespace tryAGI.OpenAI
{
    ...
    /// </summary>
    public enum ModelResponsePropertiesPromptCacheRetention
    {
        /// <summary>
        ///
        /// </summary>
    ...
    /// </summary>
    public static class ModelResponsePropertiesPromptCacheRetentionExtensions
    {
        /// <summary>
        /// Converts an enum to a string.
        /// </summary>
        public static string ToValueString(this ModelResponsePropertiesPromptCacheRetention value)
        {
            return value switch
            {
                ModelResponsePropertiesPromptCacheRetention.x24h => "24h",
                ModelResponsePropertiesPromptCacheRetention.InMemory => "in_memory",
        ...
        /// </summary>
        public static ModelResponsePropertiesPromptCacheRetention? ToEnum(string value)
        {
            return value switch
            {
                "24h" => ModelResponsePropertiesPromptCacheRetention.x24h,
                "in_memory" => ModelResponsePropertiesPromptCacheRetention.InMemory,
                _ => null,
            };
        }
    }
