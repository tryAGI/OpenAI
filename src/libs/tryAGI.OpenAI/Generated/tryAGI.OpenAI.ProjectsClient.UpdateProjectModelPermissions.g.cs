...
namespace tryAGI.OpenAI
{
    public partial class ProjectsClient
    {
        ...
        private static readonly global::tryAGI.OpenAI.EndPointSecurityRequirement s_UpdateProjectModelPermissionsSecurityRequirement0 =
        ...
        private static readonly global::tryAGI.OpenAI.EndPointSecurityRequirement[] s_UpdateProjectModelPermissionsSecurityRequirements =
            new global::tryAGI.OpenAI.EndPointSecurityRequirement[]
            {                s_UpdateProjectModelPermissionsSecurityRequirement0,
            };
        partial void PrepareUpdateProjectModelPermissionsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string projectId,
            global::tryAGI.OpenAI.ProjectModelPermissionsUpdateRequest request);
        partial void PrepareUpdateProjectModelPermissionsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string projectId,
            global::tryAGI.OpenAI.ProjectModelPermissionsUpdateRequest request);
        partial void ProcessUpdateProjectModelPermissionsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessUpdateProjectModelPermissionsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::tryAGI.OpenAI.ProjectModelPermissions> UpdateProjectModelPermissionsAsync(
            string projectId,
        ...
        {
            var __response = await UpdateProjectModelPermissionsAsResponseAsync(
                projectId: projectId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::tryAGI.OpenAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::tryAGI.OpenAI.AutoSDKHttpResponse<global::tryAGI.OpenAI.ProjectModelPermissions>> UpdateProjectModelPermissionsAsResponseAsync(
            string projectId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareUpdateProjectModelPermissionsArguments(
            ...
            var __authorizations = global::tryAGI.OpenAI.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_UpdateProjectModelPermissionsSecurityRequirements,
                operationName: "UpdateProjectModelPermissionsAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareUpdateProjectModelPermissionsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "UpdateProjectModelPermissions",
                                methodName: "UpdateProjectModelPermissionsAsync",
                                pathTemplate: "$\"/organization/projects/{projectId}/model_permissions\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessUpdateProjectModelPermissionsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            // The model permission request is invalid or the project is archived.
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessUpdateProjectModelPermissionsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::tryAGI.OpenAI.ProjectModelPermissions.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::tryAGI.OpenAI.AutoSDKHttpResponse<global::tryAGI.OpenAI.ProjectModelPermissions>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::tryAGI.OpenAI.ProjectModelPermissions.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::tryAGI.OpenAI.ProjectModelPermissions> UpdateProjectModelPermissionsAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::tryAGI.OpenAI.ProjectModelPermissionsUpdateRequest
            {
                Mode = mode,
                ModelIds = modelIds,
            };

            return await UpdateProjectModelPermissionsAsync(
                projectId: projectId,
                request: __request,
                requestOptions: requestOptions,
