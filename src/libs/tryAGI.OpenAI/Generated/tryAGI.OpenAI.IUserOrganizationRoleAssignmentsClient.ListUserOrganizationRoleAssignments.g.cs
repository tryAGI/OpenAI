...
namespace tryAGI.OpenAI
{
    public partial interface IUserOrganizationRoleAssignmentsClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::tryAGI.OpenAI.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::tryAGI.OpenAI.AutoSDKHttpResponse<global::tryAGI.OpenAI.RoleListResource>> ListUserOrganizationRoleAssignmentsAsResponseAsync(
            string userId,
            int? limit = default,
            string? after = default,
            global::tryAGI.OpenAI.ListUserRoleAssignmentsOrder? order = default,
