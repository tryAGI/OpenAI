...
namespace tryAGI.OpenAI
{
    public partial class ChatClient
    {
        ...
        private static readonly global::tryAGI.OpenAI.EndPointSecurityRequirement s_GetChatCompletionMessagesSecurityRequirement0 =
        ...
        private static readonly global::tryAGI.OpenAI.EndPointSecurityRequirement[] s_GetChatCompletionMessagesSecurityRequirements =
            new global::tryAGI.OpenAI.EndPointSecurityRequirement[]
            {                s_GetChatCompletionMessagesSecurityRequirement0,
            };
        ...
        public async global::System.Threading.Tasks.Task<global::tryAGI.OpenAI.ChatCompletionMessageList> GetChatCompletionMessagesAsync(
            string completionId,
        ...
        {
            var __response = await GetChatCompletionMessagesAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::tryAGI.OpenAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::tryAGI.OpenAI.AutoSDKHttpResponse<global::tryAGI.OpenAI.ChatCompletionMessageList>> GetChatCompletionMessagesAsResponseAsync(
            string completionId,
            string? after = default,
            int? limit = default,
            global::tryAGI.OpenAI.GetChatCompletionMessagesOrder? order = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::tryAGI.OpenAI.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetChatCompletionMessagesSecurityRequirements,
                operationName: "GetChatCompletionMessagesAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetChatCompletionMessagesAsync",
                ...
                else
                {
                    await global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            // No stored chat completion was found with the specified ID.
                            ...
                            // An internal error prevented the request from being completed.
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    return new global::tryAGI.OpenAI.AutoSDKHttpResponse<global::tryAGI.OpenAI.ChatCompletionMessageList>(
                                        statusCode: __response.StatusCode,
