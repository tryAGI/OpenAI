...
namespace tryAGI.OpenAI.JsonConverters
{
    ...
    public class EvalGraderTextSimilarityJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::tryAGI.OpenAI.EvalGraderTextSimilarity>
    {
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
                    try
                    {
                        textSimilarityGrader = global::System.Text.Json.JsonSerializer.Deserialize<global::tryAGI.OpenAI.GraderTextSimilarity>(__rawJson, options);
                    }
                ...
                else if (__bestIndex == 1)
                {
                    try
                    {
                        evalGraderTextSimilarityVariant2 = global::System.Text.Json.JsonSerializer.Deserialize<global::tryAGI.OpenAI.EvalGraderTextSimilarityVariant2>(__rawJson, options);
                    }
                    catch (global::System.Text.Json.JsonException)
                    {
                    }
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                global::System.Text.Json.JsonSerializer.Serialize(writer, value.TextSimilarityGrader, typeof(global::tryAGI.OpenAI.GraderTextSimilarity), options);
            }
            else if (value.IsEvalGraderTextSimilarityVariant2)
            {
                global::System.Text.Json.JsonSerializer.Serialize(writer, value.EvalGraderTextSimilarityVariant2, typeof(global::tryAGI.OpenAI.EvalGraderTextSimilarityVariant2), options);
            }
        }
    }
}