...
namespace tryAGI.OpenAI
{
    public partial class VaultsClient
    {
        ...
        private static readonly global::tryAGI.OpenAI.EndPointSecurityRequirement s_RotateVaultCredentialSecurityRequirement0 =
        ...
        private static readonly global::tryAGI.OpenAI.EndPointSecurityRequirement[] s_RotateVaultCredentialSecurityRequirements =
            new global::tryAGI.OpenAI.EndPointSecurityRequirement[]
            {                s_RotateVaultCredentialSecurityRequirement0,
            };
        partial void PrepareRotateVaultCredentialArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string vaultId,
            ref string credentialId,
            global::tryAGI.OpenAI.RotateVaultCredentialParams request);
        partial void PrepareRotateVaultCredentialRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string vaultId,
            string credentialId,
            global::tryAGI.OpenAI.RotateVaultCredentialParams request);
        partial void ProcessRotateVaultCredentialResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessRotateVaultCredentialResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::tryAGI.OpenAI.VaultCredentialResource> RotateVaultCredentialAsync(
            string vaultId,
            string credentialId,
        ...
        {
            var __response = await RotateVaultCredentialAsResponseAsync(
                vaultId: vaultId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::tryAGI.OpenAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::tryAGI.OpenAI.AutoSDKHttpResponse<global::tryAGI.OpenAI.VaultCredentialResource>> RotateVaultCredentialAsResponseAsync(
            string vaultId,
            string credentialId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareRotateVaultCredentialArguments(
            ...
            var __authorizations = global::tryAGI.OpenAI.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_RotateVaultCredentialSecurityRequirements,
                operationName: "RotateVaultCredentialAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareRotateVaultCredentialRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "RotateVaultCredentialAsync",
                                pathTemplate: "$\"/vaults/{vaultId}/credentials/{credentialId}\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessRotateVaultCredentialResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            // The requested vault or credential was not found.
                            ...
                            // The request conflicted with the current vault state.
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessRotateVaultCredentialResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::tryAGI.OpenAI.VaultCredentialResource.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::tryAGI.OpenAI.AutoSDKHttpResponse<global::tryAGI.OpenAI.VaultCredentialResource>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::tryAGI.OpenAI.VaultCredentialResource.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::tryAGI.OpenAI.VaultCredentialResource> RotateVaultCredentialAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::tryAGI.OpenAI.RotateVaultCredentialParams
            {
                Auth = auth,
                Metadata = metadata,
            };

            return await RotateVaultCredentialAsync(
                vaultId: vaultId,
                credentialId: credentialId,
                request: __request,
                requestOptions: requestOptions,
