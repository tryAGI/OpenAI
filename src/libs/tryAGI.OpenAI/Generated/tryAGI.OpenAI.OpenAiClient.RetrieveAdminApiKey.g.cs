...
namespace tryAGI.OpenAI
{
    public partial class OpenAiClient
    {
        ...
        partial void PrepareRetrieveAdminApiKeyArguments(
            ...
            ref string keyId);
        partial void PrepareRetrieveAdminApiKeyRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string keyId);
        partial void ProcessRetrieveAdminApiKeyResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task<global::tryAGI.OpenAI.AdminApiKey> RetrieveAdminApiKeyAsync(
            string keyId,
            global::tryAGI.OpenAI.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await RetrieveAdminApiKeyAsResponseAsync(
                keyId: keyId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::tryAGI.OpenAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::tryAGI.OpenAI.AutoSDKHttpResponse<global::tryAGI.OpenAI.AdminApiKey>> RetrieveAdminApiKeyAsResponseAsync(
            string keyId,
            global::tryAGI.OpenAI.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareRetrieveAdminApiKeyArguments(
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "RetrieveAdminApiKey",
                                methodName: "RetrieveAdminApiKeyAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessRetrieveAdminApiKeyResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessRetrieveAdminApiKeyResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
