...
namespace tryAGI.OpenAI.JsonConverters
{
    ...
    public class ItemFieldJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::tryAGI.OpenAI.ItemField>
    {
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            if (__jsonProps.Contains("namespace")) __score1++;
            if (__jsonProps.Contains("status")) __score1++;
            if (__jsonProps.Contains("type")) __score1++;
            var __score2 = 0;
            if (__jsonProps.Contains("arguments")) __score2++;
            if (__jsonProps.Contains("call_id")) __score2++;
            if (__jsonProps.Contains("created_by")) __score2++;
            if (__jsonProps.Contains("execution")) __score2++;
            if (__jsonProps.Contains("id")) __score2++;
            if (__jsonProps.Contains("status")) __score2++;
            if (__jsonProps.Contains("type")) __score2++;
            var __score3 = 0;
            if (__jsonProps.Contains("call_id")) __score3++;
            if (__jsonProps.Contains("created_by")) __score3++;
            if (__jsonProps.Contains("execution")) __score3++;
            ...
            if (__bestIndex >= 0)
            {
                ...
                else if (__bestIndex == 4)
                {
                    try
                    {
                        functionCallOutput = global::System.Text.Json.JsonSerializer.Deserialize<global::tryAGI.OpenAI.FunctionToolCallOutput>(__rawJson, options);
                    }
                    catch (global::System.Text.Json.JsonException)
                    {
                    }
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                global::System.Text.Json.JsonSerializer.Serialize(writer, value.FunctionCallOutput, typeof(global::tryAGI.OpenAI.FunctionToolCallOutput), options);
            }
