...
{
    /// <inheritdoc />
    public class ItemFieldJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::tryAGI.OpenAI.ItemField>
    {
        /// <inheritdoc />
        public override global::tryAGI.OpenAI.ItemField Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            if (__jsonProps.Contains("created_by")) __score4++;
            if (__jsonProps.Contains("execution")) __score4++;
            if (__jsonProps.Contains("id")) __score4++;
            if (__jsonProps.Contains("status")) __score4++;
            if (__jsonProps.Contains("type")) __score4++;
            var __score5 = 0;
            if (__jsonProps.Contains("call_id")) __score5++;
            if (__jsonProps.Contains("created_by")) __score5++;
            if (__jsonProps.Contains("execution")) __score5++;
            ...
            if (__jsonProps.Contains("queries")) __score8++;
            if (__jsonProps.Contains("results")) __score8++;
            ...
            if (__jsonProps.Contains("background")) __score10++;
            if (__jsonProps.Contains("id")) __score10++;
            if (__jsonProps.Contains("output_format")) __score10++;
            if (__jsonProps.Contains("quality")) __score10++;
            if (__jsonProps.Contains("result")) __score10++;
            if (__jsonProps.Contains("revised_prompt")) __score10++;
            if (__jsonProps.Contains("size")) __score10++;
            ...
            if (__jsonProps.Contains("pending_safety_checks")) __score11++;
            if (__jsonProps.Contains("status")) __score11++;
            if (__jsonProps.Contains("type")) __score11++;
            var __score12 = 0;
            var __score13 = 0;
            if (__jsonProps.Contains("content")) __score13++;
            if (__jsonProps.Contains("encrypted_content")) __score13++;
            if (__jsonProps.Contains("id")) __score13++;
            if (__jsonProps.Contains("status")) __score13++;
            if (__jsonProps.Contains("summary")) __score13++;
            ...
            if (__jsonProps.Contains("container_id")) __score15++;
            if (__jsonProps.Contains("id")) __score15++;
            if (__jsonProps.Contains("outputs")) __score15++;
            if (__jsonProps.Contains("status")) __score15++;
            if (__jsonProps.Contains("type")) __score15++;
            var __score16 = 0;
            if (__jsonProps.Contains("action")) __score16++;
            if (__jsonProps.Contains("action.command")) __score16++;
            if (__jsonProps.Contains("action.env")) __score16++;
            if (__jsonProps.Contains("action.timeout_ms")) __score16++;
            if (__jsonProps.Contains("action.type")) __score16++;
            if (__jsonProps.Contains("action.user")) __score16++;
            if (__jsonProps.Contains("action.working_directory")) __score16++;
            ...
            if (__jsonProps.Contains("action.commands")) __score18++;
            if (__jsonProps.Contains("action.max_output_length")) __score18++;
            if (__jsonProps.Contains("action.timeout_ms")) __score18++;
            if (__jsonProps.Contains("call_id")) __score18++;
            if (__jsonProps.Contains("caller")) __score18++;
            if (__jsonProps.Contains("created_by")) __score18++;
            if (__jsonProps.Contains("environment")) __score18++;
            ...
            if (__jsonProps.Contains("max_output_length")) __score19++;
            ...
            if (__jsonProps.Contains("operation")) __score20++;
            ...
            if (__jsonProps.Contains("tools")) __score22++;
            ...
            if (__jsonProps.Contains("approve")) __score24++;
            if (__jsonProps.Contains("id")) __score24++;
            if (__jsonProps.Contains("reason")) __score24++;
            ...
            if (__jsonProps.Contains("input")) __score26++;
            if (__jsonProps.Contains("name")) __score26++;
            if (__jsonProps.Contains("namespace")) __score26++;
            if (__jsonProps.Contains("type")) __score26++;
            var __score27 = 0;
            if (__jsonProps.Contains("call_id")) __score27++;
            if (__jsonProps.Contains("caller")) __score27++;
            ...
            if (__bestIndex >= 0)
            {
                ...
                else if (__bestIndex == 1)
                {
                    try
                    {
                        var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::tryAGI.OpenAI.Program), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::tryAGI.OpenAI.Program> ??
                                       throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(global::tryAGI.OpenAI.Program).Name}");
                ...
                else if (__bestIndex == 2)
                {
                    try
                    {
                        var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::tryAGI.OpenAI.ProgramOutput), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::tryAGI.OpenAI.ProgramOutput> ??
                                       throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(global::tryAGI.OpenAI.ProgramOutput).Name}");
        ...
        public override void Write(
            ...
            global::tryAGI.OpenAI.ItemField value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
