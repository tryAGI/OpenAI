...
namespace tryAGI.OpenAI
{
    public partial class AudioClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::tryAGI.OpenAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::tryAGI.OpenAI.AutoSDKHttpResponse<global::tryAGI.OpenAI.VoiceConsentResource>> CreateVoiceConsentAsResponseAsync(
            ...
            try
            {
                ...
                else
                {
                    await global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            // Invalid consent recording or consent phrase.
                            ...
                            // The endpoint is unavailable to this caller.
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            {
                Name = name,
                Recording = global::System.Array.Empty<byte>(),
                Recordingname = recordingname,
                Language = language,
            };
            PrepareArguments(
