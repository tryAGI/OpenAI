...
namespace tryAGI.OpenAI
{
    public partial class UserOrganizationRoleAssignmentsClient
    {
        ...
        partial void PrepareAssignOrganizationRoleToUserRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string userId,
            global::tryAGI.OpenAI.PublicAssignOrganizationGroupRoleBody request);
        partial void ProcessAssignOrganizationRoleToUserResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task<global::tryAGI.OpenAI.UserRoleAssignment> AssignOrganizationRoleToUserAsync(
            string userId,
        ...
        {
            var __response = await AssignOrganizationRoleToUserAsResponseAsync(
                userId: userId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::tryAGI.OpenAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::tryAGI.OpenAI.AutoSDKHttpResponse<global::tryAGI.OpenAI.UserRoleAssignment>> AssignOrganizationRoleToUserAsResponseAsync(
            string userId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareAssignOrganizationRoleToUserArguments(
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareAssignOrganizationRoleToUserRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "AssignOrganizationRoleToUser",
                                methodName: "AssignOrganizationRoleToUserAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessAssignOrganizationRoleToUserResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessAssignOrganizationRoleToUserResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await AssignOrganizationRoleToUserAsync(
                userId: userId,
                request: __request,
                requestOptions: requestOptions,
