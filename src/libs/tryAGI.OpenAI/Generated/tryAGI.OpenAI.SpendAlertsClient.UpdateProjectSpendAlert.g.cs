...
namespace tryAGI.OpenAI
{
    public partial class SpendAlertsClient
    {
        ...
        private static readonly global::tryAGI.OpenAI.EndPointSecurityRequirement s_UpdateProjectSpendAlertSecurityRequirement0 =
        ...
        private static readonly global::tryAGI.OpenAI.EndPointSecurityRequirement[] s_UpdateProjectSpendAlertSecurityRequirements =
            new global::tryAGI.OpenAI.EndPointSecurityRequirement[]
            {                s_UpdateProjectSpendAlertSecurityRequirement0,
            };
        partial void PrepareUpdateProjectSpendAlertArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string projectId,
            ref string alertId,
            global::tryAGI.OpenAI.CreateSpendAlertBody request);
        partial void PrepareUpdateProjectSpendAlertRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string projectId,
            string alertId,
            global::tryAGI.OpenAI.CreateSpendAlertBody request);
        partial void ProcessUpdateProjectSpendAlertResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessUpdateProjectSpendAlertResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::tryAGI.OpenAI.ProjectSpendAlert> UpdateProjectSpendAlertAsync(
            string projectId,
            string alertId,
        ...
        {
            var __response = await UpdateProjectSpendAlertAsResponseAsync(
                projectId: projectId,
                alertId: alertId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::tryAGI.OpenAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::tryAGI.OpenAI.AutoSDKHttpResponse<global::tryAGI.OpenAI.ProjectSpendAlert>> UpdateProjectSpendAlertAsResponseAsync(
            string projectId,
            string alertId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareUpdateProjectSpendAlertArguments(
            ...
            var __authorizations = global::tryAGI.OpenAI.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_UpdateProjectSpendAlertSecurityRequirements,
                operationName: "UpdateProjectSpendAlertAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::tryAGI.OpenAI.PathBuilder(
                                path: $"/organization/projects/{projectId}/spend_alerts/{alertId}",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareUpdateProjectSpendAlertRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "UpdateProjectSpendAlert",
                                methodName: "UpdateProjectSpendAlertAsync",
                                pathTemplate: "$\"/organization/projects/{projectId}/spend_alerts/{alertId}\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessUpdateProjectSpendAlertResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            // The project or spend alert was not found.
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessUpdateProjectSpendAlertResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::tryAGI.OpenAI.ProjectSpendAlert.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::tryAGI.OpenAI.AutoSDKHttpResponse<global::tryAGI.OpenAI.ProjectSpendAlert>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::tryAGI.OpenAI.ProjectSpendAlert.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await UpdateProjectSpendAlertAsync(
                projectId: projectId,
                alertId: alertId,
                request: __request,
                requestOptions: requestOptions,
