...
{
    /// <inheritdoc />
    public class ToolsItem7JsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::tryAGI.OpenAI.ToolsItem7>
    {
        /// <inheritdoc />
        public override global::tryAGI.OpenAI.ToolsItem7 Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var discriminatorTypeInfo = typeInfoResolver.GetTypeInfo(typeof(global::tryAGI.OpenAI.ModifyAssistantRequestToolDiscriminator), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::tryAGI.OpenAI.ModifyAssistantRequestToolDiscriminator> ??
                            throw new global::System.InvalidOperationException($"Cannot get type info for {nameof(global::tryAGI.OpenAI.ModifyAssistantRequestToolDiscriminator)}");
            var discriminator = global::System.Text.Json.JsonSerializer.Deserialize(ref readerCopy, discriminatorTypeInfo);

            global::tryAGI.OpenAI.AssistantToolsCode? codeInterpreter = default;
            if (discriminator?.Type == global::tryAGI.OpenAI.ModifyAssistantRequestToolDiscriminatorType.CodeInterpreter)
            {
            ...
            if (discriminator?.Type == global::tryAGI.OpenAI.ModifyAssistantRequestToolDiscriminatorType.FileSearch)
            {
            ...
            if (discriminator?.Type == global::tryAGI.OpenAI.ModifyAssistantRequestToolDiscriminatorType.Function)
            {
            ...
            var result = new global::tryAGI.OpenAI.ToolsItem7(
                discriminator?.Type,
                codeInterpreter,
                fileSearch,
                function
        ...
        public override void Write(
            ...
            global::tryAGI.OpenAI.ToolsItem7 value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
