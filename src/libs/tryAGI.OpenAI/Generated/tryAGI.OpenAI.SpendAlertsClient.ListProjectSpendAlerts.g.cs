...
namespace tryAGI.OpenAI
{
    public partial class SpendAlertsClient
    {
        ...
        private static readonly global::tryAGI.OpenAI.EndPointSecurityRequirement s_ListProjectSpendAlertsSecurityRequirement0 =
        ...
        private static readonly global::tryAGI.OpenAI.EndPointSecurityRequirement[] s_ListProjectSpendAlertsSecurityRequirements =
            new global::tryAGI.OpenAI.EndPointSecurityRequirement[]
            {                s_ListProjectSpendAlertsSecurityRequirement0,
            };
        partial void PrepareListProjectSpendAlertsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string projectId,
            ref int? limit,
            ref global::tryAGI.OpenAI.ListProjectSpendAlertsOrder? order,
            ref string? after,
            ref string? before);
        partial void PrepareListProjectSpendAlertsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string projectId,
            int? limit,
            global::tryAGI.OpenAI.ListProjectSpendAlertsOrder? order,
            string? after,
            string? before);
        partial void ProcessListProjectSpendAlertsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessListProjectSpendAlertsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::tryAGI.OpenAI.ProjectSpendAlertListResource> ListProjectSpendAlertsAsync(
            string projectId,
            int? limit = default,
        ...
        {
            var __response = await ListProjectSpendAlertsAsResponseAsync(
                projectId: projectId,
                limit: limit,
                order: order,
                after: after,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::tryAGI.OpenAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::tryAGI.OpenAI.AutoSDKHttpResponse<global::tryAGI.OpenAI.ProjectSpendAlertListResource>> ListProjectSpendAlertsAsResponseAsync(
            string projectId,
            int? limit = default,
            global::tryAGI.OpenAI.ListProjectSpendAlertsOrder? order = default,
            string? after = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareListProjectSpendAlertsArguments(
            ...
            var __authorizations = global::tryAGI.OpenAI.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ListProjectSpendAlertsSecurityRequirements,
                operationName: "ListProjectSpendAlertsAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareListProjectSpendAlertsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ListProjectSpendAlerts",
                                methodName: "ListProjectSpendAlertsAsync",
                                pathTemplate: "$\"/organization/projects/{projectId}/spend_alerts\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessListProjectSpendAlertsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            // The project or spend alert pagination cursor was not found.
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessListProjectSpendAlertsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::tryAGI.OpenAI.ProjectSpendAlertListResource.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::tryAGI.OpenAI.AutoSDKHttpResponse<global::tryAGI.OpenAI.ProjectSpendAlertListResource>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::tryAGI.OpenAI.ProjectSpendAlertListResource.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
