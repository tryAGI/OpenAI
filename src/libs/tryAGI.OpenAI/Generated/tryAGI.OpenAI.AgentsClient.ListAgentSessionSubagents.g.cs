...
namespace tryAGI.OpenAI
{
    public partial class AgentsClient
    {
        ...
        private static readonly global::tryAGI.OpenAI.EndPointSecurityRequirement s_ListAgentSessionSubagentsSecurityRequirement0 =
        ...
        private static readonly global::tryAGI.OpenAI.EndPointSecurityRequirement[] s_ListAgentSessionSubagentsSecurityRequirements =
            new global::tryAGI.OpenAI.EndPointSecurityRequirement[]
            {                s_ListAgentSessionSubagentsSecurityRequirement0,
            };
        partial void PrepareListAgentSessionSubagentsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string sessionId,
            ref long? limit,
            ref global::tryAGI.OpenAI.ListOrderParam? order,
            ref string? after);
        partial void PrepareListAgentSessionSubagentsRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? after);
        partial void ProcessListAgentSessionSubagentsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessListAgentSessionSubagentsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::tryAGI.OpenAI.ListAgentSessionSubagentsResponse> ListAgentSessionSubagentsAsync(
            string sessionId,
            long? limit = default,
        ...
        {
            var __response = await ListAgentSessionSubagentsAsResponseAsync(
                sessionId: sessionId,
                limit: limit,
                order: order,
                after: after,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::tryAGI.OpenAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::tryAGI.OpenAI.AutoSDKHttpResponse<global::tryAGI.OpenAI.ListAgentSessionSubagentsResponse>> ListAgentSessionSubagentsAsResponseAsync(
            string sessionId,
            long? limit = default,
            global::tryAGI.OpenAI.ListOrderParam? order = default,
            string? after = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareListAgentSessionSubagentsArguments(
            ...
            var __authorizations = global::tryAGI.OpenAI.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ListAgentSessionSubagentsSecurityRequirements,
                operationName: "ListAgentSessionSubagentsAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareListAgentSessionSubagentsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "ListAgentSessionSubagentsAsync",
                                pathTemplate: "$\"/agents/sessions/{sessionId}/subagents\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessListAgentSessionSubagentsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessListAgentSessionSubagentsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::tryAGI.OpenAI.ListAgentSessionSubagentsResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::tryAGI.OpenAI.AutoSDKHttpResponse<global::tryAGI.OpenAI.ListAgentSessionSubagentsResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::tryAGI.OpenAI.ListAgentSessionSubagentsResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public global::System.Collections.Generic.IAsyncEnumerable<global::tryAGI.OpenAI.SubagentResource> ListAgentSessionSubagentsAutoPagingAsync(
            string sessionId,             long? limit = default,
            global::tryAGI.OpenAI.ListOrderParam? order = default,
            string? after = null,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            return global::tryAGI.OpenAI.AutoSDKPager.CursorAsync<global::tryAGI.OpenAI.ListAgentSessionSubagentsResponse, global::tryAGI.OpenAI.SubagentResource>(
                fetchPage: (__cursor, __ct) => ListAgentSessionSubagentsAsync(
                    sessionId: sessionId,
                    limit: limit,
                    order: order,
                    after: __cursor,
                ...
                extractItems: static __response => __response is null
                    ? null
                    : (global::System.Collections.Generic.IEnumerable<global::tryAGI.OpenAI.SubagentResource>?)__response.Data,
