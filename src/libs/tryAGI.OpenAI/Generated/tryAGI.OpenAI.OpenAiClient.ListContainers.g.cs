            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if (ReadResponseAsString)
            {
                ...
                try
                {
                    ...
                    return
                        global::tryAGI.OpenAI.ContainerListResource.FromJson(__content, JsonSerializerContext) ??
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::tryAGI.OpenAI.ContainerListResource.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
