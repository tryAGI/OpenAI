...
namespace tryAGI.OpenAI
{
    public partial class OpenAiClient
    {
        ...
        partial void ProcessListContainersResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        {
            var __response = await ListContainersAsResponseAsync(
                limit: limit,
                order: order,
                after: after,
                name: name,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::tryAGI.OpenAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::tryAGI.OpenAI.AutoSDKHttpResponse<global::tryAGI.OpenAI.ContainerListResource>> ListContainersAsResponseAsync(
            int? limit = default,
            global::tryAGI.OpenAI.ListContainersOrder? order = default,
            string? after = default,
            string? name = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareListContainersArguments(
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "ListContainersAsync",
                                pathTemplate: "\"/containers\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            // The container specified by `after` was not found.
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessListContainersResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::tryAGI.OpenAI.ContainerListResource.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::tryAGI.OpenAI.AutoSDKHttpResponse<global::tryAGI.OpenAI.ContainerListResource>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::tryAGI.OpenAI.ContainerListResource.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public global::System.Collections.Generic.IAsyncEnumerable<global::tryAGI.OpenAI.ContainerResource> ListContainersAutoPagingAsync(
              int? limit = default,
            global::tryAGI.OpenAI.ListContainersOrder? order = default,
            string? name = default,
            string? after = null,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            return global::tryAGI.OpenAI.AutoSDKPager.CursorAsync<global::tryAGI.OpenAI.ContainerListResource, global::tryAGI.OpenAI.ContainerResource>(
                fetchPage: (__cursor, __ct) => ListContainersAsync(
                    limit: limit,
                    order: order,
                    after: __cursor,
                    name: name,
                ...
                extractItems: static __response => __response is null
                    ? null
                    : (global::System.Collections.Generic.IEnumerable<global::tryAGI.OpenAI.ContainerResource>?)__response.Data,
