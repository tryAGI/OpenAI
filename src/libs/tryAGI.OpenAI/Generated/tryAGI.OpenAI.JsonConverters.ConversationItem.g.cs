...
namespace tryAGI.OpenAI.JsonConverters
{
    ...
    public class ConversationItemJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::tryAGI.OpenAI.ConversationItem>
    {
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            if (__jsonProps.Contains("background")) __score5++;
            if (__jsonProps.Contains("id")) __score5++;
            if (__jsonProps.Contains("output_format")) __score5++;
            if (__jsonProps.Contains("quality")) __score5++;
            if (__jsonProps.Contains("result")) __score5++;
            if (__jsonProps.Contains("revised_prompt")) __score5++;
            if (__jsonProps.Contains("size")) __score5++;
            ...
            if (message == null && functionToolCallResource == null && functionToolCallOutputResource == null && fileSearchCall == null && webSearchCall == null && imageGenerationCall == null && computerCall == null && computerToolCallOutputResource == null && toolSearchCall == null && toolSearchOutput == null && additionalTools == null && configurationUpdate == null && reasoning == null && program == null && programOutput == null && compaction == null && codeInterpreterCall == null && localShellCall == null && localShellCallOutput == null && shellCall == null && shellCallOutput == null && applyPatchCall == null && applyPatchCallOutput == null && mcpListTools == null && mcpApprovalRequest == null && mcpApprovalResponse == null && mcpCall == null && customToolCall == null && customToolCallOutput == null)
            {
                try
                {
