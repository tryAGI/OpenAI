...
namespace tryAGI.OpenAI
{
    ...
    public static class ConversationItemDiscriminatorTypeExtensions
    {
        ...
        public static string ToValueString(this ConversationItemDiscriminatorType value)
        {
            return value switch
            {
                ConversationItemDiscriminatorType.AdditionalTools => "additional_tools",
                ...
                ConversationItemDiscriminatorType.ConfigurationUpdate => "configuration_update",
                ...
                ConversationItemDiscriminatorType.Program => "program",
                ConversationItemDiscriminatorType.ProgramOutput => "program_output",
        ...
        public static ConversationItemDiscriminatorType? ToEnum(string value)
        {
            return value switch
            {
                "additional_tools" => ConversationItemDiscriminatorType.AdditionalTools,
                ...
                "configuration_update" => ConversationItemDiscriminatorType.ConfigurationUpdate,
                ...
                "program" => ConversationItemDiscriminatorType.Program,
                "program_output" => ConversationItemDiscriminatorType.ProgramOutput,
