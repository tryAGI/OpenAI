...
namespace tryAGI.OpenAI
{
    public partial class LiveClient
    {
        ...
        private static readonly global::tryAGI.OpenAI.EndPointSecurityRequirement s_AcceptLiveSessionSecurityRequirement0 =
        ...
        private static readonly global::tryAGI.OpenAI.EndPointSecurityRequirement[] s_AcceptLiveSessionSecurityRequirements =
            new global::tryAGI.OpenAI.EndPointSecurityRequirement[]
            {                s_AcceptLiveSessionSecurityRequirement0,
            };
        partial void PrepareAcceptLiveSessionArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string sessionId,
            global::tryAGI.OpenAI.LiveCallAcceptRequest request);
        partial void PrepareAcceptLiveSessionRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string sessionId,
            global::tryAGI.OpenAI.LiveCallAcceptRequest request);
        partial void ProcessAcceptLiveSessionResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task AcceptLiveSessionAsync(
            string sessionId,
        ...
        {
            await AcceptLiveSessionAsResponseAsync(
                sessionId: sessionId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::tryAGI.OpenAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::tryAGI.OpenAI.AutoSDKHttpResponse> AcceptLiveSessionAsResponseAsync(
            string sessionId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareAcceptLiveSessionArguments(
            ...
            var __authorizations = global::tryAGI.OpenAI.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_AcceptLiveSessionSecurityRequirements,
                operationName: "AcceptLiveSessionAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareAcceptLiveSessionRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "AcceptLiveSession",
                                methodName: "AcceptLiveSessionAsync",
                                pathTemplate: "$\"/live/sessions/{sessionId}/accept\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessAcceptLiveSessionResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            // Invalid request body or headers.
                            ...
                            // The session or call was not found or is unavailable for this operation.
                            ...
                            // The session or call can no longer accept this operation.
        ...
        public async global::System.Threading.Tasks.Task AcceptLiveSessionAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::tryAGI.OpenAI.LiveCallAcceptRequest
            {
                Session = session,
            };

            await AcceptLiveSessionAsync(
                sessionId: sessionId,
                request: __request,
                requestOptions: requestOptions,
