...
{
    /// <inheritdoc />
    public class ContentVariant1ItemJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::tryAGI.OpenAI.ContentVariant1Item>
    {
        /// <inheritdoc />
        public override global::tryAGI.OpenAI.ContentVariant1Item Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var discriminatorTypeInfo = typeInfoResolver.GetTypeInfo(typeof(global::tryAGI.OpenAI.UserMessageItemParamContentVariant1ItemDiscriminator), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::tryAGI.OpenAI.UserMessageItemParamContentVariant1ItemDiscriminator> ??
                            throw new global::System.InvalidOperationException($"Cannot get type info for {nameof(global::tryAGI.OpenAI.UserMessageItemParamContentVariant1ItemDiscriminator)}");
            var discriminator = global::System.Text.Json.JsonSerializer.Deserialize(ref readerCopy, discriminatorTypeInfo);

            global::tryAGI.OpenAI.InputTextContentParam? inputText = default;
            if (discriminator?.Type == global::tryAGI.OpenAI.UserMessageItemParamContentVariant1ItemDiscriminatorType.InputText)
            {
            ...
            if (discriminator?.Type == global::tryAGI.OpenAI.UserMessageItemParamContentVariant1ItemDiscriminatorType.InputImage)
            {
            ...
            if (discriminator?.Type == global::tryAGI.OpenAI.UserMessageItemParamContentVariant1ItemDiscriminatorType.InputFile)
            {
            ...
            var __value = new global::tryAGI.OpenAI.ContentVariant1Item(
                discriminator?.Type,
                inputText,
        ...
        public override void Write(
            ...
            global::tryAGI.OpenAI.ContentVariant1Item value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
