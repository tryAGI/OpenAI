...
{
    public partial class SpendAlertsClient
    {


        private static readonly global::tryAGI.OpenAI.EndPointSecurityRequirement s_UpdateOrganizationSpendAlertSecurityRequirement0 =
        ...
        private static readonly global::tryAGI.OpenAI.EndPointSecurityRequirement[] s_UpdateOrganizationSpendAlertSecurityRequirements =
            new global::tryAGI.OpenAI.EndPointSecurityRequirement[]
            {                s_UpdateOrganizationSpendAlertSecurityRequirement0,
            };
        partial void PrepareUpdateOrganizationSpendAlertArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string alertId,
            global::tryAGI.OpenAI.CreateSpendAlertBody request);
        partial void PrepareUpdateOrganizationSpendAlertRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string alertId,
            global::tryAGI.OpenAI.CreateSpendAlertBody request);
        partial void ProcessUpdateOrganizationSpendAlertResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessUpdateOrganizationSpendAlertResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);

        /// <summary>
        /// Update organization spend alert<br/>
        ...
        public async global::System.Threading.Tasks.Task<global::tryAGI.OpenAI.OrganizationSpendAlert> UpdateOrganizationSpendAlertAsync(
            string alertId,
        ...
        {
            var __response = await UpdateOrganizationSpendAlertAsResponseAsync(
                alertId: alertId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::tryAGI.OpenAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::tryAGI.OpenAI.AutoSDKHttpResponse<global::tryAGI.OpenAI.OrganizationSpendAlert>> UpdateOrganizationSpendAlertAsResponseAsync(
            string alertId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareUpdateOrganizationSpendAlertArguments(
            ...
            var __authorizations = global::tryAGI.OpenAI.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_UpdateOrganizationSpendAlertSecurityRequirements,
                operationName: "UpdateOrganizationSpendAlertAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::tryAGI.OpenAI.PathBuilder(
                                path: $"/organization/spend_alerts/{alertId}",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareUpdateOrganizationSpendAlertRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "UpdateOrganizationSpendAlert",
                                methodName: "UpdateOrganizationSpendAlertAsync",
                                pathTemplate: "$\"/organization/spend_alerts/{alertId}\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessUpdateOrganizationSpendAlertResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            // The spend alert update is invalid or conflicts with the hard spend limit.
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessUpdateOrganizationSpendAlertResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::tryAGI.OpenAI.OrganizationSpendAlert.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::tryAGI.OpenAI.AutoSDKHttpResponse<global::tryAGI.OpenAI.OrganizationSpendAlert>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::tryAGI.OpenAI.OrganizationSpendAlert.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::tryAGI.OpenAI.OrganizationSpendAlert> UpdateOrganizationSpendAlertAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::tryAGI.OpenAI.CreateSpendAlertBody
            {
            ...
            return await UpdateOrganizationSpendAlertAsync(
                alertId: alertId,
                request: __request,
                requestOptions: requestOptions,
