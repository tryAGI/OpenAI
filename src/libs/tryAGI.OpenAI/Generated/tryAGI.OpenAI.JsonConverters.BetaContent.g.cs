...
{
    /// <inheritdoc />
    public class BetaContentJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::tryAGI.OpenAI.BetaContent>
    {
        /// <inheritdoc />
        public override global::tryAGI.OpenAI.BetaContent Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var __score0 = 0;
            {
                var __ti = typeInfoResolver.GetTypeInfo(typeof(global::tryAGI.OpenAI.BetaInputContent), options);
            ...
            var __score1 = 0;
            {
                var __ti = typeInfoResolver.GetTypeInfo(typeof(global::tryAGI.OpenAI.BetaOutputContent), options);
                if (__ti != null && __ti.Kind == global::System.Text.Json.Serialization.Metadata.JsonTypeInfoKind.Object)
                {
                    foreach (var __prop in __ti.Properties)
                    {
            ...
            global::tryAGI.OpenAI.BetaInputContent? inputContentTypes = default;
            global::tryAGI.OpenAI.BetaOutputContent? outputContentTypes = default;
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
            ...
            var __value = new global::tryAGI.OpenAI.BetaContent(
                inputContentTypes,
        ...
        public override void Write(
            ...
            global::tryAGI.OpenAI.BetaContent value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
