...
{
    /// <inheritdoc />
    public class BetaModelIdsCompactionJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::tryAGI.OpenAI.BetaModelIdsCompaction>
    {
        /// <inheritdoc />
        public override global::tryAGI.OpenAI.BetaModelIdsCompaction Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var __score0 = 0;
            {
                var __ti = typeInfoResolver.GetTypeInfo(typeof(global::tryAGI.OpenAI.BetaModelIdsResponses), options);
            ...
            global::tryAGI.OpenAI.BetaModelIdsResponses? responses = default;
            string? betaModelIdsCompactionVariant2 = default;
            object? betaModelIdsCompactionVariant3 = default;
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
                ...
                else if (__bestIndex == 1)
                {
                    try
                    {
                        ...
                        betaModelIdsCompactionVariant2 = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
                    catch (global::System.Text.Json.JsonException)
                    {
                    }
                ...
                else if (__bestIndex == 2)
                {
                    try
                    {
                        ...
                        betaModelIdsCompactionVariant3 = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
                    catch (global::System.Text.Json.JsonException)
                    {
                    }
            ...
            if (responses == null && betaModelIdsCompactionVariant2 == null && betaModelIdsCompactionVariant3 == null)
            {
                try
                {
            ...
            var __value = new global::tryAGI.OpenAI.BetaModelIdsCompaction(
                responses,
        ...
        public override void Write(
            ...
            global::tryAGI.OpenAI.BetaModelIdsCompaction value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
