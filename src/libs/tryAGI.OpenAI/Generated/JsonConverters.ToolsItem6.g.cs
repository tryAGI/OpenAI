...
{
    /// <inheritdoc />
    public class ToolsItem6JsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::tryAGI.OpenAI.ToolsItem6>
    {
        /// <inheritdoc />
        public override global::tryAGI.OpenAI.ToolsItem6 Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var discriminatorTypeInfo = typeInfoResolver.GetTypeInfo(typeof(global::tryAGI.OpenAI.MessageObjectAttachmentToolDiscriminator), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::tryAGI.OpenAI.MessageObjectAttachmentToolDiscriminator> ??
                            throw new global::System.InvalidOperationException($"Cannot get type info for {nameof(global::tryAGI.OpenAI.MessageObjectAttachmentToolDiscriminator)}");
            var discriminator = global::System.Text.Json.JsonSerializer.Deserialize(ref readerCopy, discriminatorTypeInfo);

            global::tryAGI.OpenAI.AssistantToolsCode? codeInterpreter = default;
            if (discriminator?.Type == global::tryAGI.OpenAI.MessageObjectAttachmentToolDiscriminatorType.CodeInterpreter)
            {
            ...
            if (discriminator?.Type == global::tryAGI.OpenAI.MessageObjectAttachmentToolDiscriminatorType.FileSearch)
            {
            ...
            var result = new global::tryAGI.OpenAI.ToolsItem6(
                discriminator?.Type,
                codeInterpreter,
                fileSearch
                );
        ...
        public override void Write(
            ...
            global::tryAGI.OpenAI.ToolsItem6 value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
