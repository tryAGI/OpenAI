...
namespace tryAGI.OpenAI.JsonConverters
{
    ...
    public class EvalItemContentJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::tryAGI.OpenAI.EvalItemContent>
    {
            ...
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
                    try
                    {
                        ...
                        evalContentItem = global::System.Text.Json.JsonSerializer.Deserialize<global::tryAGI.OpenAI.EvalItemContentItem>(__rawJson, options);
                    }
                ...
                else if (__bestIndex == 1)
                {
                    try
                    {
                        ...
                        anArrayOfInputTextOutputTextInputImageAndInputAudio = global::System.Text.Json.JsonSerializer.Deserialize<global::System.Collections.Generic.IList<global::tryAGI.OpenAI.EvalItemContentItem>>(__rawJson, options);
                    }
                    catch (global::System.Text.Json.JsonException)
                    {
                    }
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                global::System.Text.Json.JsonSerializer.Serialize(writer, value.EvalContentItem, typeof(global::tryAGI.OpenAI.EvalItemContentItem), options);
            }
            else if (value.IsAnArrayOfInputTextOutputTextInputImageAndInputAudio)
            {
                global::System.Text.Json.JsonSerializer.Serialize(writer, value.AnArrayOfInputTextOutputTextInputImageAndInputAudio, typeof(global::System.Collections.Generic.IList<global::tryAGI.OpenAI.EvalItemContentItem>), options);
            }
        }
    }
}