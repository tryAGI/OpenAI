...
namespace tryAGI.OpenAI
{
    public partial class SkillsClient
    {
        ...
        partial void PrepareListSkillVersionsArguments(
            ...
            ref string? after);
        partial void PrepareListSkillVersionsRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? after);
        partial void ProcessListSkillVersionsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessListSkillVersionsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::tryAGI.OpenAI.SkillVersionListResource> ListSkillVersionsAsync(
            string skillId,
            int? limit = default,
        ...
        {
            var __response = await ListSkillVersionsAsResponseAsync(
                skillId: skillId,
                limit: limit,
                order: order,
                after: after,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::tryAGI.OpenAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::tryAGI.OpenAI.AutoSDKHttpResponse<global::tryAGI.OpenAI.SkillVersionListResource>> ListSkillVersionsAsResponseAsync(
            string skillId,
            int? limit = default,
            global::tryAGI.OpenAI.OrderEnum? order = default,
            string? after = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareListSkillVersionsArguments(
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "ListSkillVersionsAsync",
                                pathTemplate: "$\"/skills/{skillId}/versions\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessListSkillVersionsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            // The version specified by `after` does not belong to this skill.
                            ...
                            // The skill or the version specified by `after` was not found.
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessListSkillVersionsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::tryAGI.OpenAI.SkillVersionListResource.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::tryAGI.OpenAI.AutoSDKHttpResponse<global::tryAGI.OpenAI.SkillVersionListResource>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::tryAGI.OpenAI.SkillVersionListResource.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public global::System.Collections.Generic.IAsyncEnumerable<global::tryAGI.OpenAI.SkillVersionResource> ListSkillVersionsAutoPagingAsync(
            string skillId,             int? limit = default,
            global::tryAGI.OpenAI.OrderEnum? order = default,
            string? after = null,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            return global::tryAGI.OpenAI.AutoSDKPager.CursorAsync<global::tryAGI.OpenAI.SkillVersionListResource, global::tryAGI.OpenAI.SkillVersionResource>(
                fetchPage: (__cursor, __ct) => ListSkillVersionsAsync(
                    skillId: skillId,
                    limit: limit,
                    order: order,
                    after: __cursor,
                ...
                extractItems: static __response => __response is null
                    ? null
                    : (global::System.Collections.Generic.IEnumerable<global::tryAGI.OpenAI.SkillVersionResource>?)__response.Data,
