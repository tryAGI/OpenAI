...
namespace tryAGI.OpenAI.JsonConverters
{
    ...
    public class OutputsVariant1ItemJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::tryAGI.OpenAI.OutputsVariant1Item>
    {
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
                    try
                    {
                        logs = global::System.Text.Json.JsonSerializer.Deserialize<global::tryAGI.OpenAI.CodeInterpreterOutputLogs>(__rawJson, options);
                    }
                ...
                else if (__bestIndex == 1)
                {
                    try
                    {
                        image = global::System.Text.Json.JsonSerializer.Deserialize<global::tryAGI.OpenAI.CodeInterpreterOutputImage>(__rawJson, options);
                    }
                    catch (global::System.Text.Json.JsonException)
                    {
                    }
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            if (value.IsLogs)
            {
                global::System.Text.Json.JsonSerializer.Serialize(writer, value.Logs, typeof(global::tryAGI.OpenAI.CodeInterpreterOutputLogs), options);
            }
            else if (value.IsImage)
            {
                global::System.Text.Json.JsonSerializer.Serialize(writer, value.Image, typeof(global::tryAGI.OpenAI.CodeInterpreterOutputImage), options);
            }
        }
    }
}