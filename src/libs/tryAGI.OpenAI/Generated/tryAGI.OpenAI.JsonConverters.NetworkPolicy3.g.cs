...
namespace tryAGI.OpenAI.JsonConverters
{
    ...
    public class NetworkPolicy3JsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::tryAGI.OpenAI.NetworkPolicy3>
    {
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var discriminatorTypeInfo = typeInfoResolver.GetTypeInfo(typeof(global::tryAGI.OpenAI.ContainerAutoParamNetworkPolicyDiscriminator), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::tryAGI.OpenAI.ContainerAutoParamNetworkPolicyDiscriminator> ??
                            throw new global::System.InvalidOperationException($"Cannot get type info for {nameof(global::tryAGI.OpenAI.ContainerAutoParamNetworkPolicyDiscriminator)}");
            var discriminator = global::System.Text.Json.JsonSerializer.Deserialize(ref readerCopy, discriminatorTypeInfo);

            global::tryAGI.OpenAI.ContainerNetworkPolicyDisabledParam? disabled = default;
            if (discriminator?.Type == global::tryAGI.OpenAI.ContainerAutoParamNetworkPolicyDiscriminatorType.Disabled)
            {
            ...
            if (discriminator?.Type == global::tryAGI.OpenAI.ContainerAutoParamNetworkPolicyDiscriminatorType.Allowlist)
            {
