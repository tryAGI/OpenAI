...
namespace tryAGI.OpenAI
{
    public partial class RealtimeClient
    {
        ...
        private static readonly global::tryAGI.OpenAI.EndPointSecurityRequirement s_RejectRealtimeCallSecurityRequirement0 =
        ...
        private static readonly global::tryAGI.OpenAI.EndPointSecurityRequirement[] s_RejectRealtimeCallSecurityRequirements =
            new global::tryAGI.OpenAI.EndPointSecurityRequirement[]
            {                s_RejectRealtimeCallSecurityRequirement0,
            };
        partial void PrepareRejectRealtimeCallArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string callId,
            global::tryAGI.OpenAI.RealtimeCallRejectRequest request);
        partial void PrepareRejectRealtimeCallRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string callId,
            global::tryAGI.OpenAI.RealtimeCallRejectRequest request);
        partial void ProcessRejectRealtimeCallResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task RejectRealtimeCallAsync(
            string callId,
        ...
        {
            await RejectRealtimeCallAsResponseAsync(
                callId: callId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::tryAGI.OpenAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::tryAGI.OpenAI.AutoSDKHttpResponse> RejectRealtimeCallAsResponseAsync(
            string callId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareRejectRealtimeCallArguments(
            ...
            var __authorizations = global::tryAGI.OpenAI.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_RejectRealtimeCallSecurityRequirements,
                operationName: "RejectRealtimeCallAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareRejectRealtimeCallRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "RejectRealtimeCall",
                                methodName: "RejectRealtimeCallAsync",
                                pathTemplate: "$\"/realtime/calls/{callId}/reject\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessRejectRealtimeCallResponse(
                    httpClient: HttpClient,
