...
{
    /// <inheritdoc />
    public class BetaFunctionAndCustomToolCallOutputJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::tryAGI.OpenAI.BetaFunctionAndCustomToolCallOutput>
    {
        /// <inheritdoc />
        public override global::tryAGI.OpenAI.BetaFunctionAndCustomToolCallOutput Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var discriminatorTypeInfo = typeInfoResolver.GetTypeInfo(typeof(global::tryAGI.OpenAI.BetaFunctionAndCustomToolCallOutputDiscriminator), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::tryAGI.OpenAI.BetaFunctionAndCustomToolCallOutputDiscriminator> ??
                            throw new global::System.InvalidOperationException($"Cannot get type info for {nameof(global::tryAGI.OpenAI.BetaFunctionAndCustomToolCallOutputDiscriminator)}");
            var discriminator = global::System.Text.Json.JsonSerializer.Deserialize(ref readerCopy, discriminatorTypeInfo);

            global::tryAGI.OpenAI.BetaInputTextContent? inputText = default;
            if (discriminator?.Type == global::tryAGI.OpenAI.BetaFunctionAndCustomToolCallOutputDiscriminatorType.InputText)
            {
            ...
            if (discriminator?.Type == global::tryAGI.OpenAI.BetaFunctionAndCustomToolCallOutputDiscriminatorType.InputImage)
            {
            ...
            if (discriminator?.Type == global::tryAGI.OpenAI.BetaFunctionAndCustomToolCallOutputDiscriminatorType.InputFile)
            {
            ...
            var __value = new global::tryAGI.OpenAI.BetaFunctionAndCustomToolCallOutput(
                discriminator?.Type,
                inputText,
        ...
        public override void Write(
            ...
            global::tryAGI.OpenAI.BetaFunctionAndCustomToolCallOutput value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
