...
namespace tryAGI.OpenAI
{
    public partial class OpenAiClient
    {
        ...
        private static readonly global::tryAGI.OpenAI.EndPointSecurityRequirement s_ListThreadsMethodSecurityRequirement0 =
        ...
        private static readonly global::tryAGI.OpenAI.EndPointSecurityRequirement[] s_ListThreadsMethodSecurityRequirements =
            new global::tryAGI.OpenAI.EndPointSecurityRequirement[]
            {                s_ListThreadsMethodSecurityRequirement0,
            };
        partial void PrepareListThreadsMethodArguments(
            ...
            ref string? before,
            ref string? user);
        partial void PrepareListThreadsMethodRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? before,
            string? user);
        partial void ProcessListThreadsMethodResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessListThreadsMethodResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);

        /// <summary>
        /// List ChatKit threads<br/>
        ...
        public async global::System.Threading.Tasks.Task<global::tryAGI.OpenAI.ThreadListResource> ListThreadsMethodAsync(
            int? limit = default,
        ...
        {
            var __response = await ListThreadsMethodAsResponseAsync(
                limit: limit,
                order: order,
                after: after,
                before: before,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::tryAGI.OpenAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::tryAGI.OpenAI.AutoSDKHttpResponse<global::tryAGI.OpenAI.ThreadListResource>> ListThreadsMethodAsResponseAsync(
            int? limit = default,
            global::tryAGI.OpenAI.OrderEnum? order = default,
            string? after = default,
            string? before = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareListThreadsMethodArguments(
            ...
            var __authorizations = global::tryAGI.OpenAI.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ListThreadsMethodSecurityRequirements,
                operationName: "ListThreadsMethodAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareListThreadsMethodRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "ListThreadsMethodAsync",
                                pathTemplate: "\"/chatkit/threads\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            // The request is invalid or the required ChatKit beta header is missing or invalid.
                            ...
                            // The thread specified by after was not found or is not accessible.
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessListThreadsMethodResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::tryAGI.OpenAI.ThreadListResource.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::tryAGI.OpenAI.AutoSDKHttpResponse<global::tryAGI.OpenAI.ThreadListResource>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::tryAGI.OpenAI.ThreadListResource.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        /// <summary>
        /// Wraps ListThreadsMethodAsync as an IAsyncEnumerable&lt;global::tryAGI.OpenAI.ThreadResource&gt; that auto-pages over the response.
        /// </summary>
        /// <param name="limit"></param>
        /// <param name="order"></param>
        /// <param name="before">
        ...
        public global::System.Collections.Generic.IAsyncEnumerable<global::tryAGI.OpenAI.ThreadResource> ListThreadsMethodAutoPagingAsync(
              int? limit = default,
            global::tryAGI.OpenAI.OrderEnum? order = default,
            string? before = default,
            string? user = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            return global::tryAGI.OpenAI.AutoSDKPager.CursorAsync<global::tryAGI.OpenAI.ThreadListResource, global::tryAGI.OpenAI.ThreadResource>(
                fetchPage: (__cursor, __ct) => ListThreadsMethodAsync(
                    limit: limit,
                    order: order,
                    after: __cursor,
                    before: before,
                ...
                extractItems: static __response => __response is null
                    ? null
                    : (global::System.Collections.Generic.IEnumerable<global::tryAGI.OpenAI.ThreadResource>?)__response.Data,
