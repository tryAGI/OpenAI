...
{
    /// <inheritdoc />
    public class LiveClientEventJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::tryAGI.OpenAI.LiveClientEvent>
    {
        /// <inheritdoc />
        public override global::tryAGI.OpenAI.LiveClientEvent Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var discriminatorTypeInfo = typeInfoResolver.GetTypeInfo(typeof(global::tryAGI.OpenAI.LiveClientEventDiscriminator), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::tryAGI.OpenAI.LiveClientEventDiscriminator> ??
                            throw new global::System.InvalidOperationException($"Cannot get type info for {nameof(global::tryAGI.OpenAI.LiveClientEventDiscriminator)}");
            var discriminator = global::System.Text.Json.JsonSerializer.Deserialize(ref readerCopy, discriminatorTypeInfo);

            global::tryAGI.OpenAI.LiveSessionStartEvent? sessionStart = default;
            if (discriminator?.Type == global::tryAGI.OpenAI.LiveClientEventDiscriminatorType.SessionStart)
            {
                var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::tryAGI.OpenAI.LiveSessionStartEvent), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::tryAGI.OpenAI.LiveSessionStartEvent> ??
                               throw new global::System.InvalidOperationException($"Cannot get type info for {nameof(global::tryAGI.OpenAI.LiveSessionStartEvent)}");
            ...
            if (discriminator?.Type == global::tryAGI.OpenAI.LiveClientEventDiscriminatorType.SessionUpdate)
            {
            ...
            if (discriminator?.Type == global::tryAGI.OpenAI.LiveClientEventDiscriminatorType.SessionInputAudioAppend)
            {
            ...
            if (discriminator?.Type == global::tryAGI.OpenAI.LiveClientEventDiscriminatorType.SessionInputAudioMute)
            {
            ...
            if (discriminator?.Type == global::tryAGI.OpenAI.LiveClientEventDiscriminatorType.SessionInputAudioUnmute)
            {
            ...
            if (discriminator?.Type == global::tryAGI.OpenAI.LiveClientEventDiscriminatorType.SessionInstructionsAppend)
            {
            ...
            if (discriminator?.Type == global::tryAGI.OpenAI.LiveClientEventDiscriminatorType.SessionThinkingAppend)
            {
            ...
            if (discriminator?.Type == global::tryAGI.OpenAI.LiveClientEventDiscriminatorType.SessionCommentaryAppend)
            {
            ...
            if (discriminator?.Type == global::tryAGI.OpenAI.LiveClientEventDiscriminatorType.ResponseItemCreate)
            {
            ...
            if (discriminator?.Type == global::tryAGI.OpenAI.LiveClientEventDiscriminatorType.ResponseCreate)
            {
            ...
            if (discriminator?.Type == global::tryAGI.OpenAI.LiveClientEventDiscriminatorType.SessionClose)
            {
            ...
            var __value = new global::tryAGI.OpenAI.LiveClientEvent(
                discriminator?.Type,
                sessionStart,
        ...
        public override void Write(
            ...
            global::tryAGI.OpenAI.LiveClientEvent value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
            ...
            {
                var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::tryAGI.OpenAI.LiveSessionStartEvent), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::tryAGI.OpenAI.LiveSessionStartEvent?> ??
                               throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(global::tryAGI.OpenAI.LiveSessionStartEvent).Name}");
