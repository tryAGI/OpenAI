...
{
    /// <inheritdoc />
    public class TemplateItemJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::tryAGI.OpenAI.TemplateItem>
    {
        /// <inheritdoc />
        public override global::tryAGI.OpenAI.TemplateItem Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var
            readerCopy = reader;
            global::tryAGI.OpenAI.EasyInputMessage? easyInputMessage = default;
            try
            {
                ...
                easyInputMessage = global::System.Text.Json.JsonSerializer.Deserialize(ref readerCopy, typeInfo);
            }
            ...
            readerCopy = reader;
            global::tryAGI.OpenAI.EvalItem? eval = default;
            try
            {
                ...
                eval = global::System.Text.Json.JsonSerializer.Deserialize(ref readerCopy, typeInfo);
            }
            catch (global::System.Text.Json.JsonException)
            {
            }

            var result = new global::tryAGI.OpenAI.TemplateItem(
                easyInputMessage,
                eval
                );
        ...
        public override void Write(
            ...
            global::tryAGI.OpenAI.TemplateItem value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
            ...
            else if (value.IsEval)
            {
                var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::tryAGI.OpenAI.EvalItem), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::tryAGI.OpenAI.EvalItem?> ??
                               throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(global::tryAGI.OpenAI.EvalItem).Name}");
                global::System.Text.Json.JsonSerializer.Serialize(writer, value.Eval, typeInfo);
            }
        }
    }
}