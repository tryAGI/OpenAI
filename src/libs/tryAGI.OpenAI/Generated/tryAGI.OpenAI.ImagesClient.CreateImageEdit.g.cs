...
namespace tryAGI.OpenAI
{
    public partial class ImagesClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::tryAGI.OpenAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::tryAGI.OpenAI.AutoSDKHttpResponse<global::tryAGI.OpenAI.ImagesResponse>> CreateImageEditAsResponseAsync(
            ...
            try
            {
                ...
                else
                {
                    await global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            // Invalid image request, including invalid DALL-E parameters or input.
                            ...
                            // The requested DALL-E image endpoint is unavailable because it has been retired.
                            ...
                            // The image could not be generated or processed.
