...
namespace tryAGI.OpenAI
{
    public partial class AudioClient
    {
            ...
            try
            {
                ...
                else
                {
                    await global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            // Invalid speech request, input, output format, or voice.
                            ...
                            // The voice or speech audio could not be processed.
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::tryAGI.OpenAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::tryAGI.OpenAI.AutoSDKHttpResponse<byte[]>> CreateSpeechAsResponseAsync(
