...
namespace tryAGI.OpenAI
{
    public partial class ProjectUserRoleAssignmentsClient
    {
        ...
        private static readonly global::tryAGI.OpenAI.EndPointSecurityRequirement s_AssignProjectUserRoleSecurityRequirement0 =
        ...
        private static readonly global::tryAGI.OpenAI.EndPointSecurityRequirement[] s_AssignProjectUserRoleSecurityRequirements =
            new global::tryAGI.OpenAI.EndPointSecurityRequirement[]
            {                s_AssignProjectUserRoleSecurityRequirement0,
            };
        partial void PrepareAssignProjectUserRoleArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string projectId,
            ref string userId,
            global::tryAGI.OpenAI.PublicAssignOrganizationGroupRoleBody request);
        partial void PrepareAssignProjectUserRoleRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string projectId,
            string userId,
            global::tryAGI.OpenAI.PublicAssignOrganizationGroupRoleBody request);
        partial void ProcessAssignProjectUserRoleResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessAssignProjectUserRoleResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);

        /// <summary>
        /// Assign project role to user<br/>
        ...
        public async global::System.Threading.Tasks.Task<global::tryAGI.OpenAI.UserRoleAssignment> AssignProjectUserRoleAsync(
            string projectId,
            string userId,
        ...
        {
            var __response = await AssignProjectUserRoleAsResponseAsync(
                projectId: projectId,
                userId: userId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::tryAGI.OpenAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::tryAGI.OpenAI.AutoSDKHttpResponse<global::tryAGI.OpenAI.UserRoleAssignment>> AssignProjectUserRoleAsResponseAsync(
            string projectId,
            string userId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareAssignProjectUserRoleArguments(
            ...
            var __authorizations = global::tryAGI.OpenAI.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_AssignProjectUserRoleSecurityRequirements,
                operationName: "AssignProjectUserRoleAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareAssignProjectUserRoleRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "AssignProjectUserRole",
                                methodName: "AssignProjectUserRoleAsync",
                                pathTemplate: "$\"/projects/{projectId}/users/{userId}/roles\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessAssignProjectUserRoleResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            // The endpoint is unavailable or a requested resource was not found in this organization or project.
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessAssignProjectUserRoleResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::tryAGI.OpenAI.UserRoleAssignment.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::tryAGI.OpenAI.AutoSDKHttpResponse<global::tryAGI.OpenAI.UserRoleAssignment>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::tryAGI.OpenAI.UserRoleAssignment.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await AssignProjectUserRoleAsync(
                projectId: projectId,
                userId: userId,
                request: __request,
                requestOptions: requestOptions,
