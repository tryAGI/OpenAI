...
{
    /// <inheritdoc />
    public class BetaOutputContentJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::tryAGI.OpenAI.BetaOutputContent>
    {
        /// <inheritdoc />
        public override global::tryAGI.OpenAI.BetaOutputContent Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var discriminatorTypeInfo = typeInfoResolver.GetTypeInfo(typeof(global::tryAGI.OpenAI.BetaOutputContentDiscriminator), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::tryAGI.OpenAI.BetaOutputContentDiscriminator> ??
                            throw new global::System.InvalidOperationException($"Cannot get type info for {nameof(global::tryAGI.OpenAI.BetaOutputContentDiscriminator)}");
            var discriminator = global::System.Text.Json.JsonSerializer.Deserialize(ref readerCopy, discriminatorTypeInfo);

            global::tryAGI.OpenAI.BetaOutputTextContent? outputText = default;
            if (discriminator?.Type == global::tryAGI.OpenAI.BetaOutputContentDiscriminatorType.OutputText)
            {
            ...
            if (discriminator?.Type == global::tryAGI.OpenAI.BetaOutputContentDiscriminatorType.Refusal)
            {
            ...
            if (discriminator?.Type == global::tryAGI.OpenAI.BetaOutputContentDiscriminatorType.ReasoningText)
            {
            ...
            var __value = new global::tryAGI.OpenAI.BetaOutputContent(
                discriminator?.Type,
                outputText,
        ...
        public override void Write(
            ...
            global::tryAGI.OpenAI.BetaOutputContent value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
