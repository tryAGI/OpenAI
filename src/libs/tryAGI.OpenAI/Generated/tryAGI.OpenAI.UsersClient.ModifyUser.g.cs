...
namespace tryAGI.OpenAI
{
    public partial class UsersClient
    {
        ...
        {
            var __response = await ModifyUserAsResponseAsync(
                userId: userId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::tryAGI.OpenAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::tryAGI.OpenAI.AutoSDKHttpResponse<global::tryAGI.OpenAI.User>> ModifyUserAsResponseAsync(
            string userId,
            ...
            try
            {
                ...
                else
                {
                    await global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            // The requested user role is invalid or the update is not permitted.
