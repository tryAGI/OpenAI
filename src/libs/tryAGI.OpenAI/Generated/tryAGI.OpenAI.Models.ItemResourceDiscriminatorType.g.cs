...
namespace tryAGI.OpenAI
{
    ...
    public static class ItemResourceDiscriminatorTypeExtensions
    {
        ...
        public static string ToValueString(this ItemResourceDiscriminatorType value)
        {
            return value switch
            {
                ItemResourceDiscriminatorType.AdditionalTools => "additional_tools",
                ...
                ItemResourceDiscriminatorType.Program => "program",
                ItemResourceDiscriminatorType.ProgramOutput => "program_output",
        ...
        public static ItemResourceDiscriminatorType? ToEnum(string value)
        {
            return value switch
            {
                "additional_tools" => ItemResourceDiscriminatorType.AdditionalTools,
                ...
                "program" => ItemResourceDiscriminatorType.Program,
                "program_output" => ItemResourceDiscriminatorType.ProgramOutput,
