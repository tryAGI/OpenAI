...
namespace tryAGI.OpenAI
{
    public partial class OpenAiClient
    {
        ...
        private static readonly global::tryAGI.OpenAI.EndPointSecurityRequirement s_RotateWebhookEndpointSigningSecretSecurityRequirement0 =
        ...
        private static readonly global::tryAGI.OpenAI.EndPointSecurityRequirement[] s_RotateWebhookEndpointSigningSecretSecurityRequirements =
            new global::tryAGI.OpenAI.EndPointSecurityRequirement[]
            {                s_RotateWebhookEndpointSigningSecretSecurityRequirement0,
            };
        partial void PrepareRotateWebhookEndpointSigningSecretArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string webhookEndpointId,
            global::tryAGI.OpenAI.PublicRotateSecretBody request);
        partial void PrepareRotateWebhookEndpointSigningSecretRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string webhookEndpointId,
            global::tryAGI.OpenAI.PublicRotateSecretBody request);
        partial void ProcessRotateWebhookEndpointSigningSecretResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessRotateWebhookEndpointSigningSecretResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::tryAGI.OpenAI.WebhookEndpointWithSecretResource> RotateWebhookEndpointSigningSecretAsync(
            string webhookEndpointId,
        ...
        {
            var __response = await RotateWebhookEndpointSigningSecretAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::tryAGI.OpenAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::tryAGI.OpenAI.AutoSDKHttpResponse<global::tryAGI.OpenAI.WebhookEndpointWithSecretResource>> RotateWebhookEndpointSigningSecretAsResponseAsync(
            string webhookEndpointId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareRotateWebhookEndpointSigningSecretArguments(
                httpClient: HttpClient,
                webhookEndpointId: ref webhookEndpointId,
                request: request);


            var __authorizations = global::tryAGI.OpenAI.EndPointSecurityResolver.ResolveAuthorizations(
                availableAuthorizations: Authorizations,
                securityRequirements: s_RotateWebhookEndpointSigningSecretSecurityRequirements,
                operationName: "RotateWebhookEndpointSigningSecretAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareRotateWebhookEndpointSigningSecretRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "RotateWebhookEndpointSigningSecretAsync",
                                pathTemplate: "$\"/webhook_endpoints/{webhookEndpointId}/rotate_secret\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessRotateWebhookEndpointSigningSecretResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            // The webhook endpoint was not found in the authenticated project.
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessRotateWebhookEndpointSigningSecretResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::tryAGI.OpenAI.WebhookEndpointWithSecretResource.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::tryAGI.OpenAI.AutoSDKHttpResponse<global::tryAGI.OpenAI.WebhookEndpointWithSecretResource>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::tryAGI.OpenAI.WebhookEndpointWithSecretResource.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::tryAGI.OpenAI.WebhookEndpointWithSecretResource> RotateWebhookEndpointSigningSecretAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::tryAGI.OpenAI.PublicRotateSecretBody
            {
                KeepOldSecretActiveFor24Hours = keepOldSecretActiveFor24Hours,
            };

            return await RotateWebhookEndpointSigningSecretAsync(
                webhookEndpointId: webhookEndpointId,
                request: __request,
                requestOptions: requestOptions,
