...
namespace tryAGI.OpenAI
{
    public partial class OpenAiClient
    {
        ...
        private static readonly global::tryAGI.OpenAI.EndPointSecurityRequirement s_CreateanAPIkeyforaserviceaccountSecurityRequirement0 =
        ...
        private static readonly global::tryAGI.OpenAI.EndPointSecurityRequirement[] s_CreateanAPIkeyforaserviceaccountSecurityRequirements =
            new global::tryAGI.OpenAI.EndPointSecurityRequirement[]
            {                s_CreateanAPIkeyforaserviceaccountSecurityRequirement0,
            };
        partial void PrepareCreateanAPIkeyforaserviceaccountArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string projectId,
            ref string serviceAccountId,
            global::tryAGI.OpenAI.CreateProjectServiceAccountApiKeyBody request);
        partial void PrepareCreateanAPIkeyforaserviceaccountRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string projectId,
            string serviceAccountId,
            global::tryAGI.OpenAI.CreateProjectServiceAccountApiKeyBody request);
        partial void ProcessCreateanAPIkeyforaserviceaccountResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreateanAPIkeyforaserviceaccountResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);

        /// <summary>
        /// Create an API key for a service account<br/>
        ...
        public async global::System.Threading.Tasks.Task<global::tryAGI.OpenAI.ServiceAccountApiKeyBody> CreateanAPIkeyforaserviceaccountAsync(
            string projectId,
            string serviceAccountId,
        ...
        {
            var __response = await CreateanAPIkeyforaserviceaccountAsResponseAsync(
                projectId: projectId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::tryAGI.OpenAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::tryAGI.OpenAI.AutoSDKHttpResponse<global::tryAGI.OpenAI.ServiceAccountApiKeyBody>> CreateanAPIkeyforaserviceaccountAsResponseAsync(
            string projectId,
            string serviceAccountId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreateanAPIkeyforaserviceaccountArguments(
            ...
            var __authorizations = global::tryAGI.OpenAI.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateanAPIkeyforaserviceaccountSecurityRequirements,
                operationName: "CreateanAPIkeyforaserviceaccountAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreateanAPIkeyforaserviceaccountRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "CreateanAPIkeyforaserviceaccountAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateanAPIkeyforaserviceaccountResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            // The API key request is invalid or the project is archived.
                            ...
                            // The project or service account was not found.
                            ...
                            // The service account already has an API key and cannot create another.
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreateanAPIkeyforaserviceaccountResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::tryAGI.OpenAI.ServiceAccountApiKeyBody.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::tryAGI.OpenAI.AutoSDKHttpResponse<global::tryAGI.OpenAI.ServiceAccountApiKeyBody>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::tryAGI.OpenAI.ServiceAccountApiKeyBody.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::tryAGI.OpenAI.ServiceAccountApiKeyBody> CreateanAPIkeyforaserviceaccountAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::tryAGI.OpenAI.CreateProjectServiceAccountApiKeyBody
            {
                Name = name,
                Scopes = scopes,
            ...
            return await CreateanAPIkeyforaserviceaccountAsync(
                projectId: projectId,
                serviceAccountId: serviceAccountId,
                request: __request,
                requestOptions: requestOptions,
