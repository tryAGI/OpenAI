...
namespace tryAGI.OpenAI
{
    public partial class ProjectGroupRoleAssignmentsClient
    {
        ...
        partial void PrepareListProjectGroupRoleAssignmentsArguments(
            ...
            ref int? limit,
            ref string? after,
            ref global::tryAGI.OpenAI.ListProjectGroupRoleAssignmentsOrder? order);
        partial void PrepareListProjectGroupRoleAssignmentsRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            int? limit,
            string? after,
            global::tryAGI.OpenAI.ListProjectGroupRoleAssignmentsOrder? order);
        partial void ProcessListProjectGroupRoleAssignmentsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessListProjectGroupRoleAssignmentsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);

        /// <summary>
        /// List project group role assignments<br/>
        ...
        public async global::System.Threading.Tasks.Task<global::tryAGI.OpenAI.RoleListResource> ListProjectGroupRoleAssignmentsAsync(
            string projectId,
            string groupId,
            int? limit = default,
        ...
        {
            var __response = await ListProjectGroupRoleAssignmentsAsResponseAsync(
                projectId: projectId,
                groupId: groupId,
                limit: limit,
                after: after,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::tryAGI.OpenAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::tryAGI.OpenAI.AutoSDKHttpResponse<global::tryAGI.OpenAI.RoleListResource>> ListProjectGroupRoleAssignmentsAsResponseAsync(
            string projectId,
            string groupId,
            int? limit = default,
            string? after = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareListProjectGroupRoleAssignmentsArguments(
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareListProjectGroupRoleAssignmentsRequest(
                    httpClient: HttpClient,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ListProjectGroupRoleAssignments",
                                methodName: "ListProjectGroupRoleAssignmentsAsync",
                                pathTemplate: "$\"/projects/{projectId}/groups/{groupId}/roles\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessListProjectGroupRoleAssignmentsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::tryAGI.OpenAI.RoleListResource.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::tryAGI.OpenAI.AutoSDKHttpResponse<global::tryAGI.OpenAI.RoleListResource>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::tryAGI.OpenAI.RoleListResource.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
