...
namespace tryAGI.OpenAI
{
    public partial class VectorStoresClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::tryAGI.OpenAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::tryAGI.OpenAI.AutoSDKHttpResponse<global::tryAGI.OpenAI.VectorStoreFileObject>> CreateVectorStoreFileAsResponseAsync(
            string vectorStoreId,
            ...
            try
            {
                ...
                else
                {
                    await global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            // The file input is invalid, the store has expired, or a file limit would be exceeded.
                            ...
                            // The file could not be attached to the vector store.
