...
namespace tryAGI.OpenAI
{
    ...
    internal sealed partial class UserOrganizationRoleAssignmentsSourceGenerationContextChunk0 : global::System.Text.Json.Serialization.JsonSerializerContext
    {
    }
    /// <summary>
    ///
    /// </summary>
    public sealed partial class UserOrganizationRoleAssignmentsSourceGenerationContext : global::System.Text.Json.Serialization.JsonSerializerContext
    {
        ...
        ///
        /// </summary>
        public static UserOrganizationRoleAssignmentsSourceGenerationContext Default { get; } = new(DefaultOptions);

        private UserOrganizationRoleAssignmentsSourceGenerationContext(global::System.Text.Json.JsonSerializerOptions options)
            : base(options)
        {
        }
        ...
        private sealed class LazyEnumJsonConverterFactory : global::System.Text.Json.Serialization.JsonConverterFactory
        {
            public override bool CanConvert(global::System.Type typeToConvert)
            {
                return
                    ...
                    || typeToConvert == typeof(global::tryAGI.OpenAI.ListUserRoleAssignmentsOrder)
                ...
                global::System.Text.Json.JsonSerializerOptions options)
            {
                ...
                if (typeToConvert == typeof(global::tryAGI.OpenAI.ListUserRoleAssignmentsOrder))
                {
                    return new global::tryAGI.OpenAI.JsonConverters.ListUserRoleAssignmentsOrderJsonConverter();
                }

                if (typeToConvert == typeof(global::tryAGI.OpenAI.ListUserRoleAssignmentsOrder?))
                {
                    return new global::tryAGI.OpenAI.JsonConverters.ListUserRoleAssignmentsOrderNullableJsonConverter();
                }
        ...
        private sealed class LazyChunkResolver : global::System.Text.Json.Serialization.Metadata.IJsonTypeInfoResolver
        {
            ...
            private static global::System.Text.Json.Serialization.Metadata.IJsonTypeInfoResolver CreateResolver(int index)
            {
                return index switch
                {
                    0 => new UserOrganizationRoleAssignmentsSourceGenerationContextChunk0(new global::System.Text.Json.JsonSerializerOptions()),
