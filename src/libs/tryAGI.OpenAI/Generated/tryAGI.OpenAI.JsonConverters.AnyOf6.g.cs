...
{
    /// <inheritdoc />
    public class AnyOfJsonConverter<T1, T2, T3, T4, T5, T6> : global::System.Text.Json.Serialization.JsonConverter<global::tryAGI.OpenAI.AnyOf<T1, T2, T3, T4, T5, T6>>
    {
        /// <inheritdoc />
        public override global::tryAGI.OpenAI.AnyOf<T1, T2, T3, T4, T5, T6> Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var result = new global::tryAGI.OpenAI.AnyOf<T1, T2, T3, T4, T5, T6>(
                value1,
                value2,
                value3,
                value4,
        ...
        public override void Write(
            ...
            global::tryAGI.OpenAI.AnyOf<T1, T2, T3, T4, T5, T6> value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
