...
namespace tryAGI.OpenAI
{
    ...
    public sealed partial class AssistantToolsFileSearchFileSearch
    {
        ...
        /// Note that the file search tool may output fewer than `max_num_results` results. See the [file search tool documentation](https://developers.openai.com/api/docs/guides/tools-file-search#retrieval-customization) for more information.
        /// </summary>
        ...
        public global::tryAGI.OpenAI.FileSearchRankingOptions? RankingOptions { get; set; }
        ...
        public AssistantToolsFileSearchFileSearch(
            int? maxNumResults,
            global::tryAGI.OpenAI.FileSearchRankingOptions? rankingOptions)
        {
