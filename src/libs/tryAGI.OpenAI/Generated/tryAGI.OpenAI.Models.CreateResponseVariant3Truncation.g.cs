...
namespace tryAGI.OpenAI
{
    ...
    /// </summary>
    public enum CreateResponseVariant3Truncation
    {
        /// <summary>
    ...
    /// </summary>
    public static class CreateResponseVariant3TruncationExtensions
    {
        /// <summary>
        /// Converts an enum to a string.
        /// </summary>
        public static string ToValueString(this CreateResponseVariant3Truncation value)
        {
            return value switch
            {
                CreateResponseVariant3Truncation.Auto => "auto",
                CreateResponseVariant3Truncation.Disabled => "disabled",
        ...
        /// </summary>
        public static CreateResponseVariant3Truncation? ToEnum(string value)
        {
            return value switch
            {
                "auto" => CreateResponseVariant3Truncation.Auto,
                "disabled" => CreateResponseVariant3Truncation.Disabled,
                _ => null,
            };
        }
    }
