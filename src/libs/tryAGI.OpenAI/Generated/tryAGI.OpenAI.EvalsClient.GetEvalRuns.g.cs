...
namespace tryAGI.OpenAI
{
    public partial class EvalsClient
    {
        ...
        partial void PrepareGetEvalRunsArguments(
            ...
            ref string? after,
            ref int? limit,
            ref global::tryAGI.OpenAI.GetEvalRunsOrder? order,
            ref global::tryAGI.OpenAI.GetEvalRunsStatus? status);
        partial void PrepareGetEvalRunsRequest(
            ...
            string? after,
            int? limit,
            global::tryAGI.OpenAI.GetEvalRunsOrder? order,
            global::tryAGI.OpenAI.GetEvalRunsStatus? status);
        ...
        public async global::System.Threading.Tasks.Task<global::tryAGI.OpenAI.EvalRunList> GetEvalRunsAsync(
            string evalId,
        ...
        {
            var __response = await GetEvalRunsAsResponseAsync(
                evalId: evalId,
                after: after,
                limit: limit,
                order: order,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::tryAGI.OpenAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::tryAGI.OpenAI.AutoSDKHttpResponse<global::tryAGI.OpenAI.EvalRunList>> GetEvalRunsAsResponseAsync(
            string evalId,
            string? after = default,
            int? limit = default,
            global::tryAGI.OpenAI.GetEvalRunsOrder? order = default,
            ...
            try
            {
                ...
                else
                {
                    await global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            // The run list parameters are invalid.
                            ...
                            // The evaluation or the run specified by `after` was not found.
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::tryAGI.OpenAI.EvalRunList.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::tryAGI.OpenAI.AutoSDKHttpResponse<global::tryAGI.OpenAI.EvalRunList>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::tryAGI.OpenAI.EvalRunList.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
