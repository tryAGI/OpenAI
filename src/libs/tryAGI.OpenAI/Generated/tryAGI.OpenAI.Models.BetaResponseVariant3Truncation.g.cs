...
namespace tryAGI.OpenAI
{
    ...
    /// </summary>
    public enum BetaResponseVariant3Truncation
    {
        /// <summary>
    ...
    /// </summary>
    public static class BetaResponseVariant3TruncationExtensions
    {
        /// <summary>
        /// Converts an enum to a string.
        /// </summary>
        public static string ToValueString(this BetaResponseVariant3Truncation value)
        {
            return value switch
            {
                BetaResponseVariant3Truncation.Auto => "auto",
                BetaResponseVariant3Truncation.Disabled => "disabled",
        ...
        /// </summary>
        public static BetaResponseVariant3Truncation? ToEnum(string value)
        {
            return value switch
            {
                "auto" => BetaResponseVariant3Truncation.Auto,
                "disabled" => BetaResponseVariant3Truncation.Disabled,
                _ => null,
            };
        }
    }
