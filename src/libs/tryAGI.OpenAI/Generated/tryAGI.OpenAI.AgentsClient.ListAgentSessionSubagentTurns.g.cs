...
namespace tryAGI.OpenAI
{
    public partial class AgentsClient
    {
        ...
        private static readonly global::tryAGI.OpenAI.EndPointSecurityRequirement s_ListAgentSessionSubagentTurnsSecurityRequirement0 =
        ...
        private static readonly global::tryAGI.OpenAI.EndPointSecurityRequirement[] s_ListAgentSessionSubagentTurnsSecurityRequirements =
            new global::tryAGI.OpenAI.EndPointSecurityRequirement[]
            {                s_ListAgentSessionSubagentTurnsSecurityRequirement0,
            };
        partial void PrepareListAgentSessionSubagentTurnsArguments(
            ...
            ref string? after);
        partial void PrepareListAgentSessionSubagentTurnsRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? after);
        partial void ProcessListAgentSessionSubagentTurnsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessListAgentSessionSubagentTurnsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::tryAGI.OpenAI.SessionTurnListResource> ListAgentSessionSubagentTurnsAsync(
            string sessionId,
            string subagentId,
            long? limit = default,
        ...
        {
            var __response = await ListAgentSessionSubagentTurnsAsResponseAsync(
                sessionId: sessionId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::tryAGI.OpenAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::tryAGI.OpenAI.AutoSDKHttpResponse<global::tryAGI.OpenAI.SessionTurnListResource>> ListAgentSessionSubagentTurnsAsResponseAsync(
            string sessionId,
            string subagentId,
            long? limit = default,
            global::tryAGI.OpenAI.ListOrderParam? order = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareListAgentSessionSubagentTurnsArguments(
            ...
            var __authorizations = global::tryAGI.OpenAI.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ListAgentSessionSubagentTurnsSecurityRequirements,
                operationName: "ListAgentSessionSubagentTurnsAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::tryAGI.OpenAI.PathBuilder(
                                path: $"/agents/sessions/{sessionId}/subagents/{subagentId}/turns",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareListAgentSessionSubagentTurnsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "ListAgentSessionSubagentTurnsAsync",
                                pathTemplate: "$\"/agents/sessions/{sessionId}/subagents/{subagentId}/turns\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessListAgentSessionSubagentTurnsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessListAgentSessionSubagentTurnsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::tryAGI.OpenAI.SessionTurnListResource.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::tryAGI.OpenAI.AutoSDKHttpResponse<global::tryAGI.OpenAI.SessionTurnListResource>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::tryAGI.OpenAI.SessionTurnListResource.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public global::System.Collections.Generic.IAsyncEnumerable<global::tryAGI.OpenAI.TurnResource> ListAgentSessionSubagentTurnsAutoPagingAsync(
            string sessionId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            return global::tryAGI.OpenAI.AutoSDKPager.CursorAsync<global::tryAGI.OpenAI.SessionTurnListResource, global::tryAGI.OpenAI.TurnResource>(
                fetchPage: (__cursor, __ct) => ListAgentSessionSubagentTurnsAsync(
                    sessionId: sessionId,
                    subagentId: subagentId,
                    limit: limit,
                    order: order,
                ...
                extractItems: static __response => __response is null
                    ? null
                    : (global::System.Collections.Generic.IEnumerable<global::tryAGI.OpenAI.TurnResource>?)__response.Data,
