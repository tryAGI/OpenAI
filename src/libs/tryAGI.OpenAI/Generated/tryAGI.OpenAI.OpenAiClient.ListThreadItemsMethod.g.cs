...
namespace tryAGI.OpenAI
{
    public partial class OpenAiClient
    {
        ...
        private static readonly global::tryAGI.OpenAI.EndPointSecurityRequirement s_ListThreadItemsMethodSecurityRequirement0 =
        ...
        private static readonly global::tryAGI.OpenAI.EndPointSecurityRequirement[] s_ListThreadItemsMethodSecurityRequirements =
            new global::tryAGI.OpenAI.EndPointSecurityRequirement[]
            {                s_ListThreadItemsMethodSecurityRequirement0,
            };
        partial void PrepareListThreadItemsMethodArguments(
            ...
            ref string? after,
            ref string? before);
        partial void PrepareListThreadItemsMethodRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? after,
            string? before);
        partial void ProcessListThreadItemsMethodResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessListThreadItemsMethodResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);

        /// <summary>
        /// List ChatKit thread items<br/>
        ...
        public async global::System.Threading.Tasks.Task<global::tryAGI.OpenAI.ThreadItemListResource> ListThreadItemsMethodAsync(
            string threadId,
            int? limit = default,
        ...
        {
            var __response = await ListThreadItemsMethodAsResponseAsync(
                threadId: threadId,
                limit: limit,
                order: order,
                after: after,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::tryAGI.OpenAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::tryAGI.OpenAI.AutoSDKHttpResponse<global::tryAGI.OpenAI.ThreadItemListResource>> ListThreadItemsMethodAsResponseAsync(
            string threadId,
            int? limit = default,
            global::tryAGI.OpenAI.OrderEnum? order = default,
            string? after = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareListThreadItemsMethodArguments(
            ...
            var __authorizations = global::tryAGI.OpenAI.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ListThreadItemsMethodSecurityRequirements,
                operationName: "ListThreadItemsMethodAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "ListThreadItemsMethodAsync",
                                pathTemplate: "$\"/chatkit/threads/{threadId}/items\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessListThreadItemsMethodResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            // The thread was not found or is not accessible.
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessListThreadItemsMethodResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::tryAGI.OpenAI.ThreadItemListResource.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::tryAGI.OpenAI.AutoSDKHttpResponse<global::tryAGI.OpenAI.ThreadItemListResource>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::tryAGI.OpenAI.ThreadItemListResource.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        /// <summary>
        /// Wraps ListThreadItemsMethodAsync as an IAsyncEnumerable&lt;global::tryAGI.OpenAI.ThreadItem&gt; that auto-pages over the response.
        /// </summary>
        /// <param name="threadId">
        /// Example: cthr_123
        /// </param>
        ...
        public global::System.Collections.Generic.IAsyncEnumerable<global::tryAGI.OpenAI.ThreadItem> ListThreadItemsMethodAutoPagingAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            return global::tryAGI.OpenAI.AutoSDKPager.CursorAsync<global::tryAGI.OpenAI.ThreadItemListResource, global::tryAGI.OpenAI.ThreadItem>(
                fetchPage: (__cursor, __ct) => ListThreadItemsMethodAsync(
                    threadId: threadId,
                    limit: limit,
                    order: order,
                    after: __cursor,
