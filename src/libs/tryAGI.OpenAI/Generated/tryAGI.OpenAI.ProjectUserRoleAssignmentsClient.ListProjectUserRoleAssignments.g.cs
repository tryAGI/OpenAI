...
namespace tryAGI.OpenAI
{
    public partial class ProjectUserRoleAssignmentsClient
    {
        ...
        partial void PrepareListProjectUserRoleAssignmentsArguments(
            ...
            ref int? limit,
            ref string? after,
            ref global::tryAGI.OpenAI.ListProjectUserRoleAssignmentsOrder? order);
        partial void PrepareListProjectUserRoleAssignmentsRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            int? limit,
            string? after,
            global::tryAGI.OpenAI.ListProjectUserRoleAssignmentsOrder? order);
        partial void ProcessListProjectUserRoleAssignmentsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessListProjectUserRoleAssignmentsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::tryAGI.OpenAI.RoleListResource> ListProjectUserRoleAssignmentsAsync(
            string projectId,
            string userId,
            int? limit = default,
        ...
        {
            var __response = await ListProjectUserRoleAssignmentsAsResponseAsync(
                projectId: projectId,
                userId: userId,
                limit: limit,
                after: after,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::tryAGI.OpenAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::tryAGI.OpenAI.AutoSDKHttpResponse<global::tryAGI.OpenAI.RoleListResource>> ListProjectUserRoleAssignmentsAsResponseAsync(
            string projectId,
            string userId,
            int? limit = default,
            string? after = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareListProjectUserRoleAssignmentsArguments(
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ListProjectUserRoleAssignments",
                                methodName: "ListProjectUserRoleAssignmentsAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessListProjectUserRoleAssignmentsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessListProjectUserRoleAssignmentsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
