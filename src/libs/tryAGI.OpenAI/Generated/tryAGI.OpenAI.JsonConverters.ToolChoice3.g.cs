...
{
    /// <inheritdoc />
    public class ToolChoice3JsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::tryAGI.OpenAI.ToolChoice3>
    {
        /// <inheritdoc />
        public override global::tryAGI.OpenAI.ToolChoice3 Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var result = new global::tryAGI.OpenAI.ToolChoice3(
                choiceOptions,
                choiceAllowed,
                choiceTypes,
                choiceFunction,
        ...
        public override void Write(
            ...
            global::tryAGI.OpenAI.ToolChoice3 value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
