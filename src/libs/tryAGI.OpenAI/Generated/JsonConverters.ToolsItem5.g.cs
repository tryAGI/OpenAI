...
namespace tryAGI.OpenAI.JsonConverters
{
    ...
    public class ToolsItem5JsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::tryAGI.OpenAI.ToolsItem5>
    {
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var discriminatorTypeInfo = typeInfoResolver.GetTypeInfo(typeof(global::tryAGI.OpenAI.CreateThreadAndRunRequestToolDiscriminator), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::tryAGI.OpenAI.CreateThreadAndRunRequestToolDiscriminator> ??
                            throw new global::System.InvalidOperationException($"Cannot get type info for {nameof(global::tryAGI.OpenAI.CreateThreadAndRunRequestToolDiscriminator)}");
            var discriminator = global::System.Text.Json.JsonSerializer.Deserialize(ref readerCopy, discriminatorTypeInfo);

            global::tryAGI.OpenAI.AssistantToolsCode? codeInterpreter = default;
            if (discriminator?.Type == global::tryAGI.OpenAI.CreateThreadAndRunRequestToolDiscriminatorType.CodeInterpreter)
            {
            ...
            if (discriminator?.Type == global::tryAGI.OpenAI.CreateThreadAndRunRequestToolDiscriminatorType.FileSearch)
            {
            ...
            if (discriminator?.Type == global::tryAGI.OpenAI.CreateThreadAndRunRequestToolDiscriminatorType.Function)
            {
