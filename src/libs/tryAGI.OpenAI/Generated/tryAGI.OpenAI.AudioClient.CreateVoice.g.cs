...
namespace tryAGI.OpenAI
{
    public partial class AudioClient
    {
            ...
            try
            {
                ...
                else
                {
                    await global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            // The audio sample could not be processed or the voice could not be created.
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    return new global::tryAGI.OpenAI.AutoSDKHttpResponse<global::tryAGI.OpenAI.VoiceResource>(
                                        statusCode: __response.StatusCode,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            {
                Name = name,
                AudioSample = global::System.Array.Empty<byte>(),
                AudioSamplename = audioSamplename,
                Consent = consent,
            };
            PrepareArguments(
