...
{
    /// <inheritdoc />
    public class ContentVariant1Item2JsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::tryAGI.OpenAI.ContentVariant1Item2>
    {
        /// <inheritdoc />
        public override global::tryAGI.OpenAI.ContentVariant1Item2 Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var discriminatorTypeInfo = typeInfoResolver.GetTypeInfo(typeof(global::tryAGI.OpenAI.BetaUserMessageItemParamContentVariant1ItemDiscriminator), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::tryAGI.OpenAI.BetaUserMessageItemParamContentVariant1ItemDiscriminator> ??
                            throw new global::System.InvalidOperationException($"Cannot get type info for {nameof(global::tryAGI.OpenAI.BetaUserMessageItemParamContentVariant1ItemDiscriminator)}");
            var discriminator = global::System.Text.Json.JsonSerializer.Deserialize(ref readerCopy, discriminatorTypeInfo);

            global::tryAGI.OpenAI.BetaInputTextContentParam? inputText = default;
            if (discriminator?.Type == global::tryAGI.OpenAI.BetaUserMessageItemParamContentVariant1ItemDiscriminatorType.InputText)
            {
            ...
            if (discriminator?.Type == global::tryAGI.OpenAI.BetaUserMessageItemParamContentVariant1ItemDiscriminatorType.InputImage)
            {
            ...
            if (discriminator?.Type == global::tryAGI.OpenAI.BetaUserMessageItemParamContentVariant1ItemDiscriminatorType.InputFile)
            {
            ...
            var __value = new global::tryAGI.OpenAI.ContentVariant1Item2(
                discriminator?.Type,
                inputText,
        ...
        public override void Write(
            ...
            global::tryAGI.OpenAI.ContentVariant1Item2 value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
