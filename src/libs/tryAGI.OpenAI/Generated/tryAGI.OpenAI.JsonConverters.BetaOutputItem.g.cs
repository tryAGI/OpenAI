...
{
    /// <inheritdoc />
    public class BetaOutputItemJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::tryAGI.OpenAI.BetaOutputItem>
    {
        /// <inheritdoc />
        public override global::tryAGI.OpenAI.BetaOutputItem Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            if (__jsonProps.Contains("author")) __score4++;
            if (__jsonProps.Contains("content")) __score4++;
            if (__jsonProps.Contains("id")) __score4++;
            if (__jsonProps.Contains("recipient")) __score4++;
            ...
            if (__jsonProps.Contains("arguments")) __score5++;
            ...
            if (__jsonProps.Contains("fingerprint")) __score11++;
            ...
            if (__jsonProps.Contains("agent.agent_name")) __score14++;
            if (__jsonProps.Contains("call_id")) __score14++;
            if (__jsonProps.Contains("created_by")) __score14++;
            if (__jsonProps.Contains("execution")) __score14++;
            ...
            if (__jsonProps.Contains("role")) __score15++;
            if (__jsonProps.Contains("tools")) __score15++;
            ...
            if (__jsonProps.Contains("background")) __score17++;
            if (__jsonProps.Contains("id")) __score17++;
            if (__jsonProps.Contains("output_format")) __score17++;
            if (__jsonProps.Contains("quality")) __score17++;
            if (__jsonProps.Contains("result")) __score17++;
            if (__jsonProps.Contains("revised_prompt")) __score17++;
            if (__jsonProps.Contains("size")) __score17++;
            ...
            global::tryAGI.OpenAI.BetaFunctionToolCallOutputResource? functionToolCallResource = default;
            ...
            global::tryAGI.OpenAI.BetaComputerToolCallOutputResource? computerToolCallResource = default;
            ...
            var __value = new global::tryAGI.OpenAI.BetaOutputItem(
                message,
        ...
        public override void Write(
            ...
            global::tryAGI.OpenAI.BetaOutputItem value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
