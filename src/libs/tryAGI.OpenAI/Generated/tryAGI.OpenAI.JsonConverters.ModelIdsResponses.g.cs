...
namespace tryAGI.OpenAI.JsonConverters
{
    ...
    public class ModelIdsResponsesJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::tryAGI.OpenAI.ModelIdsResponses>
    {
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            global::tryAGI.OpenAI.ModelIdsResponsesEnum? responsesOnlyModel = default;
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
                ...
                else if (__bestIndex == 1)
                {
                    try
                    {
                        ...
                        responsesOnlyModel = global::System.Text.Json.JsonSerializer.Deserialize<global::tryAGI.OpenAI.ModelIdsResponsesEnum>(__rawJson, options);
                    }
                    catch (global::System.Text.Json.JsonException)
                    {
                    }
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                global::System.Text.Json.JsonSerializer.Serialize(writer, value.ResponsesOnlyModel, typeof(global::tryAGI.OpenAI.ModelIdsResponsesEnum), options);
            }
        }
    }
}