...
{
    /// <inheritdoc />
    public class BetaResponseJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::tryAGI.OpenAI.BetaResponse>
    {
        /// <inheritdoc />
        public override global::tryAGI.OpenAI.BetaResponse Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            global::tryAGI.OpenAI.BetaModelResponseProperties? modelProperties = default;
            global::tryAGI.OpenAI.BetaResponseProperties? properties = default;
            global::tryAGI.OpenAI.BetaResponseVariant3? betaResponseVariant3 = default;
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
                ...
                else if (__bestIndex == 2)
                {
                    try
                    {
                        var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::tryAGI.OpenAI.BetaResponseVariant3), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::tryAGI.OpenAI.BetaResponseVariant3> ??
                                       throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(global::tryAGI.OpenAI.BetaResponseVariant3).Name}");
                        betaResponseVariant3 = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
                    catch (global::System.Text.Json.JsonException)
                    {
                    }
            ...
            if (modelProperties == null && properties == null && betaResponseVariant3 == null)
            {
                try
                {
            ...
            var __value = new global::tryAGI.OpenAI.BetaResponse(
                modelProperties,
        ...
        public override void Write(
            ...
            global::tryAGI.OpenAI.BetaResponse value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
            ...
            else if (value.IsBetaResponseVariant3)
            {
                var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::tryAGI.OpenAI.BetaResponseVariant3), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::tryAGI.OpenAI.BetaResponseVariant3?> ??
                               throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(global::tryAGI.OpenAI.BetaResponseVariant3).Name}");
                global::System.Text.Json.JsonSerializer.Serialize(writer, value.BetaResponseVariant3!, typeInfo);
            }
        }
    }
}