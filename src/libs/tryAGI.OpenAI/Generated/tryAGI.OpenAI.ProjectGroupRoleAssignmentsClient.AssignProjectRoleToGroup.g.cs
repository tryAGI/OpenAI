...
namespace tryAGI.OpenAI
{
    public partial class ProjectGroupRoleAssignmentsClient
    {
        ...
        partial void PrepareAssignProjectRoleToGroupRequest(
            global::System.Net.Http.HttpClient httpClient,
        ...
        partial void ProcessAssignProjectRoleToGroupResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::tryAGI.OpenAI.GroupRoleAssignment> AssignProjectRoleToGroupAsync(
            string projectId,
            string groupId,
        ...
        {
            var __response = await AssignProjectRoleToGroupAsResponseAsync(
                projectId: projectId,
                groupId: groupId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::tryAGI.OpenAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::tryAGI.OpenAI.AutoSDKHttpResponse<global::tryAGI.OpenAI.GroupRoleAssignment>> AssignProjectRoleToGroupAsResponseAsync(
            string projectId,
            string groupId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareAssignProjectRoleToGroupArguments(
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "AssignProjectRoleToGroup",
                                methodName: "AssignProjectRoleToGroupAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessAssignProjectRoleToGroupResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessAssignProjectRoleToGroupResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await AssignProjectRoleToGroupAsync(
                projectId: projectId,
                groupId: groupId,
                request: __request,
                requestOptions: requestOptions,
