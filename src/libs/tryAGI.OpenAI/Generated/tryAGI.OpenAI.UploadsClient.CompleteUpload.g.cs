...
namespace tryAGI.OpenAI
{
    public partial class UploadsClient
    {
        ...
        public async global::System.Threading.Tasks.Task<global::tryAGI.OpenAI.Upload> CompleteUploadAsync(
            string uploadId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::tryAGI.OpenAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::tryAGI.OpenAI.AutoSDKHttpResponse<global::tryAGI.OpenAI.Upload>> CompleteUploadAsResponseAsync(
            string uploadId,
            ...
            try
            {
                ...
                else
                {
                    await global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            // The upload cannot be completed in its current state, the parts are invalid, or the uploaded size does not match the specified size.
                            ...
                            // The upload has expired. Create a new upload before adding parts or completing it.
                            ...
                            // Too many upload requests. Reduce the request rate and try again later.
                            ...
                            // The upload could not be completed. Retry the same request, preserving the part order and MD5 value.
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::tryAGI.OpenAI.Upload.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::tryAGI.OpenAI.AutoSDKHttpResponse<global::tryAGI.OpenAI.Upload>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::tryAGI.OpenAI.Upload.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
