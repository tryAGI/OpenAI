...
{
    /// <inheritdoc />
    public class VaultStatusFilterParamJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::tryAGI.OpenAI.VaultStatusFilterParam>
    {
        /// <inheritdoc />
        public override global::tryAGI.OpenAI.VaultStatusFilterParam Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var __score0 = 0;
            {
                var __ti = typeInfoResolver.GetTypeInfo(typeof(global::tryAGI.OpenAI.VaultStatusParam), options);
            ...
            var __score1 = 0;
            {
                var __ti = typeInfoResolver.GetTypeInfo(typeof(global::System.Collections.Generic.IList<global::tryAGI.OpenAI.VaultStatusParam>), options);
                if (__ti != null && __ti.Kind == global::System.Text.Json.Serialization.Metadata.JsonTypeInfoKind.Object)
                {
                    foreach (var __prop in __ti.Properties)
                    {
            ...
            global::tryAGI.OpenAI.VaultStatusParam? vaultStatusParam = default;
            global::System.Collections.Generic.IList<global::tryAGI.OpenAI.VaultStatusParam>? vaultStatusFilterParamVariant2 = default;
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
                    try
                    {
                        ...
                        vaultStatusParam = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
                ...
                else if (__bestIndex == 1)
                {
                    try
                    {
                        ...
                        vaultStatusFilterParamVariant2 = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
                    catch (global::System.Text.Json.JsonException)
                    {
                    }
            ...
            if (vaultStatusParam == null && vaultStatusFilterParamVariant2 == null)
            {
                try
                {
            ...
            var __value = new global::tryAGI.OpenAI.VaultStatusFilterParam(
                vaultStatusParam,
        ...
        public override void Write(
            ...
            global::tryAGI.OpenAI.VaultStatusFilterParam value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");

            if (value.IsVaultStatusParam)
            {
                var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::tryAGI.OpenAI.VaultStatusParam), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::tryAGI.OpenAI.VaultStatusParam> ??
                               throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(global::tryAGI.OpenAI.VaultStatusParam).Name}");
