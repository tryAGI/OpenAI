...
namespace tryAGI.OpenAI
{
    ...
    /// </summary>
    public enum BetaResponseVariant3Truncation2
    {
        /// <summary>
    ...
    /// </summary>
    public static class BetaResponseVariant3Truncation2Extensions
    {
        /// <summary>
        /// Converts an enum to a string.
        /// </summary>
        public static string ToValueString(this BetaResponseVariant3Truncation2 value)
        {
            return value switch
            {
                BetaResponseVariant3Truncation2.Auto => "auto",
                BetaResponseVariant3Truncation2.Disabled => "disabled",
        ...
        /// </summary>
        public static BetaResponseVariant3Truncation2? ToEnum(string value)
        {
            return value switch
            {
                "auto" => BetaResponseVariant3Truncation2.Auto,
                "disabled" => BetaResponseVariant3Truncation2.Disabled,
                _ => null,
            };
        }
    }
