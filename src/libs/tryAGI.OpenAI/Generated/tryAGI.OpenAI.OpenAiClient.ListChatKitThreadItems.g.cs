...
namespace tryAGI.OpenAI
{
    public partial class OpenAiClient
    {
        ...
        partial void PrepareListChatKitThreadItemsArguments(
            ...
            ref string? after,
            ref string? before);
        partial void PrepareListChatKitThreadItemsRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? after,
            string? before);
        partial void ProcessListChatKitThreadItemsResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task<global::tryAGI.OpenAI.ThreadItemListResource> ListChatKitThreadItemsAsync(
            string threadId,
            int? limit = default,
        ...
        {
            var __response = await ListChatKitThreadItemsAsResponseAsync(
                threadId: threadId,
                limit: limit,
                order: order,
                after: after,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::tryAGI.OpenAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::tryAGI.OpenAI.AutoSDKHttpResponse<global::tryAGI.OpenAI.ThreadItemListResource>> ListChatKitThreadItemsAsResponseAsync(
            string threadId,
            int? limit = default,
            global::tryAGI.OpenAI.OrderEnum? order = default,
            string? after = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareListChatKitThreadItemsArguments(
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ListChatKitThreadItems",
                                methodName: "ListChatKitThreadItemsAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessListChatKitThreadItemsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessListChatKitThreadItemsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
