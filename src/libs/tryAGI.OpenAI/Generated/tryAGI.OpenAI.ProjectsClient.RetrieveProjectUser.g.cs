            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if (ReadResponseAsString)
            {
                ...
                try
                {
                    ...
                    return
                        global::tryAGI.OpenAI.ProjectUser.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::tryAGI.OpenAI.ProjectUser.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
