    ...
    public static class OutputItemDiscriminatorTypeExtensions
    {
        ...
        public static string ToValueString(this OutputItemDiscriminatorType value)
        {
            return value switch
            {
                ...
                OutputItemDiscriminatorType.Program => "program",
                OutputItemDiscriminatorType.ProgramOutput => "program_output",
        ...
        public static OutputItemDiscriminatorType? ToEnum(string value)
        {
            return value switch
            {
                ...
                "program" => OutputItemDiscriminatorType.Program,
                "program_output" => OutputItemDiscriminatorType.ProgramOutput,
