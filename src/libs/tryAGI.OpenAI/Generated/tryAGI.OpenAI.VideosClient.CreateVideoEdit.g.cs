...
namespace tryAGI.OpenAI
{
    public partial class VideosClient
    {
        ...
        partial void PrepareCreateVideoEditRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::tryAGI.OpenAI.CreateVideoEditMultipartBody request);
        partial void ProcessCreateVideoEditResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreateVideoEditResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::tryAGI.OpenAI.VideoResource> CreateVideoEditAsync(

            global::tryAGI.OpenAI.CreateVideoEditMultipartBody request,
            global::tryAGI.OpenAI.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await CreateVideoEditAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::tryAGI.OpenAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::tryAGI.OpenAI.AutoSDKHttpResponse<global::tryAGI.OpenAI.VideoResource>> CreateVideoEditAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreateVideoEditArguments(
                         ...
                         __authorization.Location == "Header")
                {
                    __httpRequest.Headers.Add(__authorization.Name, __authorization.Value);
                            ...
                            if (request.Video.TryPickValue1(out var __valueVideo1))
                            {
                                ...
                                var __fileNameVideo1 = "file.bin";
                                var __contentVideo1 = new global::System.Net.Http.ByteArrayContent(__valueVideo1 ?? global::System.Array.Empty<byte>());
                                __contentVideo1.Headers.ContentType = new global::System.Net.Http.Headers.MediaTypeHeaderValue(
                                    __fileNameVideo1 is null
                                        ? "application/octet-stream"
                                        : (global::System.IO.Path.GetExtension(__fileNameVideo1) ?? string.Empty).ToLowerInvariant() switch
                                        {
                                            ".aac" => "audio/aac",
                                            ".flac" => "audio/flac",
                                            ".gif" => "image/gif",
                                ...
                                __httpRequestContent.Add(
                                    ...
                                    name: "\"video\"",
                                    fileName: $"\"{__fileNameVideo1}\"");
                                if (__contentVideo1.Headers.ContentDisposition != null)
                                {
                                    __contentVideo1.Headers.ContentDisposition.FileNameStar = null;
                                }
                            }
                            else if (request.Video.TryPickValue2(out var __valueVideo2))
                            {

                                var __contentVideo2 = new global::System.Net.Http.StringContent((__valueVideo2!).ToJson(JsonSerializerContext));
                                __contentVideo2.Headers.ContentType = new global::System.Net.Http.Headers.MediaTypeHeaderValue("application/json");
                                __httpRequestContent.Add(
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "CreateVideoEditAsync",
                                pathTemplate: "\"/videos/edits\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateVideoEditResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreateVideoEditResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::tryAGI.OpenAI.VideoResource.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::tryAGI.OpenAI.AutoSDKHttpResponse<global::tryAGI.OpenAI.VideoResource>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::tryAGI.OpenAI.VideoResource.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::tryAGI.OpenAI.VideoResource> CreateVideoEditAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::tryAGI.OpenAI.CreateVideoEditMultipartBody
            {
                Video = video,
                Prompt = prompt,
            };

            return await CreateVideoEditAsync(
                request: __request,
                requestOptions: requestOptions,
