...
namespace tryAGI.OpenAI
{
    ...
    public sealed partial class BetaResponseTextParam
    {
        ...
        /// [Structured Outputs guide](https://developers.openai.com/api/docs/guides/structured-outputs).<br/>
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::tryAGI.OpenAI.JsonConverters.BetaTextResponseFormatConfigurationJsonConverter))]
        public global::tryAGI.OpenAI.BetaTextResponseFormatConfiguration? Format { get; set; }

        /// <summary>
        ///
        /// </summary>
        [global::System.Text.Json.Serialization.JsonPropertyName("verbosity")]
        public global::tryAGI.OpenAI.BetaVerbosityEnum? Verbosity { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BetaResponseTextParam" /> class.
        /// </summary>
        /// <param name="format">
        /// An object specifying the format that the model must output.<br/>
        /// Configuring `{ "type": "json_schema" }` enables Structured Outputs,<br/>
...
#endif
        public BetaResponseTextParam(
            global::tryAGI.OpenAI.BetaTextResponseFormatConfiguration? format,
            global::tryAGI.OpenAI.BetaVerbosityEnum? verbosity)
        {
            this.Format = format;
