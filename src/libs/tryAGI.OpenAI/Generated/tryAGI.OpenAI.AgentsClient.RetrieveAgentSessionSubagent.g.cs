...
namespace tryAGI.OpenAI
{
    public partial class AgentsClient
    {
        ...
        private static readonly global::tryAGI.OpenAI.EndPointSecurityRequirement s_RetrieveAgentSessionSubagentSecurityRequirement0 =
        ...
        private static readonly global::tryAGI.OpenAI.EndPointSecurityRequirement[] s_RetrieveAgentSessionSubagentSecurityRequirements =
            new global::tryAGI.OpenAI.EndPointSecurityRequirement[]
            {                s_RetrieveAgentSessionSubagentSecurityRequirement0,
            };
        partial void PrepareRetrieveAgentSessionSubagentArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string sessionId,
            ref string subagentId);
        partial void PrepareRetrieveAgentSessionSubagentRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string sessionId,
            string subagentId);
        partial void ProcessRetrieveAgentSessionSubagentResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessRetrieveAgentSessionSubagentResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::tryAGI.OpenAI.SubagentResource> RetrieveAgentSessionSubagentAsync(
            string sessionId,
            string subagentId,
            global::tryAGI.OpenAI.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await RetrieveAgentSessionSubagentAsResponseAsync(
                sessionId: sessionId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::tryAGI.OpenAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::tryAGI.OpenAI.AutoSDKHttpResponse<global::tryAGI.OpenAI.SubagentResource>> RetrieveAgentSessionSubagentAsResponseAsync(
            string sessionId,
            string subagentId,
            global::tryAGI.OpenAI.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareRetrieveAgentSessionSubagentArguments(
            ...
            var __authorizations = global::tryAGI.OpenAI.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_RetrieveAgentSessionSubagentSecurityRequirements,
                operationName: "RetrieveAgentSessionSubagentAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::tryAGI.OpenAI.PathBuilder(
                                path: $"/agents/sessions/{sessionId}/subagents/{subagentId}",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareRetrieveAgentSessionSubagentRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "RetrieveAgentSessionSubagentAsync",
                                pathTemplate: "$\"/agents/sessions/{sessionId}/subagents/{subagentId}\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessRetrieveAgentSessionSubagentResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessRetrieveAgentSessionSubagentResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::tryAGI.OpenAI.SubagentResource.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::tryAGI.OpenAI.AutoSDKHttpResponse<global::tryAGI.OpenAI.SubagentResource>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::tryAGI.OpenAI.SubagentResource.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
