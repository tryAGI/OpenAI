...
{
    public partial class HostedToolsClient
    {


        private static readonly global::tryAGI.OpenAI.EndPointSecurityRequirement s_UpdateProjectHostedToolPermissionsSecurityRequirement0 =
        ...
        private static readonly global::tryAGI.OpenAI.EndPointSecurityRequirement[] s_UpdateProjectHostedToolPermissionsSecurityRequirements =
            new global::tryAGI.OpenAI.EndPointSecurityRequirement[]
            {                s_UpdateProjectHostedToolPermissionsSecurityRequirement0,
            };
        partial void PrepareUpdateProjectHostedToolPermissionsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string projectId,
            global::tryAGI.OpenAI.ProjectHostedToolPermissionsUpdateRequest request);
        partial void PrepareUpdateProjectHostedToolPermissionsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string projectId,
            global::tryAGI.OpenAI.ProjectHostedToolPermissionsUpdateRequest request);
        partial void ProcessUpdateProjectHostedToolPermissionsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessUpdateProjectHostedToolPermissionsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);

        /// <summary>
        /// Modify project hosted tool permissions<br/>
        ...
        public async global::System.Threading.Tasks.Task<global::tryAGI.OpenAI.ProjectHostedToolPermissions> UpdateProjectHostedToolPermissionsAsync(
            string projectId,
        ...
        {
            var __response = await UpdateProjectHostedToolPermissionsAsResponseAsync(
                projectId: projectId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::tryAGI.OpenAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::tryAGI.OpenAI.AutoSDKHttpResponse<global::tryAGI.OpenAI.ProjectHostedToolPermissions>> UpdateProjectHostedToolPermissionsAsResponseAsync(
            string projectId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareUpdateProjectHostedToolPermissionsArguments(
            ...
            var __authorizations = global::tryAGI.OpenAI.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_UpdateProjectHostedToolPermissionsSecurityRequirements,
                operationName: "UpdateProjectHostedToolPermissionsAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareUpdateProjectHostedToolPermissionsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "UpdateProjectHostedToolPermissions",
                                methodName: "UpdateProjectHostedToolPermissionsAsync",
                                pathTemplate: "$\"/organization/projects/{projectId}/hosted_tool_permissions\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessUpdateProjectHostedToolPermissionsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            // The hosted tool permission request is invalid.
                            ...
                            if ((int)__response.StatusCode == 403)
                            {
                                ...
                                global::tryAGI.OpenAI.PermissionErrorResponse? __value_403 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_403 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_403 = global::tryAGI.OpenAI.PermissionErrorResponse.FromJson(__content_403, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_403 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::tryAGI.OpenAI.ApiException<global::tryAGI.OpenAI.PermissionErrorResponse>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            // The requested project setting conflicts with the organization policy.
                            if ((int)__response.StatusCode == 409)
                            {
                                string? __content_409 = null;
                                global::System.Exception? __exception_409 = null;
                                global::tryAGI.OpenAI.ErrorResponse? __value_409 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_409 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_409 = global::tryAGI.OpenAI.ErrorResponse.FromJson(__content_409, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_409 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                            ...
                            // Too many management requests. Reduce the request rate and try again later.
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessUpdateProjectHostedToolPermissionsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::tryAGI.OpenAI.ProjectHostedToolPermissions.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::tryAGI.OpenAI.AutoSDKHttpResponse<global::tryAGI.OpenAI.ProjectHostedToolPermissions>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::tryAGI.OpenAI.ProjectHostedToolPermissions.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::tryAGI.OpenAI.ProjectHostedToolPermissions> UpdateProjectHostedToolPermissionsAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::tryAGI.OpenAI.ProjectHostedToolPermissionsUpdateRequest
            {
            ...
            return await UpdateProjectHostedToolPermissionsAsync(
                projectId: projectId,
                request: __request,
                requestOptions: requestOptions,
