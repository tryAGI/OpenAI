...
namespace tryAGI.OpenAI
{
    public partial class RealtimeClient
    {
        ...
        private static readonly global::tryAGI.OpenAI.EndPointSecurityRequirement s_ReferRealtimeCallSecurityRequirement0 =
        ...
        private static readonly global::tryAGI.OpenAI.EndPointSecurityRequirement[] s_ReferRealtimeCallSecurityRequirements =
            new global::tryAGI.OpenAI.EndPointSecurityRequirement[]
            {                s_ReferRealtimeCallSecurityRequirement0,
            };
        partial void PrepareReferRealtimeCallArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string callId,
            global::tryAGI.OpenAI.RealtimeCallReferRequest request);
        partial void PrepareReferRealtimeCallRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string callId,
            global::tryAGI.OpenAI.RealtimeCallReferRequest request);
        partial void ProcessReferRealtimeCallResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task ReferRealtimeCallAsync(
            string callId,
        ...
        {
            await ReferRealtimeCallAsResponseAsync(
                callId: callId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::tryAGI.OpenAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::tryAGI.OpenAI.AutoSDKHttpResponse> ReferRealtimeCallAsResponseAsync(
            string callId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareReferRealtimeCallArguments(
            ...
            var __authorizations = global::tryAGI.OpenAI.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ReferRealtimeCallSecurityRequirements,
                operationName: "ReferRealtimeCallAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareReferRealtimeCallRequest(
                    httpClient: HttpClient,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ReferRealtimeCall",
                                methodName: "ReferRealtimeCallAsync",
                                pathTemplate: "$\"/realtime/calls/{callId}/refer\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
