...
namespace tryAGI.OpenAI.JsonConverters
{
    ...
    public class InputParamJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::tryAGI.OpenAI.InputParam>
    {
            ...
            if (__bestIndex >= 0)
            {
                ...
                else if (__bestIndex == 1)
                {
                    try
                    {
                        ...
                        inputItemList = global::System.Text.Json.JsonSerializer.Deserialize<global::System.Collections.Generic.IList<global::tryAGI.OpenAI.InputItem>>(__rawJson, options);
                    }
                    catch (global::System.Text.Json.JsonException)
                    {
                    }
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                global::System.Text.Json.JsonSerializer.Serialize(writer, value.InputItemList, typeof(global::System.Collections.Generic.IList<global::tryAGI.OpenAI.InputItem>), options);
            }
        }
    }
}