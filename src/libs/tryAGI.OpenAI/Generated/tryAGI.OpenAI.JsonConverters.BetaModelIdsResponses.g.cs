...
{
    /// <inheritdoc />
    public class BetaModelIdsResponsesJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::tryAGI.OpenAI.BetaModelIdsResponses>
    {
        /// <inheritdoc />
        public override global::tryAGI.OpenAI.BetaModelIdsResponses Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var __score0 = 0;
            {
                var __ti = typeInfoResolver.GetTypeInfo(typeof(global::tryAGI.OpenAI.BetaModelIdsShared), options);
            ...
            var __score1 = 0;
            {
                var __ti = typeInfoResolver.GetTypeInfo(typeof(global::tryAGI.OpenAI.BetaModelIdsResponsesEnum), options);
                if (__ti != null && __ti.Kind == global::System.Text.Json.Serialization.Metadata.JsonTypeInfoKind.Object)
                {
                    foreach (var __prop in __ti.Properties)
                    {
            ...
            global::tryAGI.OpenAI.BetaModelIdsShared? shared = default;
            global::tryAGI.OpenAI.BetaModelIdsResponsesEnum? responsesOnlyModel = default;
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
            ...
            var __value = new global::tryAGI.OpenAI.BetaModelIdsResponses(
                shared,
        ...
        public override void Write(
            ...
            global::tryAGI.OpenAI.BetaModelIdsResponses value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
