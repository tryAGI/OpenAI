...
namespace tryAGI.OpenAI
{
    public partial class CompletionsClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::tryAGI.OpenAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::tryAGI.OpenAI.AutoSDKHttpResponse<global::tryAGI.OpenAI.CreateCompletionResponse>> CreateCompletionAsResponseAsync(
            ...
            try
            {
                ...
                else
                {
                    await global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            // Invalid completion request or incompatible request parameters.
                            ...
                            // Authentication failed because the API key is missing or revoked, or the client IP is not authorized.
                            ...
                            // Access to a personal API organization is blocked by the organization policy.
                            ...
                            // The requested model was not found, is unavailable, or does not support this endpoint.
                            ...
                            // The completion could not be processed due to an internal error.
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::tryAGI.OpenAI.CreateCompletionResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::tryAGI.OpenAI.AutoSDKHttpResponse<global::tryAGI.OpenAI.CreateCompletionResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::tryAGI.OpenAI.CreateCompletionResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        /// [See more information about frequency and presence penalties.](https://developers.openai.com/api/docs/guides/text)<br/>
        /// Default Value: 0
        /// </param>
        ...
        /// The maximum number of [tokens](https://platform.openai.com/tokenizer) that can be generated in the completion.<br/>
        ...
        public async global::System.Threading.Tasks.Task<global::tryAGI.OpenAI.CreateCompletionResponse> CreateCompletionAsync(
            ...
            global::tryAGI.OpenAI.OneOf<string, global::System.Collections.Generic.IList<string>, global::System.Collections.Generic.IList<int>, global::System.Collections.Generic.IList<global::System.Collections.Generic.IList<int>>>? prompt = default,
            int? bestOf = default,
            bool? echo = default,
            ...
            bool? stream = default,
            global::tryAGI.OpenAI.ChatCompletionStreamOptionsVariant1? streamOptions = default,
