...
namespace tryAGI.OpenAI.JsonConverters
{
    ...
    public class EvalGraderStringCheckJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::tryAGI.OpenAI.EvalGraderStringCheck>
    {
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
                    try
                    {
                        stringCheckGrader = global::System.Text.Json.JsonSerializer.Deserialize<global::tryAGI.OpenAI.GraderStringCheck>(__rawJson, options);
                    }
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                global::System.Text.Json.JsonSerializer.Serialize(writer, value.StringCheckGrader, typeof(global::tryAGI.OpenAI.GraderStringCheck), options);
            }
        }
    }
}