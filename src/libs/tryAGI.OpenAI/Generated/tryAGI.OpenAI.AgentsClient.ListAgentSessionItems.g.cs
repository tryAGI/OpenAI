...
namespace tryAGI.OpenAI
{
    public partial class AgentsClient
    {
        ...
        private static readonly global::tryAGI.OpenAI.EndPointSecurityRequirement s_ListAgentSessionItemsSecurityRequirement0 =
        ...
        private static readonly global::tryAGI.OpenAI.EndPointSecurityRequirement[] s_ListAgentSessionItemsSecurityRequirements =
            new global::tryAGI.OpenAI.EndPointSecurityRequirement[]
            {                s_ListAgentSessionItemsSecurityRequirement0,
            };
        partial void PrepareListAgentSessionItemsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string sessionId,
            ref long? limit,
            ref global::tryAGI.OpenAI.ListOrderParam? order,
            ref string? after);
        partial void PrepareListAgentSessionItemsRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? after);
        partial void ProcessListAgentSessionItemsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessListAgentSessionItemsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::tryAGI.OpenAI.SessionItemListResource> ListAgentSessionItemsAsync(
            string sessionId,
            long? limit = default,
        ...
        {
            var __response = await ListAgentSessionItemsAsResponseAsync(
                sessionId: sessionId,
                limit: limit,
                order: order,
                after: after,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::tryAGI.OpenAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::tryAGI.OpenAI.AutoSDKHttpResponse<global::tryAGI.OpenAI.SessionItemListResource>> ListAgentSessionItemsAsResponseAsync(
            string sessionId,
            long? limit = default,
            global::tryAGI.OpenAI.ListOrderParam? order = default,
            string? after = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareListAgentSessionItemsArguments(
            ...
            var __authorizations = global::tryAGI.OpenAI.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ListAgentSessionItemsSecurityRequirements,
                operationName: "ListAgentSessionItemsAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareListAgentSessionItemsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "ListAgentSessionItemsAsync",
                                pathTemplate: "$\"/agents/sessions/{sessionId}/items\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessListAgentSessionItemsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessListAgentSessionItemsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public global::System.Collections.Generic.IAsyncEnumerable<global::tryAGI.OpenAI.SessionTurnItemResource> ListAgentSessionItemsAutoPagingAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            return global::tryAGI.OpenAI.AutoSDKPager.CursorAsync<global::tryAGI.OpenAI.SessionItemListResource, global::tryAGI.OpenAI.SessionTurnItemResource>(
                fetchPage: (__cursor, __ct) => ListAgentSessionItemsAsync(
                    sessionId: sessionId,
                    limit: limit,
                    order: order,
                    after: __cursor,
