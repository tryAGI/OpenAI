...
namespace tryAGI.OpenAI
{
    public partial class RealtimeClient
    {
        ...
        private static readonly global::tryAGI.OpenAI.EndPointSecurityRequirement s_CreateRealtimeCallWithRawBodySecurityRequirement0 =
        ...
        private static readonly global::tryAGI.OpenAI.EndPointSecurityRequirement[] s_CreateRealtimeCallWithRawBodySecurityRequirements =
            new global::tryAGI.OpenAI.EndPointSecurityRequirement[]
            {                s_CreateRealtimeCallWithRawBodySecurityRequirement0,
            };
        partial void PrepareCreateRealtimeCallWithRawBodyArguments(
            global::System.Net.Http.HttpClient httpClient,
            string request);
        partial void PrepareCreateRealtimeCallWithRawBodyRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string request);
        partial void ProcessCreateRealtimeCallWithRawBodyResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreateRealtimeCallWithRawBodyResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref byte[] content);
        ...
        public async global::System.Threading.Tasks.Task<byte[]> CreateRealtimeCallWithRawBodyAsync(

            string request,
            global::tryAGI.OpenAI.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await CreateRealtimeCallWithRawBodyAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::tryAGI.OpenAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::System.IO.Stream> CreateRealtimeCallWithRawBodyAsStreamAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreateRealtimeCallWithRawBodyArguments(
            ...
            var __authorizations = global::tryAGI.OpenAI.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateRealtimeCallWithRawBodySecurityRequirements,
                operationName: "CreateRealtimeCallWithRawBodyAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreateRealtimeCallWithRawBodyRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "CreateRealtimeCallWithRawBody",
                                methodName: "CreateRealtimeCallWithRawBodyAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateRealtimeCallWithRawBodyResponse(
                    httpClient: HttpClient,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::tryAGI.OpenAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::tryAGI.OpenAI.AutoSDKHttpResponse<byte[]>> CreateRealtimeCallWithRawBodyAsResponseAsync(
                ...
                else
                {
                    await global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreateRealtimeCallWithRawBodyResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
