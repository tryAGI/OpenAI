...
namespace tryAGI.OpenAI
{
    ...
    /// </summary>
    public enum ResponseVariant3Truncation2
    {
        /// <summary>
    ...
    /// </summary>
    public static class ResponseVariant3Truncation2Extensions
    {
        /// <summary>
        /// Converts an enum to a string.
        /// </summary>
        public static string ToValueString(this ResponseVariant3Truncation2 value)
        {
            return value switch
            {
                ResponseVariant3Truncation2.Auto => "auto",
                ResponseVariant3Truncation2.Disabled => "disabled",
        ...
        /// </summary>
        public static ResponseVariant3Truncation2? ToEnum(string value)
        {
            return value switch
            {
                "auto" => ResponseVariant3Truncation2.Auto,
                "disabled" => ResponseVariant3Truncation2.Disabled,
                _ => null,
            };
        }
    }
