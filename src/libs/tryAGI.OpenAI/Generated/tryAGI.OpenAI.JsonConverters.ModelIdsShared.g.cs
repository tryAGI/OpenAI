...
{
    /// <inheritdoc />
    public class ModelIdsSharedJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::tryAGI.OpenAI.ModelIdsShared>
    {
        /// <inheritdoc />
        public override global::tryAGI.OpenAI.ModelIdsShared Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var __score1 = 0;
            {
                var __ti = typeInfoResolver.GetTypeInfo(typeof(global::tryAGI.OpenAI.ModelIdsSharedEnum), options);
                if (__ti != null && __ti.Kind == global::System.Text.Json.Serialization.Metadata.JsonTypeInfoKind.Object)
                {
                    foreach (var __prop in __ti.Properties)
                    {
            ...
            global::tryAGI.OpenAI.ModelIdsSharedEnum? @enum = default;
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
                    try
                    {
                        ...
                        modelIdsSharedVariant1 = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
        ...
        public override void Write(
            ...
            global::tryAGI.OpenAI.ModelIdsShared value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
            ...
            if (value.IsModelIdsSharedVariant1)
            {
                var typeInfo = typeInfoResolver.GetTypeInfo(typeof(string), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<string?> ??
                               throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(string).Name}");
                global::System.Text.Json.JsonSerializer.Serialize(writer, value.ModelIdsSharedVariant1!, typeInfo);
            }
