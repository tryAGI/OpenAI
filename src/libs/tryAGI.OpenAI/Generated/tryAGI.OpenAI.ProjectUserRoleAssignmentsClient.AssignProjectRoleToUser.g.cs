...
namespace tryAGI.OpenAI
{
    public partial class ProjectUserRoleAssignmentsClient
    {
        ...
        partial void PrepareAssignProjectRoleToUserRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string projectId,
            string userId,
            global::tryAGI.OpenAI.PublicAssignOrganizationGroupRoleBody request);
        partial void ProcessAssignProjectRoleToUserResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task<global::tryAGI.OpenAI.UserRoleAssignment> AssignProjectRoleToUserAsync(
            string projectId,
            string userId,
        ...
        {
            var __response = await AssignProjectRoleToUserAsResponseAsync(
                projectId: projectId,
                userId: userId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::tryAGI.OpenAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::tryAGI.OpenAI.AutoSDKHttpResponse<global::tryAGI.OpenAI.UserRoleAssignment>> AssignProjectRoleToUserAsResponseAsync(
            string projectId,
            string userId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareAssignProjectRoleToUserArguments(
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareAssignProjectRoleToUserRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "AssignProjectRoleToUser",
                                methodName: "AssignProjectRoleToUserAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessAssignProjectRoleToUserResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessAssignProjectRoleToUserResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await AssignProjectRoleToUserAsync(
                projectId: projectId,
                userId: userId,
                request: __request,
                requestOptions: requestOptions,
