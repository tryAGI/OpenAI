    ...
    public static class ModelIdsSharedEnumExtensions
    {
        ...
        public static string ToValueString(this ModelIdsSharedEnum value)
        {
            return value switch
            {
                ...
                ModelIdsSharedEnum.Gpt5 => "gpt-5",
                ModelIdsSharedEnum.Gpt520250807 => "gpt-5-2025-08-07",
                ModelIdsSharedEnum.Gpt5ChatLatest => "gpt-5-chat-latest",
                ModelIdsSharedEnum.Gpt5Mini => "gpt-5-mini",
                ModelIdsSharedEnum.Gpt5Mini20250807 => "gpt-5-mini-2025-08-07",
                ModelIdsSharedEnum.Gpt5Nano => "gpt-5-nano",
                ModelIdsSharedEnum.Gpt5Nano20250807 => "gpt-5-nano-2025-08-07",
                ModelIdsSharedEnum.Gpt51 => "gpt-5.1",
                ModelIdsSharedEnum.Gpt5120251113 => "gpt-5.1-2025-11-13",
                ModelIdsSharedEnum.Gpt51ChatLatest => "gpt-5.1-chat-latest",
                ModelIdsSharedEnum.Gpt51Codex => "gpt-5.1-codex",
                ModelIdsSharedEnum.Gpt51Mini => "gpt-5.1-mini",
                ModelIdsSharedEnum.Gpt52 => "gpt-5.2",
                ModelIdsSharedEnum.Gpt5220251211 => "gpt-5.2-2025-12-11",
                ModelIdsSharedEnum.Gpt52ChatLatest => "gpt-5.2-chat-latest",
                ModelIdsSharedEnum.Gpt52Pro => "gpt-5.2-pro",
                ModelIdsSharedEnum.Gpt52Pro20251211 => "gpt-5.2-pro-2025-12-11",
        ...
        public static ModelIdsSharedEnum? ToEnum(string value)
        {
            return value switch
            {
                ...
                "gpt-5" => ModelIdsSharedEnum.Gpt5,
                "gpt-5-2025-08-07" => ModelIdsSharedEnum.Gpt520250807,
                "gpt-5-chat-latest" => ModelIdsSharedEnum.Gpt5ChatLatest,
                "gpt-5-mini" => ModelIdsSharedEnum.Gpt5Mini,
                "gpt-5-mini-2025-08-07" => ModelIdsSharedEnum.Gpt5Mini20250807,
                "gpt-5-nano" => ModelIdsSharedEnum.Gpt5Nano,
                "gpt-5-nano-2025-08-07" => ModelIdsSharedEnum.Gpt5Nano20250807,
                "gpt-5.1" => ModelIdsSharedEnum.Gpt51,
                "gpt-5.1-2025-11-13" => ModelIdsSharedEnum.Gpt5120251113,
                "gpt-5.1-chat-latest" => ModelIdsSharedEnum.Gpt51ChatLatest,
                "gpt-5.1-codex" => ModelIdsSharedEnum.Gpt51Codex,
                "gpt-5.1-mini" => ModelIdsSharedEnum.Gpt51Mini,
                "gpt-5.2" => ModelIdsSharedEnum.Gpt52,
                "gpt-5.2-2025-12-11" => ModelIdsSharedEnum.Gpt5220251211,
                "gpt-5.2-chat-latest" => ModelIdsSharedEnum.Gpt52ChatLatest,
                "gpt-5.2-pro" => ModelIdsSharedEnum.Gpt52Pro,
                "gpt-5.2-pro-2025-12-11" => ModelIdsSharedEnum.Gpt52Pro20251211,
