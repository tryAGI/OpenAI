...
{
    /// <inheritdoc />
    public class ToolsItem4JsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::tryAGI.OpenAI.ToolsItem4>
    {
        /// <inheritdoc />
        public override global::tryAGI.OpenAI.ToolsItem4 Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var discriminatorTypeInfo = typeInfoResolver.GetTypeInfo(typeof(global::tryAGI.OpenAI.CreateRunRequestToolDiscriminator), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::tryAGI.OpenAI.CreateRunRequestToolDiscriminator> ??
                            throw new global::System.InvalidOperationException($"Cannot get type info for {nameof(global::tryAGI.OpenAI.CreateRunRequestToolDiscriminator)}");
            var discriminator = global::System.Text.Json.JsonSerializer.Deserialize(ref readerCopy, discriminatorTypeInfo);

            global::tryAGI.OpenAI.AssistantToolsCode? codeInterpreter = default;
            if (discriminator?.Type == global::tryAGI.OpenAI.CreateRunRequestToolDiscriminatorType.CodeInterpreter)
            {
            ...
            if (discriminator?.Type == global::tryAGI.OpenAI.CreateRunRequestToolDiscriminatorType.FileSearch)
            {
            ...
            if (discriminator?.Type == global::tryAGI.OpenAI.CreateRunRequestToolDiscriminatorType.Function)
            {
            ...
            var result = new global::tryAGI.OpenAI.ToolsItem4(
                discriminator?.Type,
                codeInterpreter,
                fileSearch,
                function
        ...
        public override void Write(
            ...
            global::tryAGI.OpenAI.ToolsItem4 value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
