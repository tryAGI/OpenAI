...
namespace tryAGI.OpenAI
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::tryAGI.OpenAI.AutoSDKRetryOptions Retry { get; set; } = new global::tryAGI.OpenAI.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::tryAGI.OpenAI.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::tryAGI.OpenAI.IAutoSDKHook>();
        ...
        public global::tryAGI.OpenAI.AutoSDKClientOptions AddHook(
            global::tryAGI.OpenAI.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::tryAGI.OpenAI.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::tryAGI.OpenAI.AutoSDKClientOptions UseAuthorizationProvider(
            global::tryAGI.OpenAI.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::tryAGI.OpenAI.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::tryAGI.OpenAI.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::tryAGI.OpenAI.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::tryAGI.OpenAI.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::tryAGI.OpenAI.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::tryAGI.OpenAI.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::tryAGI.OpenAI.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::tryAGI.OpenAI.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::tryAGI.OpenAI.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::tryAGI.OpenAI.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::tryAGI.OpenAI.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::tryAGI.OpenAI.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::tryAGI.OpenAI.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::tryAGI.OpenAI.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::tryAGI.OpenAI.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    internal static class AutoSDKRequestOptionsSupport
    {
        internal static global::tryAGI.OpenAI.AutoSDKHookContext CreateHookContext(
            ...
            global::tryAGI.OpenAI.AutoSDKClientOptions clientOptions,
        ...
        {
            return new global::tryAGI.OpenAI.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::tryAGI.OpenAI.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::tryAGI.OpenAI.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::tryAGI.OpenAI.AutoSDKClientOptions clientOptions,
            global::System.Func<global::tryAGI.OpenAI.IAutoSDKHook, global::tryAGI.OpenAI.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::tryAGI.OpenAI.AutoSDKHookContext context)
        {
