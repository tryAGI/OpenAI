...
namespace tryAGI.OpenAI.JsonConverters
{
    ...
    public class ResponsesClientEventJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::tryAGI.OpenAI.ResponsesClientEvent>
    {
            ...
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
                    try
                    {
                        ...
                        responseCreate = global::System.Text.Json.JsonSerializer.Deserialize<global::tryAGI.OpenAI.ResponsesClientEventResponseCreate>(__rawJson, options);
                    }
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                global::System.Text.Json.JsonSerializer.Serialize(writer, value.ResponseCreate, typeof(global::tryAGI.OpenAI.ResponsesClientEventResponseCreate), options);
            }
        }
    }
}