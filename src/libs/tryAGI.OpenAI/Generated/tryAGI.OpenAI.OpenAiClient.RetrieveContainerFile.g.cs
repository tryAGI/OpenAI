                    ...
                    await global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    return
                                        global::tryAGI.OpenAI.ContainerFileResource.FromJson(__content, JsonSerializerContext) ??
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    return
                                        await global::tryAGI.OpenAI.ContainerFileResource.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
