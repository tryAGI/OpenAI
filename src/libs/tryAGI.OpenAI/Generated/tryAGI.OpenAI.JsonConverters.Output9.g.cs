...
{
    /// <inheritdoc />
    public class Output9JsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::tryAGI.OpenAI.Output9>
    {
        /// <inheritdoc />
        public override global::tryAGI.OpenAI.Output9 Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var discriminatorTypeInfo = typeInfoResolver.GetTypeInfo(typeof(global::tryAGI.OpenAI.BetaModerationOutputDiscriminator), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::tryAGI.OpenAI.BetaModerationOutputDiscriminator> ??
                            throw new global::System.InvalidOperationException($"Cannot get type info for {nameof(global::tryAGI.OpenAI.BetaModerationOutputDiscriminator)}");
            var discriminator = global::System.Text.Json.JsonSerializer.Deserialize(ref readerCopy, discriminatorTypeInfo);

            global::tryAGI.OpenAI.BetaModerationResultBody? moderationResult = default;
            if (discriminator?.Type == global::tryAGI.OpenAI.BetaModerationOutputDiscriminatorType.ModerationResult)
            {
            ...
            if (discriminator?.Type == global::tryAGI.OpenAI.BetaModerationOutputDiscriminatorType.Error)
            {
            ...
            var __value = new global::tryAGI.OpenAI.Output9(
                discriminator?.Type,
                moderationResult,
        ...
        public override void Write(
            ...
            global::tryAGI.OpenAI.Output9 value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
