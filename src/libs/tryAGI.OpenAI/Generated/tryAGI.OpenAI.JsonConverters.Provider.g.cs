...
{
    /// <inheritdoc />
    public class ProviderJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::tryAGI.OpenAI.Provider>
    {
        /// <inheritdoc />
        public override global::tryAGI.OpenAI.Provider Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var discriminatorTypeInfo = typeInfoResolver.GetTypeInfo(typeof(global::tryAGI.OpenAI.ProviderDiscriminator), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::tryAGI.OpenAI.ProviderDiscriminator> ??
                            throw new global::System.InvalidOperationException($"Cannot get type info for {nameof(global::tryAGI.OpenAI.ProviderDiscriminator)}");
            var discriminator = global::System.Text.Json.JsonSerializer.Deserialize(ref readerCopy, discriminatorTypeInfo);

            global::tryAGI.OpenAI.AwsExternalStorageProviderResponse? aws = default;
            if (discriminator?.Type == global::tryAGI.OpenAI.ProviderDiscriminatorType.Aws)
            {
            ...
            if (discriminator?.Type == global::tryAGI.OpenAI.ProviderDiscriminatorType.Azure)
            {
            ...
            if (discriminator?.Type == global::tryAGI.OpenAI.ProviderDiscriminatorType.Gcp)
            {
            ...
            var __value = new global::tryAGI.OpenAI.Provider(
                discriminator?.Type,
                aws,
        ...
        public override void Write(
            ...
            global::tryAGI.OpenAI.Provider value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
