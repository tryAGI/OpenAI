...
namespace tryAGI.OpenAI.JsonConverters
{
    ...
    public class OutputItemJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::tryAGI.OpenAI.OutputItem>
    {
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            if (__jsonProps.Contains("fingerprint")) __score8++;
            ...
            if (__jsonProps.Contains("execution")) __score10++;
            ...
            if (__jsonProps.Contains("role")) __score12++;
