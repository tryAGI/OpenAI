...
namespace tryAGI.OpenAI
{
    public partial class UsageClient
    {
        ...
        private static readonly global::tryAGI.OpenAI.EndPointSecurityRequirement s_UsageFileSearchCallsSecurityRequirement0 =
        ...
        private static readonly global::tryAGI.OpenAI.EndPointSecurityRequirement[] s_UsageFileSearchCallsSecurityRequirements =
            new global::tryAGI.OpenAI.EndPointSecurityRequirement[]
            {                s_UsageFileSearchCallsSecurityRequirement0,
            };
        partial void PrepareUsageFileSearchCallsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref int startTime,
            ref int? endTime,
            ref global::tryAGI.OpenAI.UsageFileSearchCallsBucketWidth? bucketWidth,
            ...
            global::System.Collections.Generic.IList<global::tryAGI.OpenAI.UsageFileSearchCallsGroupByItem>? groupBy,
            ref int? limit,
            ref string? page);
        partial void PrepareUsageFileSearchCallsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            int startTime,
            int? endTime,
            global::tryAGI.OpenAI.UsageFileSearchCallsBucketWidth? bucketWidth,
            global::System.Collections.Generic.IList<string>? projectIds,
            global::System.Collections.Generic.IList<string>? userIds,
            global::System.Collections.Generic.IList<string>? apiKeyIds,
            global::System.Collections.Generic.IList<string>? vectorStoreIds,
            ...
            int? limit,
            string? page);
        partial void ProcessUsageFileSearchCallsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessUsageFileSearchCallsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);

        /// <summary>
        /// File search calls<br/>
        ...
        public async global::System.Threading.Tasks.Task<global::tryAGI.OpenAI.UsageResponse> UsageFileSearchCallsAsync(
            int startTime,
            int? endTime = default,
            global::tryAGI.OpenAI.UsageFileSearchCallsBucketWidth? bucketWidth = default,
            ...
            global::System.Collections.Generic.IList<string>? vectorStoreIds = default,
            global::System.Collections.Generic.IList<global::tryAGI.OpenAI.UsageFileSearchCallsGroupByItem>? groupBy = default,
            int? limit = default,
            string? page = default,
            global::tryAGI.OpenAI.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await UsageFileSearchCallsAsResponseAsync(
                startTime: startTime,
                endTime: endTime,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::tryAGI.OpenAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::tryAGI.OpenAI.AutoSDKHttpResponse<global::tryAGI.OpenAI.UsageResponse>> UsageFileSearchCallsAsResponseAsync(
            int startTime,
            int? endTime = default,
            global::tryAGI.OpenAI.UsageFileSearchCallsBucketWidth? bucketWidth = default,
            global::System.Collections.Generic.IList<string>? projectIds = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareUsageFileSearchCallsArguments(
            ...
            var __authorizations = global::tryAGI.OpenAI.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_UsageFileSearchCallsSecurityRequirements,
                operationName: "UsageFileSearchCallsAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            __pathBuilder
                                ...
                                .AddOptionalParameter("vector_store_ids", vectorStoreIds, delimiter: ",", explode: true)
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareUsageFileSearchCallsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "UsageFileSearchCalls",
                                methodName: "UsageFileSearchCallsAsync",
                                pathTemplate: "\"/organization/usage/file_search_calls\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessUsageFileSearchCallsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessUsageFileSearchCallsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::tryAGI.OpenAI.UsageResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::tryAGI.OpenAI.AutoSDKHttpResponse<global::tryAGI.OpenAI.UsageResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::tryAGI.OpenAI.UsageResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        /// <summary>
        /// Wraps UsageFileSearchCallsAsync as an IAsyncEnumerable&lt;global::tryAGI.OpenAI.UsageTimeBucket&gt; that auto-pages over the response.
        /// </summary>
        /// <param name="startTime"></param>
        /// <param name="endTime"></param>
        /// <param name="bucketWidth">
        ...
        public global::System.Collections.Generic.IAsyncEnumerable<global::tryAGI.OpenAI.UsageTimeBucket> UsageFileSearchCallsAutoPagingAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            return global::tryAGI.OpenAI.AutoSDKPager.CursorAsync<global::tryAGI.OpenAI.UsageResponse, global::tryAGI.OpenAI.UsageTimeBucket>(
                fetchPage: (__cursor, __ct) => UsageFileSearchCallsAsync(
                    startTime: startTime,
                    endTime: endTime,
                    bucketWidth: bucketWidth,
                    projectIds: projectIds,
