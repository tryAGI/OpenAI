...
{
    /// <inheritdoc />
    public class BetaItemFieldJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::tryAGI.OpenAI.BetaItemField>
    {
        /// <inheritdoc />
        public override global::tryAGI.OpenAI.BetaItemField Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            if (__jsonProps.Contains("agent.agent_name")) __score0++;
            ...
            if (__jsonProps.Contains("agent.agent_name")) __score1++;
            if (__jsonProps.Contains("call_id")) __score1++;
            if (__jsonProps.Contains("code")) __score1++;
            if (__jsonProps.Contains("fingerprint")) __score1++;
            if (__jsonProps.Contains("id")) __score1++;
            if (__jsonProps.Contains("type")) __score1++;
            var __score2 = 0;
            if (__jsonProps.Contains("agent")) __score2++;
            if (__jsonProps.Contains("agent.agent_name")) __score2++;
            ...
            if (__jsonProps.Contains("async")) __score3++;
            if (__jsonProps.Contains("call_id")) __score3++;
            if (__jsonProps.Contains("caller")) __score3++;
            ...
            if (__jsonProps.Contains("agent")) __score4++;
            if (__jsonProps.Contains("agent.agent_name")) __score4++;
            ...
            if (__jsonProps.Contains("agent.agent_name")) __score5++;
            if (__jsonProps.Contains("call_id")) __score5++;
            if (__jsonProps.Contains("id")) __score5++;
            if (__jsonProps.Contains("output")) __score5++;
            if (__jsonProps.Contains("type")) __score5++;
            var __score6 = 0;
            if (__jsonProps.Contains("agent")) __score6++;
            if (__jsonProps.Contains("agent.agent_name")) __score6++;
            ...
            var __score7 = 0;
            if (__jsonProps.Contains("agent")) __score7++;
            if (__jsonProps.Contains("agent.agent_name")) __score7++;
            ...
            if (__jsonProps.Contains("results")) __score11++;
            ...
            if (__jsonProps.Contains("background")) __score13++;
            if (__jsonProps.Contains("id")) __score13++;
            if (__jsonProps.Contains("output_format")) __score13++;
            if (__jsonProps.Contains("quality")) __score13++;
            if (__jsonProps.Contains("result")) __score13++;
            if (__jsonProps.Contains("revised_prompt")) __score13++;
            if (__jsonProps.Contains("size")) __score13++;
            ...
            if (__jsonProps.Contains("pending_safety_checks")) __score14++;
            ...
            if (__jsonProps.Contains("encrypted_content")) __score16++;
            if (__jsonProps.Contains("id")) __score16++;
            if (__jsonProps.Contains("status")) __score16++;
            if (__jsonProps.Contains("summary")) __score16++;
            ...
            if (__jsonProps.Contains("container_id")) __score18++;
            if (__jsonProps.Contains("id")) __score18++;
            if (__jsonProps.Contains("outputs")) __score18++;
            if (__jsonProps.Contains("status")) __score18++;
            if (__jsonProps.Contains("type")) __score18++;
            var __score19 = 0;
            if (__jsonProps.Contains("action")) __score19++;
            if (__jsonProps.Contains("action.command")) __score19++;
            if (__jsonProps.Contains("action.env")) __score19++;
            if (__jsonProps.Contains("action.timeout_ms")) __score19++;
            if (__jsonProps.Contains("action.type")) __score19++;
            if (__jsonProps.Contains("action.user")) __score19++;
            if (__jsonProps.Contains("action.working_directory")) __score19++;
            ...
            if (__jsonProps.Contains("action.commands")) __score21++;
            if (__jsonProps.Contains("action.max_output_length")) __score21++;
            if (__jsonProps.Contains("action.timeout_ms")) __score21++;
            if (__jsonProps.Contains("agent")) __score21++;
            if (__jsonProps.Contains("agent.agent_name")) __score21++;
            if (__jsonProps.Contains("call_id")) __score21++;
            if (__jsonProps.Contains("caller")) __score21++;
            if (__jsonProps.Contains("created_by")) __score21++;
            if (__jsonProps.Contains("environment")) __score21++;
            ...
            if (__jsonProps.Contains("max_output_length")) __score22++;
            ...
            if (__jsonProps.Contains("operation")) __score23++;
            ...
            if (__jsonProps.Contains("tools")) __score25++;
            ...
            if (__jsonProps.Contains("approve")) __score27++;
            if (__jsonProps.Contains("id")) __score27++;
            if (__jsonProps.Contains("reason")) __score27++;
            ...
            if (__jsonProps.Contains("arguments")) __score28++;
            if (__jsonProps.Contains("error")) __score28++;
            if (__jsonProps.Contains("id")) __score28++;
            if (__jsonProps.Contains("name")) __score28++;
            if (__jsonProps.Contains("output")) __score28++;
            if (__jsonProps.Contains("server_label")) __score28++;
            if (__jsonProps.Contains("status")) __score28++;
            if (__jsonProps.Contains("type")) __score28++;
            var __score29 = 0;
            if (__jsonProps.Contains("agent")) __score29++;
            if (__jsonProps.Contains("async")) __score29++;
            if (__jsonProps.Contains("call_id")) __score29++;
            if (__jsonProps.Contains("caller")) __score29++;
            if (__jsonProps.Contains("id")) __score29++;
            if (__jsonProps.Contains("input")) __score29++;
            if (__jsonProps.Contains("name")) __score29++;
            if (__jsonProps.Contains("namespace")) __score29++;
            if (__jsonProps.Contains("type")) __score29++;
            var __score30 = 0;
            if (__jsonProps.Contains("agent")) __score30++;
            if (__jsonProps.Contains("call_id")) __score30++;
            if (__jsonProps.Contains("caller")) __score30++;
            if (__jsonProps.Contains("id")) __score30++;
            if (__jsonProps.Contains("output")) __score30++;
            ...
            global::tryAGI.OpenAI.BetaMessage? message = default;
            ...
            global::tryAGI.OpenAI.BetaFunctionToolCallOutput? functionCallOutput = default;
            ...
            global::tryAGI.OpenAI.BetaComputerToolCallOutputResource? computerToolCallOutputResource = default;
            ...
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
                    try
                    {
                        var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::tryAGI.OpenAI.BetaMessage), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::tryAGI.OpenAI.BetaMessage> ??
                                       throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(global::tryAGI.OpenAI.BetaMessage).Name}");
            ...
            if (message == null && program == null && programOutput == null && functionCall == null && multiAgentCall == null && multiAgentCallOutput == null && toolSearchCall == null && toolSearchOutput == null && additionalTools == null && agentMessage == null && functionCallOutput == null && fileSearchCall == null && webSearchCall == null && imageGenerationCall == null && computerCall == null && computerToolCallOutputResource == null && reasoning == null && compaction == null && codeInterpreterCall == null && localShellCall == null && localShellCallOutput == null && shellCall == null && shellCallOutput == null && applyPatchCall == null && applyPatchCallOutput == null && mcpListTools == null && mcpApprovalRequest == null && mcpApprovalResponse == null && mcpCall == null && customToolCall == null && customToolCallOutput == null)
            {
                try
                {
            ...
            var __value = new global::tryAGI.OpenAI.BetaItemField(
                message,
        ...
        public override void Write(
            ...
            global::tryAGI.OpenAI.BetaItemField value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
