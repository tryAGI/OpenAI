...
namespace tryAGI.OpenAI.JsonConverters
{
    ...
    public class BetaResponsesServerEventJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::tryAGI.OpenAI.BetaResponsesServerEvent>
    {
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            global::tryAGI.OpenAI.BetaResponseStreamEvent? responseStream = default;
            ...
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
                    try
                    {
                        var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::tryAGI.OpenAI.BetaResponseStreamEvent), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::tryAGI.OpenAI.BetaResponseStreamEvent> ??
                                       throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(global::tryAGI.OpenAI.BetaResponseStreamEvent).Name}");
                        responseStream = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
            ...
            if (responseStream == null && responseInjectCreated == null && responseInjectFailed == null)
            {
                try
                {
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            if (value.IsResponseStream)
            {
                var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::tryAGI.OpenAI.BetaResponseStreamEvent), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::tryAGI.OpenAI.BetaResponseStreamEvent> ??
                               throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(global::tryAGI.OpenAI.BetaResponseStreamEvent).Name}");
                global::System.Text.Json.JsonSerializer.Serialize(writer, value.ResponseStream!.Value, typeInfo);
            }
