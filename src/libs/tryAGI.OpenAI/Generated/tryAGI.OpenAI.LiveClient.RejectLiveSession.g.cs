...
namespace tryAGI.OpenAI
{
    public partial class LiveClient
    {
        ...
        private static readonly global::tryAGI.OpenAI.EndPointSecurityRequirement s_RejectLiveSessionSecurityRequirement0 =
        ...
        private static readonly global::tryAGI.OpenAI.EndPointSecurityRequirement[] s_RejectLiveSessionSecurityRequirements =
            new global::tryAGI.OpenAI.EndPointSecurityRequirement[]
            {                s_RejectLiveSessionSecurityRequirement0,
            };
        partial void PrepareRejectLiveSessionArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string sessionId,
            global::tryAGI.OpenAI.LiveCallRejectRequest request);
        partial void PrepareRejectLiveSessionRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string sessionId,
            global::tryAGI.OpenAI.LiveCallRejectRequest request);
        partial void ProcessRejectLiveSessionResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task RejectLiveSessionAsync(
            string sessionId,
        ...
        {
            await RejectLiveSessionAsResponseAsync(
                sessionId: sessionId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::tryAGI.OpenAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::tryAGI.OpenAI.AutoSDKHttpResponse> RejectLiveSessionAsResponseAsync(
            string sessionId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareRejectLiveSessionArguments(
            ...
            var __authorizations = global::tryAGI.OpenAI.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_RejectLiveSessionSecurityRequirements,
                operationName: "RejectLiveSessionAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareRejectLiveSessionRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "RejectLiveSession",
                                methodName: "RejectLiveSessionAsync",
                                pathTemplate: "$\"/live/sessions/{sessionId}/reject\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessRejectLiveSessionResponse(
                    httpClient: HttpClient,
        ...
        public async global::System.Threading.Tasks.Task RejectLiveSessionAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::tryAGI.OpenAI.LiveCallRejectRequest
            {
                StatusCode = statusCode,
            };

            await RejectLiveSessionAsync(
                sessionId: sessionId,
                request: __request,
                requestOptions: requestOptions,
