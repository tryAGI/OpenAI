...
namespace tryAGI.OpenAI
{
    ...
    /// </summary>
    public enum BetaCreateResponseVariant3Truncation
    {
        /// <summary>
    ...
    /// </summary>
    public static class BetaCreateResponseVariant3TruncationExtensions
    {
        /// <summary>
        /// Converts an enum to a string.
        /// </summary>
        public static string ToValueString(this BetaCreateResponseVariant3Truncation value)
        {
            return value switch
            {
                BetaCreateResponseVariant3Truncation.Auto => "auto",
                BetaCreateResponseVariant3Truncation.Disabled => "disabled",
        ...
        /// </summary>
        public static BetaCreateResponseVariant3Truncation? ToEnum(string value)
        {
            return value switch
            {
                "auto" => BetaCreateResponseVariant3Truncation.Auto,
                "disabled" => BetaCreateResponseVariant3Truncation.Disabled,
                _ => null,
            };
        }
    }
