...
namespace tryAGI.OpenAI.JsonConverters
{
    ...
    public class EvalGraderPythonJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::tryAGI.OpenAI.EvalGraderPython>
    {
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
                    try
                    {
                        pythonGrader = global::System.Text.Json.JsonSerializer.Deserialize<global::tryAGI.OpenAI.GraderPython>(__rawJson, options);
                    }
                ...
                else if (__bestIndex == 1)
                {
                    try
                    {
                        evalGraderPythonVariant2 = global::System.Text.Json.JsonSerializer.Deserialize<global::tryAGI.OpenAI.EvalGraderPythonVariant2>(__rawJson, options);
                    }
                    catch (global::System.Text.Json.JsonException)
                    {
                    }
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                global::System.Text.Json.JsonSerializer.Serialize(writer, value.PythonGrader, typeof(global::tryAGI.OpenAI.GraderPython), options);
            }
            else if (value.IsEvalGraderPythonVariant2)
            {
                global::System.Text.Json.JsonSerializer.Serialize(writer, value.EvalGraderPythonVariant2, typeof(global::tryAGI.OpenAI.EvalGraderPythonVariant2), options);
            }
        }
    }
}