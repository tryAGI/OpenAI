...
namespace tryAGI.OpenAI
{
    ...
    public sealed partial class RealtimeTranslationSessionCreateRequestAudioInputTranscription2
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RealtimeTranslationSessionCreateRequestAudioInputTranscription2" /> class.
        /// </summary>
        /// <param name="model">
        /// The transcription model to use for source transcript deltas.
        /// </param>
...
#endif
        public RealtimeTranslationSessionCreateRequestAudioInputTranscription2(
            string model)
        {
