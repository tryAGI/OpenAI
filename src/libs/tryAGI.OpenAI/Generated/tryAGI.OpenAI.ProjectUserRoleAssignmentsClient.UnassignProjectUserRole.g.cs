...
namespace tryAGI.OpenAI
{
    public partial class ProjectUserRoleAssignmentsClient
    {
        ...
        private static readonly global::tryAGI.OpenAI.EndPointSecurityRequirement s_UnassignProjectUserRoleSecurityRequirement0 =
        ...
        private static readonly global::tryAGI.OpenAI.EndPointSecurityRequirement[] s_UnassignProjectUserRoleSecurityRequirements =
            new global::tryAGI.OpenAI.EndPointSecurityRequirement[]
            {                s_UnassignProjectUserRoleSecurityRequirement0,
            };
        partial void PrepareUnassignProjectUserRoleArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string projectId,
            ref string userId,
            ref string roleId);
        partial void PrepareUnassignProjectUserRoleRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string projectId,
            string userId,
            string roleId);
        partial void ProcessUnassignProjectUserRoleResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task<global::tryAGI.OpenAI.DeletedRoleAssignmentResource> UnassignProjectUserRoleAsync(
            string projectId,
            string userId,
            string roleId,
        ...
        {
            var __response = await UnassignProjectUserRoleAsResponseAsync(
                projectId: projectId,
                userId: userId,
                roleId: roleId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::tryAGI.OpenAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::tryAGI.OpenAI.AutoSDKHttpResponse<global::tryAGI.OpenAI.DeletedRoleAssignmentResource>> UnassignProjectUserRoleAsResponseAsync(
            string projectId,
            string userId,
            string roleId,
            global::tryAGI.OpenAI.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareUnassignProjectUserRoleArguments(
            ...
            var __authorizations = global::tryAGI.OpenAI.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_UnassignProjectUserRoleSecurityRequirements,
                operationName: "UnassignProjectUserRoleAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareUnassignProjectUserRoleRequest(
                    httpClient: HttpClient,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "UnassignProjectUserRole",
                                methodName: "UnassignProjectUserRoleAsync",
                ...
                else
                {
                    await global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessUnassignProjectUserRoleResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
