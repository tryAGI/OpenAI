...
namespace tryAGI.OpenAI
{
    public partial class VectorStoresClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::tryAGI.OpenAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::tryAGI.OpenAI.AutoSDKHttpResponse<global::tryAGI.OpenAI.VectorStoreObject>> ModifyVectorStoreAsResponseAsync(
            string vectorStoreId,
            ...
            try
            {
                ...
                else
                {
                    await global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            // The vector store input is invalid, the store has expired, or the store cannot be modified.
                            ...
                            // The caller is not authorized to update the vector store.
