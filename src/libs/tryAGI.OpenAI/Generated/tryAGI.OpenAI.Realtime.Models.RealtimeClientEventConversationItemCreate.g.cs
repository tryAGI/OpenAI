...
namespace tryAGI.OpenAI.Realtime
{
    ...
    public sealed partial class RealtimeClientEventConversationItemCreate
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::tryAGI.OpenAI.Realtime.JsonConverters.RealtimeClientEventConversationItemCreateTypeJsonConverter))]
        public global::tryAGI.OpenAI.Realtime.RealtimeClientEventConversationItemCreateType Type { get; set; }

        /// <summary>
        /// The ID of the preceding item after which the new item will be inserted. If not set, the new item will be appended to the end of the conversation.<br/>
        ...
        public RealtimeClientEventConversationItemCreate(
            ...
            string? eventId,
            global::tryAGI.OpenAI.Realtime.RealtimeClientEventConversationItemCreateType type,
