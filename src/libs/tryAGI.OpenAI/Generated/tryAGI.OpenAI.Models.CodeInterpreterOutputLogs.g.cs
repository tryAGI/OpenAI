...
namespace tryAGI.OpenAI
{
    ...
    public sealed partial class CodeInterpreterOutputLogs
    {
        ...
        /// <summary>
        /// Creates a new <see cref="CodeInterpreterOutputLogs"/> from its single non-const required field,
        /// hardcoding any const discriminator fields.
        /// </summary>
        public static CodeInterpreterOutputLogs FromLogs(string logs)
        {
            return new CodeInterpreterOutputLogs
            {
                Logs = logs,
            };
        }
