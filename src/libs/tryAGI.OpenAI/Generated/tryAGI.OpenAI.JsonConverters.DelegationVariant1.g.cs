...
{
    /// <inheritdoc />
    public class DelegationVariant1JsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::tryAGI.OpenAI.DelegationVariant1>
    {
        /// <inheritdoc />
        public override global::tryAGI.OpenAI.DelegationVariant1 Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var discriminatorTypeInfo = typeInfoResolver.GetTypeInfo(typeof(global::tryAGI.OpenAI.DelegationVariant1Discriminator), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::tryAGI.OpenAI.DelegationVariant1Discriminator> ??
                            throw new global::System.InvalidOperationException($"Cannot get type info for {nameof(global::tryAGI.OpenAI.DelegationVariant1Discriminator)}");
            var discriminator = global::System.Text.Json.JsonSerializer.Deserialize(ref readerCopy, discriminatorTypeInfo);

            global::tryAGI.OpenAI.LiveClientDelegationParam? client = default;
            if (discriminator?.Type == global::tryAGI.OpenAI.DelegationVariant1DiscriminatorType.Client)
            {
            ...
            if (discriminator?.Type == global::tryAGI.OpenAI.DelegationVariant1DiscriminatorType.Responses)
            {
            ...
            var __value = new global::tryAGI.OpenAI.DelegationVariant1(
                discriminator?.Type,
                client,
        ...
        public override void Write(
            ...
            global::tryAGI.OpenAI.DelegationVariant1 value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
