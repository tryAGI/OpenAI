    ...
    public sealed partial class OpenAiRealtimeClient
    {
            ...
            [global::System.Runtime.CompilerServices.EnumeratorCancellation] global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            while (_clientWebSocket.State == global::System.Net.WebSockets.WebSocketState.Open)
            {
                ...
                string json = global::System.Text.Encoding.UTF8.GetString(__messageBuffer.ToArray());
                    global::tryAGI.OpenAI.Realtime.RealtimeServerEvent @event;
                    try
                    {
                        @event = (global::tryAGI.OpenAI.Realtime.RealtimeServerEvent)global::System.Text.Json.JsonSerializer.Deserialize(json, typeof(global::tryAGI.OpenAI.Realtime.RealtimeServerEvent), JsonSerializerContext)!;
                    }
            ...
            string rawText)
        {
            ...
            MessageReceived?.Invoke(
                this,
                new AutoSDKWebSocketMessageEventArgs<global::tryAGI.OpenAI.Realtime.RealtimeServerEvent>(
                    @event,
                    rawText,
                    json));
