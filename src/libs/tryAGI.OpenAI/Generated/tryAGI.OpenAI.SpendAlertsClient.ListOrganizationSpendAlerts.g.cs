...
namespace tryAGI.OpenAI
{
    public partial class SpendAlertsClient
    {
        ...
        private static readonly global::tryAGI.OpenAI.EndPointSecurityRequirement s_ListOrganizationSpendAlertsSecurityRequirement0 =
        ...
        private static readonly global::tryAGI.OpenAI.EndPointSecurityRequirement[] s_ListOrganizationSpendAlertsSecurityRequirements =
            new global::tryAGI.OpenAI.EndPointSecurityRequirement[]
            {                s_ListOrganizationSpendAlertsSecurityRequirement0,
            };
        partial void PrepareListOrganizationSpendAlertsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref int? limit,
            ref global::tryAGI.OpenAI.ListOrganizationSpendAlertsOrder? order,
            ref string? after,
            ref string? before);
        partial void PrepareListOrganizationSpendAlertsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            int? limit,
            global::tryAGI.OpenAI.ListOrganizationSpendAlertsOrder? order,
            string? after,
            string? before);
        partial void ProcessListOrganizationSpendAlertsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessListOrganizationSpendAlertsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::tryAGI.OpenAI.OrganizationSpendAlertListResource> ListOrganizationSpendAlertsAsync(
            int? limit = default,
        ...
        {
            var __response = await ListOrganizationSpendAlertsAsResponseAsync(
                limit: limit,
                order: order,
                after: after,
                before: before,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::tryAGI.OpenAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::tryAGI.OpenAI.AutoSDKHttpResponse<global::tryAGI.OpenAI.OrganizationSpendAlertListResource>> ListOrganizationSpendAlertsAsResponseAsync(
            int? limit = default,
            global::tryAGI.OpenAI.ListOrganizationSpendAlertsOrder? order = default,
            string? after = default,
            string? before = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareListOrganizationSpendAlertsArguments(
            ...
            var __authorizations = global::tryAGI.OpenAI.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ListOrganizationSpendAlertsSecurityRequirements,
                operationName: "ListOrganizationSpendAlertsAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ListOrganizationSpendAlerts",
                                methodName: "ListOrganizationSpendAlertsAsync",
                                pathTemplate: "\"/organization/spend_alerts\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessListOrganizationSpendAlertsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            // The spend alert listing parameters are invalid.
                            ...
                            // The spend alert specified by the after cursor was not found.
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessListOrganizationSpendAlertsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::tryAGI.OpenAI.OrganizationSpendAlertListResource.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::tryAGI.OpenAI.AutoSDKHttpResponse<global::tryAGI.OpenAI.OrganizationSpendAlertListResource>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::tryAGI.OpenAI.OrganizationSpendAlertListResource.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
