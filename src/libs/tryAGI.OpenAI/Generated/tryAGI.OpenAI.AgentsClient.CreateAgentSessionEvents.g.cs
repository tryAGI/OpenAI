...
namespace tryAGI.OpenAI
{
    public partial class AgentsClient
    {
        ...
        private static readonly global::tryAGI.OpenAI.EndPointSecurityRequirement s_CreateAgentSessionEventsSecurityRequirement0 =
        ...
        private static readonly global::tryAGI.OpenAI.EndPointSecurityRequirement[] s_CreateAgentSessionEventsSecurityRequirements =
            new global::tryAGI.OpenAI.EndPointSecurityRequirement[]
            {                s_CreateAgentSessionEventsSecurityRequirement0,
            };
        partial void PrepareCreateAgentSessionEventsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string sessionId,
            ref string? idempotencyKey,
            global::tryAGI.OpenAI.CreateSessionEventsParams request);
        partial void PrepareCreateAgentSessionEventsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string sessionId,
            string? idempotencyKey,
            global::tryAGI.OpenAI.CreateSessionEventsParams request);
        partial void ProcessCreateAgentSessionEventsResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task CreateAgentSessionEventsAsync(
            string sessionId,
        ...
        {
            await CreateAgentSessionEventsAsResponseAsync(
                sessionId: sessionId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::tryAGI.OpenAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::tryAGI.OpenAI.AutoSDKHttpResponse> CreateAgentSessionEventsAsResponseAsync(
            string sessionId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreateAgentSessionEventsArguments(
            ...
            var __authorizations = global::tryAGI.OpenAI.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateAgentSessionEventsSecurityRequirements,
                operationName: "CreateAgentSessionEventsAsync");
            ...
            __httpRequest.Headers.TryAddWithoutValidation("Idempotency-Key", __idempotencyKey);
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreateAgentSessionEventsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "CreateAgentSessionEventsAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateAgentSessionEventsResponse(
                    httpClient: HttpClient,
        ...
        public async global::System.Threading.Tasks.Task CreateAgentSessionEventsAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::tryAGI.OpenAI.CreateSessionEventsParams
            {
                Events = events,
            };

            await CreateAgentSessionEventsAsync(
                sessionId: sessionId,
                idempotencyKey: idempotencyKey,
                request: __request,
                requestOptions: requestOptions,
