...
namespace tryAGI.OpenAI
{
    ...
    /// </summary>
    public static class BetaModelResponsePropertiesPromptCacheRetentionExtensions
    {
        /// <summary>
        /// Converts an enum to a string.
        /// </summary>
        public static string ToValueString(this BetaModelResponsePropertiesPromptCacheRetention value)
        {
            return value switch
            {
                BetaModelResponsePropertiesPromptCacheRetention.x24h => "24h",
                BetaModelResponsePropertiesPromptCacheRetention.InMemory => "in_memory",
        ...
        /// </summary>
        public static BetaModelResponsePropertiesPromptCacheRetention? ToEnum(string value)
        {
            return value switch
            {
                "24h" => BetaModelResponsePropertiesPromptCacheRetention.x24h,
                "in_memory" => BetaModelResponsePropertiesPromptCacheRetention.InMemory,
                _ => null,
            };
        }
    }
