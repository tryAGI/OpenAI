...
namespace tryAGI.OpenAI
{
    ...
    public sealed partial class RealtimeTranslationClientSecretCreateRequestExpiresAfter
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::tryAGI.OpenAI.JsonConverters.RealtimeTranslationClientSecretCreateRequestExpiresAfterAnchorJsonConverter))]
        public global::tryAGI.OpenAI.RealtimeTranslationClientSecretCreateRequestExpiresAfterAnchor? Anchor { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RealtimeTranslationClientSecretCreateRequestExpiresAfter" /> class.
        /// </summary>
        /// <param name="anchor">
        /// The anchor point for the client secret expiration, meaning that `seconds` will be added to the `created_at` time of the client secret to produce an expiration timestamp. Only `created_at` is currently supported.<br/>
        /// Default Value: created_at
        ...
        public RealtimeTranslationClientSecretCreateRequestExpiresAfter(
            global::tryAGI.OpenAI.RealtimeTranslationClientSecretCreateRequestExpiresAfterAnchor? anchor,
            long? seconds)
        {
            this.Anchor = anchor;
