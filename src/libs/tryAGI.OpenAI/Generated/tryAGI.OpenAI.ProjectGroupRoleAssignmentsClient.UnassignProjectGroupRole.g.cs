...
namespace tryAGI.OpenAI
{
    public partial class ProjectGroupRoleAssignmentsClient
    {
        ...
        private static readonly global::tryAGI.OpenAI.EndPointSecurityRequirement s_UnassignProjectGroupRoleSecurityRequirement0 =
        ...
        private static readonly global::tryAGI.OpenAI.EndPointSecurityRequirement[] s_UnassignProjectGroupRoleSecurityRequirements =
            new global::tryAGI.OpenAI.EndPointSecurityRequirement[]
            {                s_UnassignProjectGroupRoleSecurityRequirement0,
            };
        partial void PrepareUnassignProjectGroupRoleArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string projectId,
            ref string groupId,
            ref string roleId);
        partial void PrepareUnassignProjectGroupRoleRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string projectId,
            string groupId,
            string roleId);
        partial void ProcessUnassignProjectGroupRoleResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        /// <summary>
        /// Unassign project role from group<br/>
        ...
        public async global::System.Threading.Tasks.Task<global::tryAGI.OpenAI.DeletedRoleAssignmentResource> UnassignProjectGroupRoleAsync(
            string projectId,
            string groupId,
            string roleId,
        ...
        {
            var __response = await UnassignProjectGroupRoleAsResponseAsync(
                projectId: projectId,
                groupId: groupId,
                roleId: roleId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::tryAGI.OpenAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::tryAGI.OpenAI.AutoSDKHttpResponse<global::tryAGI.OpenAI.DeletedRoleAssignmentResource>> UnassignProjectGroupRoleAsResponseAsync(
            string projectId,
            string groupId,
            string roleId,
            global::tryAGI.OpenAI.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareUnassignProjectGroupRoleArguments(
            ...
            var __authorizations = global::tryAGI.OpenAI.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_UnassignProjectGroupRoleSecurityRequirements,
                operationName: "UnassignProjectGroupRoleAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "UnassignProjectGroupRole",
                                methodName: "UnassignProjectGroupRoleAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessUnassignProjectGroupRoleResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::tryAGI.OpenAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessUnassignProjectGroupRoleResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::tryAGI.OpenAI.DeletedRoleAssignmentResource.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::tryAGI.OpenAI.AutoSDKHttpResponse<global::tryAGI.OpenAI.DeletedRoleAssignmentResource>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::tryAGI.OpenAI.DeletedRoleAssignmentResource.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
