...
namespace tryAGI.OpenAI
{
    ...
    /// </summary>
    public enum BetaModelResponsePropertiesPromptCacheRetention2
    {
        /// <summary>
        ///
        /// </summary>
    ...
    /// </summary>
    public static class BetaModelResponsePropertiesPromptCacheRetention2Extensions
    {
        /// <summary>
        /// Converts an enum to a string.
        /// </summary>
        public static string ToValueString(this BetaModelResponsePropertiesPromptCacheRetention2 value)
        {
            return value switch
            {
                BetaModelResponsePropertiesPromptCacheRetention2.x24h => "24h",
                BetaModelResponsePropertiesPromptCacheRetention2.InMemory => "in_memory",
        ...
        /// </summary>
        public static BetaModelResponsePropertiesPromptCacheRetention2? ToEnum(string value)
        {
            return value switch
            {
                "24h" => BetaModelResponsePropertiesPromptCacheRetention2.x24h,
                "in_memory" => BetaModelResponsePropertiesPromptCacheRetention2.InMemory,
                _ => null,
            };
        }
    }
