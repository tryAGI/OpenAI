...
namespace OpenAI
{
    ...
    public sealed partial class AuditLogRateLimitUpdated
    {
        ...
        public global::OpenAI.AuditLogRateLimitUpdatedChangesRequested? ChangesRequested { get; set; }
        ...
        public AuditLogRateLimitUpdated(
            string? id,
            global::OpenAI.AuditLogRateLimitUpdatedChangesRequested? changesRequested)
        {
            this.Id = id;
