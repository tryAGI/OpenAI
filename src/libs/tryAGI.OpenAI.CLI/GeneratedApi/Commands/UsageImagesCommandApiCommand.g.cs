...
internal static partial class UsageImagesCommandApiCommand
{
    ...
    private static Option<global::tryAGI.OpenAI.UsageImagesBucketWidth?> BucketWidth { get; } = new(
        name: @"--bucket-width")
    {
        Description = @"Width of each time bucket in response. Currently `1m`, `1h` and `1d` are supported, default to `1d`.",
    };

    private static Option<global::System.Collections.Generic.IList<global::tryAGI.OpenAI.UsageImagesSource>?> Sources { get; } = new(
        name: @"--sources")
    {
    ...
    private static Option<global::System.Collections.Generic.IList<global::tryAGI.OpenAI.UsageImagesSize>?> Sizes { get; } = new(
        name: @"--sizes")
    {
    ...
    private static Option<global::System.Collections.Generic.IList<global::tryAGI.OpenAI.UsageImagesGroupByItem>?> GroupBy { get; } = new(
        name: @"--group-by")
    {
    ...
    public static Command Create()
    {
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                        ...
                        var sizes = parseResult.GetValue(Sizes);
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.Usage.ImagesAsync(
                                    startTime: startTime,
                                    endTime: endTime,
