...
internal static class FineTuningValidateGraderCommandApiCommand
{
...
");
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                        ...
                        var request = await CliRuntime.ReadRequestAsync<global::tryAGI.OpenAI.ValidateGraderRequest>(
                            parseResult,
                            RequestJson,
                            RequestFile,
