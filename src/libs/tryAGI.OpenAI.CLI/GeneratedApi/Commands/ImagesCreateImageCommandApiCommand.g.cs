...
internal static partial class ImagesCreateImageCommandApiCommand
{
    ...
    {
        var command = new Command(@"create-image", @"Creates an image given a prompt. [Learn more](/docs/guides/images).
");
