...
internal static partial class ResponsesCreateAModelResponse2CommandApiCommand
{
    ...
    {
        var command = new Command(@"create-amodel-response2", @"Creates a model response. Provide [text](/docs/guides/text) or
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.Responses.CreateAModelResponse2Async(
