...
internal static class FineTuningCreateCheckpointPermissionsCommandApiCommand
{
...
");
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                        ...
                        var request = await CliRuntime.ReadRequestAsync<global::tryAGI.OpenAI.CreateFineTuningCheckpointPermissionRequest>(
                            parseResult,
                            RequestJson,
                            RequestFile,
