...
internal static partial class UsageUsageCompletionsCommandApiCommand
{
    ...
    private static Option<bool?> Batch { get; } = CliRuntime.CreateNullableBoolOption(
        name: @"--batch",
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.Usage.UsageCompletionsAsync(
                                    startTime: startTime,
                                    endTime: endTime,
