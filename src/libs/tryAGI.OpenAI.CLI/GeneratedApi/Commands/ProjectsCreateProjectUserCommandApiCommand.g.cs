...
internal static class ProjectsCreateProjectUserCommandApiCommand
{
    ...
    public static Command Create()
    {
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                        ...
                        var request = await CliRuntime.ReadRequestAsync<global::tryAGI.OpenAI.ProjectUserCreateRequest>(
                            parseResult,
                            RequestJson,
                            RequestFile,
