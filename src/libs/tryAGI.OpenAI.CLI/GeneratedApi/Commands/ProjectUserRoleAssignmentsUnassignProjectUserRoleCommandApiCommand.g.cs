...
internal static partial class ProjectUserRoleAssignmentsUnassignProjectUserRoleCommandApiCommand
{
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.ProjectUserRoleAssignments.UnassignProjectUserRoleAsync(
                                    projectId: projectId,
                                    userId: userId,
                                    roleId: roleId,
