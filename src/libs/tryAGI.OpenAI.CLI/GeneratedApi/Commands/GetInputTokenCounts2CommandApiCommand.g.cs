...
internal static partial class GetInputTokenCounts2CommandApiCommand
{
    private static Option<global::System.Collections.Generic.IList<global::tryAGI.OpenAI.BetaGetinputtokencountsOpenaiBetaItem>?> OpenaiBeta { get; } = new(
        name: @"--openai-beta")
    {
    ...
    private static Option<global::tryAGI.OpenAI.OneOf<string, global::System.Collections.Generic.IList<global::tryAGI.OpenAI.BetaInputItem>>?> InputOption { get; } = new(
        name: @"--input")
    {
        Description = @"",
    };
    ...
    private static Option<global::System.Collections.Generic.IList<global::tryAGI.OpenAI.BetaTool>?> Tools { get; } = new(
        name: @"--tools")
    {
        Description = @"",
    };

    private static Option<global::tryAGI.OpenAI.BetaResponseTextParam?> Text { get; } = new(
        name: @"--text")
    {
        Description = @"",
    };

    private static Option<global::tryAGI.OpenAI.BetaReasoning?> Reasoning { get; } = new(
        name: @"--reasoning")
    {
        Description = @"",
    };
    ...
    private static Option<global::tryAGI.OpenAI.BetaPersonalityEnum?> Personality { get; } = new(
        name: @"--personality")
    {
    ...
    private static Option<global::tryAGI.OpenAI.BetaConversationParam?> Conversation { get; } = new(
        name: @"--conversation")
    {
        Description = @"",
    };

    private static Option<global::tryAGI.OpenAI.BetaToolChoiceParam?> ToolChoice { get; } = new(
        name: @"--tool-choice")
    {
        Description = @"",
    };
    ...
    private static Option<bool?> ParallelToolCalls { get; } = CliRuntime.CreateNullableBoolOption(
      ...
      private static Option<string?> RequestFile { get; } = new(@"--request-file")
      {
          ...
          Hidden = true,
                    ...
                    private static string FormatResponse(ParseResult parseResult, global::tryAGI.OpenAI.BetaTokenCountsResource value, global::System.Text.Json.Serialization.JsonSerializerContext context, bool truncateLongStrings)
                    {
                        string? text = null;
                    ...
                    static partial void CustomizeResponseText(ParseResult parseResult, global::tryAGI.OpenAI.BetaTokenCountsResource value, ref string? text);
                    static partial void CustomizeResponseFormatHints(Dictionary<string, CliFormatHint> hints);


    public static Command Create()
    {
        var command = new Command(@"get-input-token-counts2", @"Returns input token counts of the request.
...
Returns an object with `object` set to `response.input_tokens` and an `input_tokens` count.");
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            ...
            {
                        var __requestBase = await CliRuntime.ReadRequestOrDefaultAsync<global::tryAGI.OpenAI.BetaTokenCountsBody>(
                            parseResult,
                            RequestInput,
                            RequestJson,
                            RequestFile,
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.GetInputTokenCounts2Async(
