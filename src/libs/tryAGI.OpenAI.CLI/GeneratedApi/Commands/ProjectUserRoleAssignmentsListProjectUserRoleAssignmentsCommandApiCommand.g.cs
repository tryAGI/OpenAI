...
internal static partial class ProjectUserRoleAssignmentsListProjectUserRoleAssignmentsCommandApiCommand
{
    ...
    private static Option<global::tryAGI.OpenAI.ListProjectUserRoleAssignmentsOrder?> Order { get; } = new(
        name: @"--order")
    {
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.ProjectUserRoleAssignments.ListProjectUserRoleAssignmentsAsync(
                                    projectId: projectId,
                                    userId: userId,
                                    limit: limit,
                                    after: after,
