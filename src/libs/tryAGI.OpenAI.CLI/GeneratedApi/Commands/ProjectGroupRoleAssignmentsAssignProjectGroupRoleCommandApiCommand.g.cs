...
internal static partial class ProjectGroupRoleAssignmentsAssignProjectGroupRoleCommandApiCommand
{
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.ProjectGroupRoleAssignments.AssignProjectGroupRoleAsync(
                                    projectId: projectId,
                                    groupId: groupId,
                                    roleId: roleId,
