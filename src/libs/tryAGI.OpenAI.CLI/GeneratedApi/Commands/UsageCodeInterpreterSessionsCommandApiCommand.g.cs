...
internal static partial class UsageCodeInterpreterSessionsCommandApiCommand
{
    ...
    private static Option<global::tryAGI.OpenAI.UsageCodeInterpreterSessionsBucketWidth?> BucketWidth { get; } = new(
        name: @"--bucket-width")
    {
    ...
    private static Option<global::System.Collections.Generic.IList<global::tryAGI.OpenAI.UsageCodeInterpreterSessionsGroupByItem>?> GroupBy { get; } = new(
        name: @"--group-by")
    {
...
",
    ...
    {
        var command = new Command(@"code-interpreter-sessions", @"Get code interpreter sessions usage details for the organization.");
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.Usage.CodeInterpreterSessionsAsync(
                                    startTime: startTime,
                                    endTime: endTime,
