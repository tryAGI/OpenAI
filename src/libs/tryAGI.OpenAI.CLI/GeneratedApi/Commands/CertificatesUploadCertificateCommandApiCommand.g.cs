...
internal static partial class CertificatesUploadCertificateCommandApiCommand
{
    ...
    private static Option<string> Certificate { get; } = new(
        name: @"--certificate")
    {
...
");
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            ...
            {
                        var __requestBase = await CliRuntime.ReadRequestOrDefaultAsync<global::tryAGI.OpenAI.UploadCertificateRequest>(
                            parseResult,
                            Input,
                            RequestJson,
                            RequestFile,
                        ...
                        var certificate = parseResult.GetRequiredValue(Certificate);
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);


                                var response = await client.Certificates.UploadCertificateAsync(
                                    name: name,
