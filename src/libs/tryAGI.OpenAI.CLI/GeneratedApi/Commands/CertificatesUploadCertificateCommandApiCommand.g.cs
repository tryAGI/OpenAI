...
internal static class CertificatesUploadCertificateCommandApiCommand
{
...
");
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                        ...
                        var request = await CliRuntime.ReadRequestAsync<global::tryAGI.OpenAI.UploadCertificateRequest>(
                            parseResult,
                            RequestJson,
                            RequestFile,
