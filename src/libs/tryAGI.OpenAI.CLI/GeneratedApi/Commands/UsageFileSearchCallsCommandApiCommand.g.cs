...
internal static partial class UsageFileSearchCallsCommandApiCommand
{
    ...
    private static Option<global::tryAGI.OpenAI.UsageFileSearchCallsBucketWidth?> BucketWidth { get; } = new(
        name: @"--bucket-width")
    {
    ...
    private static Option<global::System.Collections.Generic.IList<string>?> VectorStoreIds { get; } = new(
        name: @"--vector-store-ids")
    {
        Description = @"Return only usage for these vector stores.",
    };

    private static Option<global::System.Collections.Generic.IList<global::tryAGI.OpenAI.UsageFileSearchCallsGroupByItem>?> GroupBy { get; } = new(
        name: @"--group-by")
    {
...
",
    ...
    {
        var command = new Command(@"file-search-calls", @"Get file search calls usage details for the organization.");
                        ...
                        command.Options.Add(VectorStoreIds);
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                        ...
                        var vectorStoreIds = parseResult.GetValue(VectorStoreIds);
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.Usage.FileSearchCallsAsync(
                                    startTime: startTime,
                                    endTime: endTime,
