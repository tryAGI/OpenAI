...
internal static partial class SpendAlertsCreateProjectSpendAlertCommandApiCommand
{
    ...
    {
        var command = new Command(@"create-project-spend-alert", @"Creates a project spend alert.");
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                        ...
                        var projectId = parseResult.GetRequiredValue(ProjectId);                        var thresholdAmount = parseResult.GetRequiredValue(CreateSpendAlertBodyOptionSetOptions.ThresholdAmount);
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.SpendAlerts.CreateProjectSpendAlertAsync(
                                    projectId: projectId,
