...
internal static partial class AgentsDeleteAgentEnvironmentTemplateCommandApiCommand
{
        ...
        name: @"environment-template-id")
    {
        Description = @"The ID of the reusable environment template.",
                    ...
                    private static string FormatResponse(ParseResult parseResult, global::tryAGI.OpenAI.DeletedEnvironmentTemplateResource value, global::System.Text.Json.Serialization.JsonSerializerContext context, bool truncateLongStrings)
                    {
                        string? text = null;
                    ...
                    static partial void CustomizeResponseText(ParseResult parseResult, global::tryAGI.OpenAI.DeletedEnvironmentTemplateResource value, ref string? text);
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.Agents.DeleteAgentEnvironmentTemplateAsync(
