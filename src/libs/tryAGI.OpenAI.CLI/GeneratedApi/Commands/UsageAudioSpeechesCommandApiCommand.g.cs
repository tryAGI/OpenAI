...
internal static partial class UsageAudioSpeechesCommandApiCommand
{
    ...
    private static Option<global::tryAGI.OpenAI.UsageAudioSpeechesBucketWidth?> BucketWidth { get; } = new(
        name: @"--bucket-width")
    {
    ...
    private static Option<global::System.Collections.Generic.IList<global::tryAGI.OpenAI.UsageAudioSpeechesGroupByItem>?> GroupBy { get; } = new(
        name: @"--group-by")
    {
...
",
    ...
    {
        var command = new Command(@"audio-speeches", @"Get audio speeches usage details for the organization.");
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.Usage.AudioSpeechesAsync(
                                    startTime: startTime,
                                    endTime: endTime,
