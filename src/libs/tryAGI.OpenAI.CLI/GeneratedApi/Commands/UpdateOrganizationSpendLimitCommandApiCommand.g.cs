...
internal static partial class UpdateOrganizationSpendLimitCommandApiCommand
{
    ...
    private static Option<global::tryAGI.OpenAI.UpdateOrganizationSpendLimitBodyCurrency> Currency { get; } = new(
        name: @"--currency")
    {
        Description = @"The currency for the threshold amount. Currently, only `USD` is supported.",
    };

    private static Option<global::tryAGI.OpenAI.UpdateOrganizationSpendLimitBodyInterval> Interval { get; } = new(
        name: @"--interval")
    {
    ...
    public static Command Create()
    {
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            ...
            {
                        var __requestBase = await CliRuntime.ReadRequestOrDefaultAsync<global::tryAGI.OpenAI.UpdateOrganizationSpendLimitBody>(
                            parseResult,
                            Input,
                            RequestJson,
                            RequestFile,
