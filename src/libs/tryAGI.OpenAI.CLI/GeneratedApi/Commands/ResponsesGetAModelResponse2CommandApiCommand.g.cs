...
internal static partial class ResponsesGetAModelResponse2CommandApiCommand
{
...
");
    ...
    private static Option<global::System.Collections.Generic.IList<global::tryAGI.OpenAI.BetaGetResponseOpenaiBetaItem>?> OpenaiBeta { get; } = new(
        name: @"--openai-beta")
    {
    ...
    {
        var command = new Command(@"get-amodel-response2", @"Retrieves a model response with the given ID.
");
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.Responses.GetAModelResponse2Async(
