...
internal static partial class RolesRetrieveOrganizationRoleCommandApiCommand
{
    ...
    {
        var command = new Command(@"retrieve-organization-role", @"Retrieves an organization role.");
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.Roles.RetrieveOrganizationRoleAsync(
                                    roleId: roleId,
