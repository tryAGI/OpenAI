...
internal static partial class RolesCreateOrganizationRoleCommandApiCommand
{
    ...
    {
        var command = new Command(@"create-organization-role", @"Creates a custom role for the organization.");
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            ...
            {
                        var __requestBase = await CliRuntime.ReadRequestOrDefaultAsync<global::tryAGI.OpenAI.PublicCreateOrganizationRoleBody>(
                            parseResult,
                            Input,
                            RequestJson,
                            RequestFile,
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.Roles.CreateOrganizationRoleAsync(
                                    roleName: roleName,
