...
internal static partial class EvalsUpdateAnEvalCommandApiCommand
{
    ...
    {
        var command = new Command(@"update-an-eval", @"Update certain properties of an evaluation.
");
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            ...
            {
                        var __requestBase = await CliRuntime.ReadRequestOrDefaultAsync<global::tryAGI.OpenAI.UpdateEvalRequest>(
                            parseResult,
                            Input,
                            RequestJson,
                            RequestFile,
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.Evals.UpdateAnEvalAsync(
                                    evalId: evalId,
                                    name: name,
                                    metadata: metadata,
