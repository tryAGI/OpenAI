...
internal static partial class GroupOrganizationRoleAssignmentsListGroupRoleAssignmentsCommandApiCommand
{
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.GroupOrganizationRoleAssignments.ListGroupRoleAssignmentsAsync(
                                    groupId: groupId,
                                    limit: limit,
                                    after: after,
                                    order: order,
