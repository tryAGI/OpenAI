...
internal static class RealtimeCreateTranscriptionSessionCommandApiCommand
{
...
");
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                        ...
                        var request = await CliRuntime.ReadRequestAsync<global::tryAGI.OpenAI.RealtimeTranscriptionSessionCreateRequest>(
                            parseResult,
                            RequestJson,
                            RequestFile,
