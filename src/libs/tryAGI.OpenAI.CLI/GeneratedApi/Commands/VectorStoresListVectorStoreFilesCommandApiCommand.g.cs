...
",
    ...
    private static Option<global::tryAGI.OpenAI.ListVectorStoreFilesOrder?> Order { get; } = new(
        name: @"--order")
    {
...
",
    ...
    private static Option<global::tryAGI.OpenAI.ListVectorStoreFilesFilter?> Filter { get; } = new(
        name: @"--filter")
    {
