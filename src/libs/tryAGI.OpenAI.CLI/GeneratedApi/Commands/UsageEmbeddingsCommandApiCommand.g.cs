...
internal static partial class UsageEmbeddingsCommandApiCommand
{
    ...
    private static Option<global::tryAGI.OpenAI.UsageEmbeddingsBucketWidth?> BucketWidth { get; } = new(
        name: @"--bucket-width")
    {
    ...
    private static Option<global::System.Collections.Generic.IList<global::tryAGI.OpenAI.UsageEmbeddingsGroupByItem>?> GroupBy { get; } = new(
        name: @"--group-by")
    {
...
",
    ...
    {
        var command = new Command(@"embeddings", @"Get embeddings usage details for the organization.");
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.Usage.EmbeddingsAsync(
                                    startTime: startTime,
                                    endTime: endTime,
