...
internal static partial class ConversationsCreateAConversationCommandApiCommand
{
    ...
    {
        var command = new Command(@"create-aconversation", @"Create a conversation.");
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            ...
            {
                        var __requestBase = await CliRuntime.ReadRequestOrDefaultAsync<global::tryAGI.OpenAI.CreateConversationBody>(
                            parseResult,
                            Input,
                            RequestJson,
                            RequestFile,
                        ...
                        var items = parseResult.GetValue(Items) ?? __requestBase?.Items;
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);


                                var response = await client.Conversations.CreateAConversationAsync(
                                    metadata: metadata,
                                    items: items,
