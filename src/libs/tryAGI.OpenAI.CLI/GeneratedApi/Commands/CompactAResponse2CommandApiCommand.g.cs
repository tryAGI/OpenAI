...
internal static partial class CompactAResponse2CommandApiCommand
{
    private static Option<global::System.Collections.Generic.IList<global::tryAGI.OpenAI.BetaCompactconversationOpenaiBetaItem>?> OpenaiBeta { get; } = new(
        name: @"--openai-beta")
    {
        Description = @"Optional beta features to enable for this request.",
    };

    private static Option<global::tryAGI.OpenAI.BetaModelIdsCompaction> Model { get; } = new(
        name: @"--model")
    {
    ...
    private static Option<global::tryAGI.OpenAI.BetaPromptCacheRetentionEnum?> PromptCacheRetention { get; } = new(
        name: @"--prompt-cache-retention")
    {
        Description = @"",
    };

    private static Option<global::tryAGI.OpenAI.BetaPromptCacheOptionsParam?> PromptCacheOptions { get; } = new(
        name: @"--prompt-cache-options")
    {
        Description = @"",
    };

    private static Option<global::tryAGI.OpenAI.BetaServiceTierEnum?> ServiceTier { get; } = new(
        name: @"--service-tier")
    {
        Description = @"",
    };
      ...
      private static Option<string?> RequestFile { get; } = new(@"--request-file")
      {
          ...
          Hidden = true,
                    ...
                    private static string FormatResponse(ParseResult parseResult, global::tryAGI.OpenAI.BetaCompactResource value, global::System.Text.Json.Serialization.JsonSerializerContext context, bool truncateLongStrings)
                    {
                        string? text = null;
                    ...
                    static partial void CustomizeResponseText(ParseResult parseResult, global::tryAGI.OpenAI.BetaCompactResource value, ref string? text);
                    static partial void CustomizeResponseFormatHints(Dictionary<string, CliFormatHint> hints);


    public static Command Create()
    {
        var command = new Command(@"compact-aresponse2", @"Compact a conversation. Returns a compacted response object.
...
Learn when and how to compact long-running conversations in the [conversation state guide](/docs/guides/conversation-state#managing-the-context-window). For ZDR-compatible compaction details, see [Compaction (advanced)](/docs/guides/conversation-state#compaction-advanced).");
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            ...
            {
                        var __requestBase = await CliRuntime.ReadRequestOrDefaultAsync<global::tryAGI.OpenAI.BetaCompactResponseMethodPublicBody>(
                            parseResult,
                            RequestInput,
                            RequestJson,
                            RequestFile,
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.CompactAResponse2Async(
