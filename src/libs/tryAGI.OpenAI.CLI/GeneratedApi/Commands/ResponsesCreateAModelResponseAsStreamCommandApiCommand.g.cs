...
internal static partial class ResponsesCreateAModelResponseAsStreamCommandApiCommand
{
    ...
    {
        var command = new Command(@"create-amodel-response-as-stream", @"Creates a model response. Provide [text](/docs/guides/text) or
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = client.Responses.CreateAModelResponseAsStreamAsync(
