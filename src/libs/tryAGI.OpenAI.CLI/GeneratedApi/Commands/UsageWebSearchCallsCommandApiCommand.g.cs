...
internal static partial class UsageWebSearchCallsCommandApiCommand
{
    ...
    private static Option<global::tryAGI.OpenAI.UsageWebSearchCallsBucketWidth?> BucketWidth { get; } = new(
        name: @"--bucket-width")
    {
    ...
    private static Option<global::System.Collections.Generic.IList<global::tryAGI.OpenAI.UsageWebSearchCallsContextLevel>?> ContextLevels { get; } = new(
        name: @"--context-levels")
    {
        Description = @"Return only web search usage for these context levels.",
    };

    private static Option<global::System.Collections.Generic.IList<global::tryAGI.OpenAI.UsageWebSearchCallsGroupByItem>?> GroupBy { get; } = new(
        name: @"--group-by")
    {
...
",
    ...
    {
        var command = new Command(@"web-search-calls", @"Get web search calls usage details for the organization.");
                        ...
                        command.Options.Add(ContextLevels);
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                        ...
                        var contextLevels = parseResult.GetValue(ContextLevels);
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.Usage.WebSearchCallsAsync(
                                    startTime: startTime,
                                    endTime: endTime,
