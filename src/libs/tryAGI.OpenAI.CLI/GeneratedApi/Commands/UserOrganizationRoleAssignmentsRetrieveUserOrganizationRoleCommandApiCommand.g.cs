...
internal static partial class UserOrganizationRoleAssignmentsRetrieveUserOrganizationRoleCommandApiCommand
{
    ...
    {
        var command = new Command(@"retrieve-user-organization-role", @"Retrieves an organization role assigned to a user.");
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.UserOrganizationRoleAssignments.RetrieveUserOrganizationRoleAsync(
                                    userId: userId,
                                    roleId: roleId,
