...
internal static partial class UsageModerationsCommandApiCommand
{
    ...
    private static Option<global::tryAGI.OpenAI.UsageModerationsBucketWidth?> BucketWidth { get; } = new(
        name: @"--bucket-width")
    {
    ...
    private static Option<global::System.Collections.Generic.IList<global::tryAGI.OpenAI.UsageModerationsGroupByItem>?> GroupBy { get; } = new(
        name: @"--group-by")
    {
...
",
    ...
    {
        var command = new Command(@"moderations", @"Get moderations usage details for the organization.");
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.Usage.ModerationsAsync(
                                    startTime: startTime,
                                    endTime: endTime,
